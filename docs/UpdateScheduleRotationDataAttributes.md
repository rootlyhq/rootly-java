...
|**startTime** | **String** | ISO8601 date and time when rotation starts. Shifts will only be created after this time. |  [optional] |
|**endTime** | **String** | ISO8601 date and time when rotation ends. Shifts will only be created before this time. |  [optional] |
