...
|**conditions** | [**List&lt;NewAlertRetriggerRuleDataAttributesConditionsInner&gt;**](NewAlertRetriggerRuleDataAttributesConditionsInner.md) | The full desired set of conditions; replaces the rule&#39;s existing conditions. An empty array applies to every alert. |  [optional] |
