...
|------------ | ------------- | ------------- | -------------|
|**formFieldId** | **String** | The ID of the form field. |  [optional] |
|**form** | [**FormEnum**](#FormEnum) | The form for the position |  [optional] |
|**position** | **Integer** | The position of the form_field_position |  [optional] |
