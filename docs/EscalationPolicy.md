...
|**repeatCount** | **Integer** | The number of times this policy will be executed until someone acknowledges the alert |  |
|**createdByUserId** | **Integer** | User who created the escalation policy |  |
