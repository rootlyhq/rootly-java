...
|**transcript** | [**MeetingRecordingDetailAllOfTranscript**](MeetingRecordingDetailAllOfTranscript.md) |  |  [optional] |
|**recallUploadId** | **String** | Recall upload identifier |  [optional] |
|**recordableId** | **String** | UUID of the associated recordable (e.g. incident) |  [optional] |
|**recordableType** | **String** | Type of the associated recordable (e.g. Incident) |  [optional] |
