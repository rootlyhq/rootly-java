...
|------------- | ------------- | -------------|
| [**bulkDeleteEnvironments**](EnvironmentsApi.md#bulkDeleteEnvironments) | **POST** /v1/environments/bulk_delete | Bulk delete Environments |
| [**bulkUpsertEnvironments**](EnvironmentsApi.md#bulkUpsertEnvironments) | **POST** /v1/environments/bulk_upsert | Bulk upsert Environments |
...
<a id="bulkDeleteEnvironments"></a>
# **bulkDeleteEnvironments**
> BulkDestroyEnvironmentsResponse bulkDeleteEnvironments(bulkDestroyEnvironments)
...
public class Example {
  public static void main(String[] args) {
    ...
    BulkDestroyEnvironments bulkDestroyEnvironments = new BulkDestroyEnvironments(); // BulkDestroyEnvironments | 
    try {
      BulkDestroyEnvironmentsResponse result = apiInstance.bulkDeleteEnvironments(bulkDestroyEnvironments);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EnvironmentsApi#bulkDeleteEnvironments");
...
|------------- | ------------- | ------------- | -------------|
| **bulkDestroyEnvironments** | [**BulkDestroyEnvironments**](BulkDestroyEnvironments.md)|  | |

### Return type

[**BulkDestroyEnvironmentsResponse**](BulkDestroyEnvironmentsResponse.md)
...
<a id="bulkUpsertEnvironments"></a>
# **bulkUpsertEnvironments**
> BulkUpsertEnvironmentsResponse bulkUpsertEnvironments(bulkUpsertEnvironments)
...
public class Example {
  public static void main(String[] args) {
    ...
    EnvironmentsApi apiInstance = new EnvironmentsApi(defaultClient);
    BulkUpsertEnvironments bulkUpsertEnvironments = new BulkUpsertEnvironments(); // BulkUpsertEnvironments | 
    try {
      BulkUpsertEnvironmentsResponse result = apiInstance.bulkUpsertEnvironments(bulkUpsertEnvironments);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EnvironmentsApi#bulkUpsertEnvironments");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **bulkUpsertEnvironments** | [**BulkUpsertEnvironments**](BulkUpsertEnvironments.md)|  | |

### Return type

[**BulkUpsertEnvironmentsResponse**](BulkUpsertEnvironmentsResponse.md)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      EnvironmentList result = apiInstance.listEnvironments(include, pageNumber, pageSize, filterSearch, filterSlug, filterName, filterColor, filterCreatedAtGt, filterCreatedAtGte, filterCreatedAtLt, filterCreatedAtLte, filterSlugEq, filterSlugNotEq, filterSlugIn, filterSlugNotIn, filterNameEq, filterNameNotEq, filterNameIn, filterNameNotIn, filterColorEq, filterColorNotEq, filterColorIn, filterColorNotIn, sort);
      System.out.println(result);
    } catch (ApiException e) {
