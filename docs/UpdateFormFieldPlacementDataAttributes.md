...
|------------ | ------------- | ------------- | -------------|
|**formSetId** | **String** | The form set this field is placed in. The form set must have the same &#x60;resource_type&#x60; as the form field, otherwise the request is rejected with 422. |  [optional] |
