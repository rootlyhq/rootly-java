...
import org.openapitools.client.model.AlertEventList;
import org.openapitools.client.model.AlertEventResponse;
import org.openapitools.client.model.ErrorsList;
import org.openapitools.client.model.NewAlertEvent;
import org.openapitools.client.model.UpdateAlertEvent;
...
public class AlertEventsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AlertEventsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AlertEventsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createAlertEvent
     * @param alertId  (required)
     * @param newAlertEvent  (optional)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 201 </td><td> alert event created with Rootly bot user </td><td>  -  </td></tr>
    ...
    public okhttp3.Call createAlertEventCall(@javax.annotation.Nonnull String alertId, @javax.annotation.Nullable NewAlertEvent newAlertEvent, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = newAlertEvent;

        // create path and map variables
        String localVarPath = "/v1/alerts/{alert_id}/events"
    ...
    private okhttp3.Call createAlertEventValidateBeforeCall(@javax.annotation.Nonnull String alertId, @javax.annotation.Nullable NewAlertEvent newAlertEvent, final ApiCallback _callback) throws ApiException {
        ...
        return createAlertEventCall(alertId, newAlertEvent, _callback);
    ...
    /**
     * Create alert event (asynchronously)
     * Creates a new alert event
     * @param alertId  (required)
     * @param newAlertEvent  (optional)
    ...
    /**
     * Build call for deleteAlertEvent
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> alert event deleted </td><td>  -  </td></tr>
    ...
    public okhttp3.Call deleteAlertEventCall(@javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/alert_events/{id}"
    ...
    private okhttp3.Call deleteAlertEventValidateBeforeCall(@javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        return deleteAlertEventCall(id, _callback);
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> alert_event found </td><td>  -  </td></tr>
    ...
    private okhttp3.Call getAlertEventValidateBeforeCall(@javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        return getAlertEventCall(id, _callback);
    ...
    /**
     * Retrieve alert event (asynchronously)
     * Retrieves a specific alert_event by id
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for listAlertEvents
     * @param alertId  (required)
    ...
    private okhttp3.Call listAlertEventsValidateBeforeCall(@javax.annotation.Nonnull String alertId, @javax.annotation.Nullable String include, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable String filterKind, @javax.annotation.Nullable String filterAction, final ApiCallback _callback) throws ApiException {
        ...
        return listAlertEventsCall(alertId, include, pageNumber, pageSize, filterKind, filterAction, _callback);
     ...
     * @param filterKind  (optional)
     * @param filterAction  (optional)
     * @return ApiResponse&lt;AlertEventList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
    ...
    /**
     * List alert events (asynchronously)
     * List alert_events
     * @param alertId  (required)
     * @param include  (optional)
     * @param pageNumber  (optional)
    ...
    /**
     * Build call for updateAlertEvent
     * @param id  (required)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> alert event updated </td><td>  -  </td></tr>
        <tr><td> 422 </td><td> invalid request </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updateAlertEventCall(@javax.annotation.Nonnull String id, @javax.annotation.Nullable UpdateAlertEvent updateAlertEvent, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = updateAlertEvent;
    ...
    private okhttp3.Call updateAlertEventValidateBeforeCall(@javax.annotation.Nonnull String id, @javax.annotation.Nullable UpdateAlertEvent updateAlertEvent, final ApiCallback _callback) throws ApiException {
        ...
        return updateAlertEventCall(id, updateAlertEvent, _callback);
