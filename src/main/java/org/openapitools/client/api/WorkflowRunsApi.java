...
import org.openapitools.client.model.NewWorkflowRun;
import org.openapitools.client.model.WorkflowRunResponse;
import org.openapitools.client.model.WorkflowRunsList;
...
public class WorkflowRunsApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 201 </td><td> workflow run created </td><td>  -  </td></tr>
        <tr><td> 422 </td><td> workflow run not created </td><td>  -  </td></tr>
    ...
    public okhttp3.Call createWorkflowRunCall(@javax.annotation.Nonnull String workflowId, @javax.annotation.Nonnull NewWorkflowRun newWorkflowRun, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = newWorkflowRun;

        // create path and map variables
        String localVarPath = "/v1/workflows/{workflow_id}/workflow_runs"
    ...
    private okhttp3.Call createWorkflowRunValidateBeforeCall(@javax.annotation.Nonnull String workflowId, @javax.annotation.Nonnull NewWorkflowRun newWorkflowRun, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'newWorkflowRun' is set
        if (newWorkflowRun == null) {
            throw new ApiException("Missing the required parameter 'newWorkflowRun' when calling createWorkflowRun(Async)");
        }

        return createWorkflowRunCall(workflowId, newWorkflowRun, _callback);
    ...
    /**
     * Creates a workflow run (asynchronously)
     * Creates a new workflow run from provided data
     * @param workflowId  (required)
     * @param newWorkflowRun  (required)
     ...
     * @param workflowId  (required)
     * @param include comma separated if needed. eg: genius_task_runs (optional)
    ...
    private okhttp3.Call listWorkflowRunsValidateBeforeCall(@javax.annotation.Nonnull String workflowId, @javax.annotation.Nullable String include, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable String filterCreatedAtGt, @javax.annotation.Nullable String filterCreatedAtGte, @javax.annotation.Nullable String filterCreatedAtLt, @javax.annotation.Nullable String filterCreatedAtLte, final ApiCallback _callback) throws ApiException {
        ...
        return listWorkflowRunsCall(workflowId, include, pageNumber, pageSize, filterCreatedAtGt, filterCreatedAtGte, filterCreatedAtLt, filterCreatedAtLte, _callback);
     ...
     * @param filterCreatedAtLt  (optional)
     * @param filterCreatedAtLte  (optional)
     * @return ApiResponse&lt;WorkflowRunsList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
