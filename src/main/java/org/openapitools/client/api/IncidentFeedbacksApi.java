...
import org.openapitools.client.model.IncidentFeedbackList;
import org.openapitools.client.model.IncidentFeedbackResponse;
import org.openapitools.client.model.NewIncidentFeedback;
import org.openapitools.client.model.UpdateIncidentFeedback;
...
public class IncidentFeedbacksApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public IncidentFeedbacksApi() {
        this(Configuration.getDefaultApiClient());
    }

    public IncidentFeedbacksApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createIncidentFeedback
     * @param incidentId  (required)
     * @param newIncidentFeedback  (required)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 201 </td><td> incident_feedback created </td><td>  -  </td></tr>
    ...
    public okhttp3.Call createIncidentFeedbackCall(@javax.annotation.Nonnull String incidentId, @javax.annotation.Nonnull NewIncidentFeedback newIncidentFeedback, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = newIncidentFeedback;

        // create path and map variables
        String localVarPath = "/v1/incidents/{incident_id}/feedbacks"
    ...
    private okhttp3.Call createIncidentFeedbackValidateBeforeCall(@javax.annotation.Nonnull String incidentId, @javax.annotation.Nonnull NewIncidentFeedback newIncidentFeedback, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'newIncidentFeedback' is set
        if (newIncidentFeedback == null) {
            throw new ApiException("Missing the required parameter 'newIncidentFeedback' when calling createIncidentFeedback(Async)");
        }

        return createIncidentFeedbackCall(incidentId, newIncidentFeedback, _callback);
     ...
     * @param incidentId  (required)
     * @param newIncidentFeedback  (required)
     * @return ApiResponse&lt;IncidentFeedbackResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
    ...
    /**
     * Creates an incident feedback (asynchronously)
     * Creates a new feedback from provided data
     * @param incidentId  (required)
     * @param newIncidentFeedback  (required)
    ...
    /**
     * Build call for getIncidentFeedbacks
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> incident_feedback found </td><td>  -  </td></tr>
    ...
    public okhttp3.Call getIncidentFeedbacksCall(@javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/feedbacks/{id}"
    ...
    private okhttp3.Call getIncidentFeedbacksValidateBeforeCall(@javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        return getIncidentFeedbacksCall(id, _callback);
    ...
    /**
     * Retrieves an incident feedback (asynchronously)
     * Retrieves a specific incident_feedback by id
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for listIncidentFeedbacks
     * @param incidentId  (required)
    ...
    private okhttp3.Call listIncidentFeedbacksValidateBeforeCall(@javax.annotation.Nonnull String incidentId, @javax.annotation.Nullable String include, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize, final ApiCallback _callback) throws ApiException {
        ...
        return listIncidentFeedbacksCall(incidentId, include, pageNumber, pageSize, _callback);
     ...
     * @param pageNumber  (optional)
     * @param pageSize  (optional)
     * @return ApiResponse&lt;IncidentFeedbackList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
    ...
    /**
     * List incident feedbacks (asynchronously)
     * List incident feedbacks
     * @param incidentId  (required)
     * @param include  (optional)
     * @param pageNumber  (optional)
    ...
    /**
     * Build call for updateIncidentFeedback
     * @param id  (required)
     * @param updateIncidentFeedback  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> incident_feedback updated </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> resource not found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updateIncidentFeedbackCall(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull UpdateIncidentFeedback updateIncidentFeedback, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = updateIncidentFeedback;
    ...
    private okhttp3.Call updateIncidentFeedbackValidateBeforeCall(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull UpdateIncidentFeedback updateIncidentFeedback, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'updateIncidentFeedback' is set
        if (updateIncidentFeedback == null) {
            throw new ApiException("Missing the required parameter 'updateIncidentFeedback' when calling updateIncidentFeedback(Async)");
        }

        return updateIncidentFeedbackCall(id, updateIncidentFeedback, _callback);
    ...
    /**
     * Update an incident feedback (asynchronously)
     * Update a specific incident feedback by id
     * @param id  (required)
     * @param updateIncidentFeedback  (required)
     * @param _callback The callback to be executed when the API call finishes
