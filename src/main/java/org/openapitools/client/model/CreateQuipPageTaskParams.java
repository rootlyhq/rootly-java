...
public class CreateQuipPageTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateQuipPageTaskParams createQuipPageTaskParams = (CreateQuipPageTaskParams) o;
    return Objects.equals(this.taskType, createQuipPageTaskParams.taskType) &&
        Objects.equals(this.postMortemTemplateId, createQuipPageTaskParams.postMortemTemplateId) &&
        Objects.equals(this.title, createQuipPageTaskParams.title) &&
        Objects.equals(this.parentFolderId, createQuipPageTaskParams.parentFolderId) &&
        Objects.equals(this.content, createQuipPageTaskParams.content) &&
        Objects.equals(this.templateId, createQuipPageTaskParams.templateId) &&
        Objects.equals(this.markPostMortemAsPublished, createQuipPageTaskParams.markPostMortemAsPublished);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, postMortemTemplateId, title, parentFolderId, content, templateId, markPostMortemAsPublished);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateQuipPageTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateQuipPageTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateQuipPageTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateQuipPageTaskParams is not found in the empty JSON string", CreateQuipPageTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateQuipPageTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateQuipPageTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateQuipPageTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateQuipPageTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateQuipPageTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateQuipPageTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateQuipPageTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateQuipPageTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateQuipPageTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateQuipPageTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateQuipPageTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateQuipPageTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateQuipPageTaskParams
   */
  public static CreateQuipPageTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateQuipPageTaskParams.class);
  }

  /**
   * Convert an instance of CreateQuipPageTaskParams to an JSON string
   *
   * @return JSON string
   */
