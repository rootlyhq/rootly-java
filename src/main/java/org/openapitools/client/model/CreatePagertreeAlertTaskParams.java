...
public class CreatePagertreeAlertTaskParams {
  ...
  public CreatePagertreeAlertTaskParams addTeamsItem(AddActionItemTaskParamsPostToSlackChannelsInner teamsItem) {
    if (this.teams == null) {
  ...
  public CreatePagertreeAlertTaskParams addUsersItem(AddActionItemTaskParamsPostToSlackChannelsInner usersItem) {
    if (this.users == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePagertreeAlertTaskParams createPagertreeAlertTaskParams = (CreatePagertreeAlertTaskParams) o;
    return Objects.equals(this.taskType, createPagertreeAlertTaskParams.taskType) &&
        Objects.equals(this.title, createPagertreeAlertTaskParams.title) &&
        Objects.equals(this.description, createPagertreeAlertTaskParams.description) &&
        Objects.equals(this.urgency, createPagertreeAlertTaskParams.urgency) &&
        Objects.equals(this.severity, createPagertreeAlertTaskParams.severity) &&
        Objects.equals(this.teams, createPagertreeAlertTaskParams.teams) &&
        Objects.equals(this.users, createPagertreeAlertTaskParams.users) &&
        Objects.equals(this.incident, createPagertreeAlertTaskParams.incident);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, title, description, urgency, severity, teams, users, incident);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePagertreeAlertTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePagertreeAlertTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePagertreeAlertTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePagertreeAlertTaskParams is not found in the empty JSON string", CreatePagertreeAlertTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePagertreeAlertTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePagertreeAlertTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePagertreeAlertTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePagertreeAlertTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePagertreeAlertTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePagertreeAlertTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePagertreeAlertTaskParams>() {
           @Override
           public void write(JsonWriter out, CreatePagertreeAlertTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePagertreeAlertTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePagertreeAlertTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePagertreeAlertTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreatePagertreeAlertTaskParams
   */
  public static CreatePagertreeAlertTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePagertreeAlertTaskParams.class);
  }

  /**
   * Convert an instance of CreatePagertreeAlertTaskParams to an JSON string
   *
   * @return JSON string
   */
