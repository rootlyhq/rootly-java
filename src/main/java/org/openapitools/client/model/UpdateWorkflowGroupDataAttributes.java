...
public class UpdateWorkflowGroupDataAttributes {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kind, updateWorkflowGroupDataAttributes.kind) &&
        ...
        Objects.equals(this.expanded, updateWorkflowGroupDataAttributes.expanded) &&
        Objects.equals(this.position, updateWorkflowGroupDataAttributes.position);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateWorkflowGroupDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWorkflowGroupDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateWorkflowGroupDataAttributes is not found in the empty JSON string", UpdateWorkflowGroupDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWorkflowGroupDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateWorkflowGroupDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWorkflowGroupDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWorkflowGroupDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWorkflowGroupDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWorkflowGroupDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWorkflowGroupDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateWorkflowGroupDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWorkflowGroupDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateWorkflowGroupDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateWorkflowGroupDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateWorkflowGroupDataAttributes
   */
  public static UpdateWorkflowGroupDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWorkflowGroupDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateWorkflowGroupDataAttributes to an JSON string
   *
   * @return JSON string
   */
