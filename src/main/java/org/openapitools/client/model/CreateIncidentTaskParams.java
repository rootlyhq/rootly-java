...
public class CreateIncidentTaskParams {
  ...
  public CreateIncidentTaskParams() {
  }

  public CreateIncidentTaskParams taskType(@javax.annotation.Nullable TaskTypeEnum taskType) {
  ...
  public CreateIncidentTaskParams title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public CreateIncidentTaskParams summary(@javax.annotation.Nullable String summary) {
  ...
  public CreateIncidentTaskParams severityId(@javax.annotation.Nullable String severityId) {
  ...
  public CreateIncidentTaskParams incidentTypeIds(@javax.annotation.Nullable List<String> incidentTypeIds) {
    this.incidentTypeIds = incidentTypeIds;
    return this;
  }

  public CreateIncidentTaskParams addIncidentTypeIdsItem(String incidentTypeIdsItem) {
  ...
  public CreateIncidentTaskParams serviceIds(@javax.annotation.Nullable List<String> serviceIds) {
    this.serviceIds = serviceIds;
    return this;
  }

  public CreateIncidentTaskParams addServiceIdsItem(String serviceIdsItem) {
  ...
  public CreateIncidentTaskParams functionalityIds(@javax.annotation.Nullable List<String> functionalityIds) {
    this.functionalityIds = functionalityIds;
    return this;
  }

  public CreateIncidentTaskParams addFunctionalityIdsItem(String functionalityIdsItem) {
  ...
  public CreateIncidentTaskParams environmentIds(@javax.annotation.Nullable List<String> environmentIds) {
    this.environmentIds = environmentIds;
    return this;
  }

  public CreateIncidentTaskParams addEnvironmentIdsItem(String environmentIdsItem) {
  ...
  public CreateIncidentTaskParams groupIds(@javax.annotation.Nullable List<String> groupIds) {
    this.groupIds = groupIds;
    return this;
  }

  public CreateIncidentTaskParams addGroupIdsItem(String groupIdsItem) {
  ...
  public CreateIncidentTaskParams _private(@javax.annotation.Nullable Boolean _private) {
  ...
  public CreateIncidentTaskParams customFieldsMapping(@javax.annotation.Nullable String customFieldsMapping) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIncidentTaskParams createIncidentTaskParams = (CreateIncidentTaskParams) o;
    return Objects.equals(this.taskType, createIncidentTaskParams.taskType) &&
        Objects.equals(this.title, createIncidentTaskParams.title) &&
        Objects.equals(this.summary, createIncidentTaskParams.summary) &&
        Objects.equals(this.severityId, createIncidentTaskParams.severityId) &&
        Objects.equals(this.incidentTypeIds, createIncidentTaskParams.incidentTypeIds) &&
        Objects.equals(this.serviceIds, createIncidentTaskParams.serviceIds) &&
        Objects.equals(this.functionalityIds, createIncidentTaskParams.functionalityIds) &&
        Objects.equals(this.environmentIds, createIncidentTaskParams.environmentIds) &&
        Objects.equals(this.groupIds, createIncidentTaskParams.groupIds) &&
        Objects.equals(this._private, createIncidentTaskParams._private) &&
        Objects.equals(this.customFieldsMapping, createIncidentTaskParams.customFieldsMapping);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskType, title, summary, severityId, incidentTypeIds, serviceIds, functionalityIds, environmentIds, groupIds, _private, customFieldsMapping);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIncidentTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIncidentTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIncidentTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIncidentTaskParams is not found in the empty JSON string", CreateIncidentTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIncidentTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIncidentTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateIncidentTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIncidentTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIncidentTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIncidentTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIncidentTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIncidentTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateIncidentTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIncidentTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIncidentTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIncidentTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateIncidentTaskParams
   */
  public static CreateIncidentTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIncidentTaskParams.class);
  }

  /**
   * Convert an instance of CreateIncidentTaskParams to an JSON string
   *
   * @return JSON string
   */
