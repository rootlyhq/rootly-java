...
public class CreateLinearSubtaskIssueTaskParams {
  ...
  public CreateLinearSubtaskIssueTaskParams addLabelsItem(AddActionItemTaskParamsPostToSlackChannelsInner labelsItem) {
    if (this.labels == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLinearSubtaskIssueTaskParams createLinearSubtaskIssueTaskParams = (CreateLinearSubtaskIssueTaskParams) o;
    return Objects.equals(this.taskType, createLinearSubtaskIssueTaskParams.taskType) &&
        Objects.equals(this.parentIssueId, createLinearSubtaskIssueTaskParams.parentIssueId) &&
        Objects.equals(this.title, createLinearSubtaskIssueTaskParams.title) &&
        Objects.equals(this.description, createLinearSubtaskIssueTaskParams.description) &&
  ...
  public String toString() {
    ...
    sb.append("class CreateLinearSubtaskIssueTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLinearSubtaskIssueTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLinearSubtaskIssueTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLinearSubtaskIssueTaskParams is not found in the empty JSON string", CreateLinearSubtaskIssueTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLinearSubtaskIssueTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLinearSubtaskIssueTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLinearSubtaskIssueTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLinearSubtaskIssueTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLinearSubtaskIssueTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLinearSubtaskIssueTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLinearSubtaskIssueTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLinearSubtaskIssueTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateLinearSubtaskIssueTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLinearSubtaskIssueTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLinearSubtaskIssueTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLinearSubtaskIssueTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateLinearSubtaskIssueTaskParams
   */
  public static CreateLinearSubtaskIssueTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLinearSubtaskIssueTaskParams.class);
  }

  /**
   * Convert an instance of CreateLinearSubtaskIssueTaskParams to an JSON string
   *
   * @return JSON string
   */
