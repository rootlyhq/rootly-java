...
public class CreateAirtableTableRecordTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateAirtableTableRecordTaskParams createAirtableTableRecordTaskParams = (CreateAirtableTableRecordTaskParams) o;
    return Objects.equals(this.taskType, createAirtableTableRecordTaskParams.taskType) &&
        Objects.equals(this.base, createAirtableTableRecordTaskParams.base) &&
        Objects.equals(this.table, createAirtableTableRecordTaskParams.table) &&
        Objects.equals(this.customFieldsMapping, createAirtableTableRecordTaskParams.customFieldsMapping);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskType, base, table, customFieldsMapping);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAirtableTableRecordTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAirtableTableRecordTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAirtableTableRecordTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAirtableTableRecordTaskParams is not found in the empty JSON string", CreateAirtableTableRecordTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAirtableTableRecordTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAirtableTableRecordTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAirtableTableRecordTaskParams.openapiRequiredFields) {
      ...
      AddActionItemTaskParamsPostToSlackChannelsInner.validateJsonElement(jsonObj.get("base"));
      // validate the required field `table`
      AddActionItemTaskParamsPostToSlackChannelsInner.validateJsonElement(jsonObj.get("table"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAirtableTableRecordTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAirtableTableRecordTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAirtableTableRecordTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAirtableTableRecordTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAirtableTableRecordTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateAirtableTableRecordTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAirtableTableRecordTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAirtableTableRecordTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAirtableTableRecordTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateAirtableTableRecordTaskParams
   */
  public static CreateAirtableTableRecordTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAirtableTableRecordTaskParams.class);
  }

  /**
   * Convert an instance of CreateAirtableTableRecordTaskParams to an JSON string
   *
   * @return JSON string
   */
