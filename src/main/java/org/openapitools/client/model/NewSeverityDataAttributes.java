...
public class NewSeverityDataAttributes {
  ...
  public NewSeverityDataAttributes addNotifyEmailsItem(String notifyEmailsItem) {
  ...
  public NewSeverityDataAttributes addSlackChannelsItem(NewEnvironmentDataAttributesSlackChannelsInner slackChannelsItem) {
  ...
  public NewSeverityDataAttributes addSlackAliasesItem(NewEnvironmentDataAttributesSlackAliasesInner slackAliasesItem) {
  ...
  public boolean equals(Object o) {
    ...
    NewSeverityDataAttributes newSeverityDataAttributes = (NewSeverityDataAttributes) o;
    return Objects.equals(this.name, newSeverityDataAttributes.name) &&
        Objects.equals(this.description, newSeverityDataAttributes.description) &&
        Objects.equals(this.severity, newSeverityDataAttributes.severity) &&
        Objects.equals(this.color, newSeverityDataAttributes.color) &&
        Objects.equals(this.position, newSeverityDataAttributes.position) &&
        Objects.equals(this.notifyEmails, newSeverityDataAttributes.notifyEmails) &&
        Objects.equals(this.slackChannels, newSeverityDataAttributes.slackChannels) &&
        Objects.equals(this.slackAliases, newSeverityDataAttributes.slackAliases);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewSeverityDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewSeverityDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewSeverityDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewSeverityDataAttributes is not found in the empty JSON string", NewSeverityDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewSeverityDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewSeverityDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewSeverityDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewSeverityDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewSeverityDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewSeverityDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewSeverityDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewSeverityDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewSeverityDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewSeverityDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewSeverityDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewSeverityDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewSeverityDataAttributes
   */
  public static NewSeverityDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewSeverityDataAttributes.class);
  }

  /**
   * Convert an instance of NewSeverityDataAttributes to an JSON string
   *
   * @return JSON string
   */
