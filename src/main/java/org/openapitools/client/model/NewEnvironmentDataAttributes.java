...
public class NewEnvironmentDataAttributes {
  ...
  public NewEnvironmentDataAttributes name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public NewEnvironmentDataAttributes description(@javax.annotation.Nullable String description) {
  ...
  public NewEnvironmentDataAttributes color(@javax.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  public NewEnvironmentDataAttributes position(@javax.annotation.Nullable Integer position) {
  ...
  public NewEnvironmentDataAttributes notifyEmails(@javax.annotation.Nullable List<String> notifyEmails) {
    this.notifyEmails = notifyEmails;
    return this;
  }

  public NewEnvironmentDataAttributes addNotifyEmailsItem(String notifyEmailsItem) {
  ...
  public NewEnvironmentDataAttributes slackChannels(@javax.annotation.Nullable List<NewEnvironmentDataAttributesSlackChannelsInner> slackChannels) {
    this.slackChannels = slackChannels;
    return this;
  }

  public NewEnvironmentDataAttributes addSlackChannelsItem(NewEnvironmentDataAttributesSlackChannelsInner slackChannelsItem) {
  ...
  public NewEnvironmentDataAttributes slackAliases(@javax.annotation.Nullable List<NewEnvironmentDataAttributesSlackAliasesInner> slackAliases) {
    this.slackAliases = slackAliases;
    return this;
  }

  public NewEnvironmentDataAttributes addSlackAliasesItem(NewEnvironmentDataAttributesSlackAliasesInner slackAliasesItem) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewEnvironmentDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewEnvironmentDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewEnvironmentDataAttributes is not found in the empty JSON string", NewEnvironmentDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewEnvironmentDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewEnvironmentDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewEnvironmentDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewEnvironmentDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewEnvironmentDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewEnvironmentDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewEnvironmentDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewEnvironmentDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewEnvironmentDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewEnvironmentDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewEnvironmentDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewEnvironmentDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewEnvironmentDataAttributes
   */
  public static NewEnvironmentDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewEnvironmentDataAttributes.class);
  }

  /**
   * Convert an instance of NewEnvironmentDataAttributes to an JSON string
   *
   * @return JSON string
   */
