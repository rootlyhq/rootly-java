...
public class AttachDatadogDashboardsTaskParams {
  ...
  public AttachDatadogDashboardsTaskParams() {
  }

  public AttachDatadogDashboardsTaskParams taskType(@javax.annotation.Nullable TaskTypeEnum taskType) {
  ...
  public AttachDatadogDashboardsTaskParams dashboards(@javax.annotation.Nonnull List<AddActionItemTaskParamsPostToSlackChannelsInner> dashboards) {
    this.dashboards = dashboards;
    return this;
  }

  public AttachDatadogDashboardsTaskParams addDashboardsItem(AddActionItemTaskParamsPostToSlackChannelsInner dashboardsItem) {
  ...
  public AttachDatadogDashboardsTaskParams postToIncidentTimeline(@javax.annotation.Nullable Boolean postToIncidentTimeline) {
  ...
  public AttachDatadogDashboardsTaskParams postToSlackChannels(@javax.annotation.Nullable List<AddActionItemTaskParamsPostToSlackChannelsInner> postToSlackChannels) {
    this.postToSlackChannels = postToSlackChannels;
    return this;
  }

  public AttachDatadogDashboardsTaskParams addPostToSlackChannelsItem(AddActionItemTaskParamsPostToSlackChannelsInner postToSlackChannelsItem) {
  ...
  public boolean equals(Object o) {
    ...
    AttachDatadogDashboardsTaskParams attachDatadogDashboardsTaskParams = (AttachDatadogDashboardsTaskParams) o;
    return Objects.equals(this.taskType, attachDatadogDashboardsTaskParams.taskType) &&
        Objects.equals(this.dashboards, attachDatadogDashboardsTaskParams.dashboards) &&
        Objects.equals(this.postToIncidentTimeline, attachDatadogDashboardsTaskParams.postToIncidentTimeline) &&
        Objects.equals(this.postToSlackChannels, attachDatadogDashboardsTaskParams.postToSlackChannels);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttachDatadogDashboardsTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachDatadogDashboardsTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachDatadogDashboardsTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachDatadogDashboardsTaskParams is not found in the empty JSON string", AttachDatadogDashboardsTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachDatadogDashboardsTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachDatadogDashboardsTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttachDatadogDashboardsTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachDatadogDashboardsTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachDatadogDashboardsTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachDatadogDashboardsTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachDatadogDashboardsTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachDatadogDashboardsTaskParams>() {
           @Override
           public void write(JsonWriter out, AttachDatadogDashboardsTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachDatadogDashboardsTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttachDatadogDashboardsTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttachDatadogDashboardsTaskParams
   * @throws IOException if the JSON string is invalid with respect to AttachDatadogDashboardsTaskParams
   */
  public static AttachDatadogDashboardsTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachDatadogDashboardsTaskParams.class);
  }

  /**
   * Convert an instance of AttachDatadogDashboardsTaskParams to an JSON string
   *
   * @return JSON string
   */
