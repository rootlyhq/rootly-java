...
import org.openapitools.client.model.ScheduleSlackUserGroup;
...
public class Schedule {
  ...
  public Schedule name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public Schedule description(@javax.annotation.Nullable String description) {
  ...
  public Schedule allTimeCoverage(@javax.annotation.Nullable Boolean allTimeCoverage) {
  ...
  public Schedule slackUserGroup(@javax.annotation.Nullable ScheduleSlackUserGroup slackUserGroup) {
  ...
  public void setSlackUserGroup(@javax.annotation.Nullable ScheduleSlackUserGroup slackUserGroup) {
    this.slackUserGroup = slackUserGroup;
  }
  ...
  public Schedule createdAt(@javax.annotation.Nonnull String createdAt) {
  ...
  public Schedule updatedAt(@javax.annotation.Nonnull String updatedAt) {
