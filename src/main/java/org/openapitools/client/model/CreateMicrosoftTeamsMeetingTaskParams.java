...
public class CreateMicrosoftTeamsMeetingTaskParams {
  ...
  public CreateMicrosoftTeamsMeetingTaskParams() {
  }

  public CreateMicrosoftTeamsMeetingTaskParams taskType(@javax.annotation.Nullable TaskTypeEnum taskType) {
  ...
  public CreateMicrosoftTeamsMeetingTaskParams name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateMicrosoftTeamsMeetingTaskParams subject(@javax.annotation.Nonnull String subject) {
  ...
  public CreateMicrosoftTeamsMeetingTaskParams recordMeeting(@javax.annotation.Nullable Boolean recordMeeting) {
  ...
  public CreateMicrosoftTeamsMeetingTaskParams postToIncidentTimeline(@javax.annotation.Nullable Boolean postToIncidentTimeline) {
  ...
  public CreateMicrosoftTeamsMeetingTaskParams postToSlackChannels(@javax.annotation.Nullable List<AddActionItemTaskParamsPostToSlackChannelsInner> postToSlackChannels) {
    this.postToSlackChannels = postToSlackChannels;
    return this;
  }

  public CreateMicrosoftTeamsMeetingTaskParams addPostToSlackChannelsItem(AddActionItemTaskParamsPostToSlackChannelsInner postToSlackChannelsItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMicrosoftTeamsMeetingTaskParams createMicrosoftTeamsMeetingTaskParams = (CreateMicrosoftTeamsMeetingTaskParams) o;
    return Objects.equals(this.taskType, createMicrosoftTeamsMeetingTaskParams.taskType) &&
  ...
  public String toString() {
    ...
    sb.append("class CreateMicrosoftTeamsMeetingTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMicrosoftTeamsMeetingTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMicrosoftTeamsMeetingTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMicrosoftTeamsMeetingTaskParams is not found in the empty JSON string", CreateMicrosoftTeamsMeetingTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMicrosoftTeamsMeetingTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMicrosoftTeamsMeetingTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateMicrosoftTeamsMeetingTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMicrosoftTeamsMeetingTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMicrosoftTeamsMeetingTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMicrosoftTeamsMeetingTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMicrosoftTeamsMeetingTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMicrosoftTeamsMeetingTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateMicrosoftTeamsMeetingTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMicrosoftTeamsMeetingTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMicrosoftTeamsMeetingTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMicrosoftTeamsMeetingTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateMicrosoftTeamsMeetingTaskParams
   */
  public static CreateMicrosoftTeamsMeetingTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMicrosoftTeamsMeetingTaskParams.class);
  }

  /**
   * Convert an instance of CreateMicrosoftTeamsMeetingTaskParams to an JSON string
   *
   * @return JSON string
   */
