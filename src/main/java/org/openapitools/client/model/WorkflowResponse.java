...
public class WorkflowResponse {
  ...
  public WorkflowResponse data(@javax.annotation.Nonnull WorkflowResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull WorkflowResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, workflowResponse.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      WorkflowResponseData.validateJsonElement(jsonObj.get("data"));
  }
