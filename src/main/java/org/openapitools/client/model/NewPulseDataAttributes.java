...
public class NewPulseDataAttributes {
  ...
  public NewPulseDataAttributes labels(@javax.annotation.Nullable List<NewAlertDataAttributesLabelsInner> labels) {
    this.labels = labels;
    return this;
  }

  public NewPulseDataAttributes addLabelsItem(NewAlertDataAttributesLabelsInner labelsItem) {
    if (this.labels == null) {
