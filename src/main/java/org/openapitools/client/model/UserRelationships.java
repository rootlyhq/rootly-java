...
import org.openapitools.client.model.OnCallRoleRelationship;
import org.openapitools.client.model.RoleRelationship;
...
public class UserRelationships {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.role, userRelationships.role) &&
        Objects.equals(this.onCallRole, userRelationships.onCallRole);
  }

  @Override
  public int hashCode() {
    return Objects.hash(role, onCallRole);
  }
  ...
  public String toString() {
    ...
    sb.append("    onCallRole: ").append(toIndentedString(onCallRole)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("on_call_role");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("role") != null && !jsonObj.get("role").isJsonNull()) {
        RoleRelationship.validateJsonElement(jsonObj.get("role"));
      }
      // validate the optional field `on_call_role`
      if (jsonObj.get("on_call_role") != null && !jsonObj.get("on_call_role").isJsonNull()) {
        OnCallRoleRelationship.validateJsonElement(jsonObj.get("on_call_role"));
      }
  }
