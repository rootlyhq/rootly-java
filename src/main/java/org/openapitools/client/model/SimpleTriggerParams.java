...
public class SimpleTriggerParams {
  ...
  public SimpleTriggerParams addTriggersItem(TriggersEnum triggersItem) {
  ...
  public boolean equals(Object o) {
    ...
    SimpleTriggerParams simpleTriggerParams = (SimpleTriggerParams) o;
    return Objects.equals(this.triggerType, simpleTriggerParams.triggerType) &&
        Objects.equals(this.triggers, simpleTriggerParams.triggers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(triggerType, triggers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SimpleTriggerParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimpleTriggerParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimpleTriggerParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimpleTriggerParams is not found in the empty JSON string", SimpleTriggerParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimpleTriggerParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimpleTriggerParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SimpleTriggerParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimpleTriggerParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimpleTriggerParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimpleTriggerParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimpleTriggerParams.class));

       return (TypeAdapter<T>) new TypeAdapter<SimpleTriggerParams>() {
           @Override
           public void write(JsonWriter out, SimpleTriggerParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimpleTriggerParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SimpleTriggerParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SimpleTriggerParams
   * @throws IOException if the JSON string is invalid with respect to SimpleTriggerParams
   */
  public static SimpleTriggerParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimpleTriggerParams.class);
  }

  /**
   * Convert an instance of SimpleTriggerParams to an JSON string
   *
   * @return JSON string
   */
