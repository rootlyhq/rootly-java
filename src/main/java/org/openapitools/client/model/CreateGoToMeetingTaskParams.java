...
public class CreateGoToMeetingTaskParams {
  ...
  /**
   * Gets or Sets conferenceCallInfo
   */
  @JsonAdapter(ConferenceCallInfoEnum.Adapter.class)
  public enum ConferenceCallInfoEnum {
    PTSN("ptsn"),
    ...
    ConferenceCallInfoEnum(String value) {
      this.value = value;
    }
    ...
    public static ConferenceCallInfoEnum fromValue(String value) {
      for (ConferenceCallInfoEnum b : ConferenceCallInfoEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ConferenceCallInfoEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ConferenceCallInfoEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ConferenceCallInfoEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ConferenceCallInfoEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ConferenceCallInfoEnum.fromValue(value);
    }
  }
  ...
  public CreateGoToMeetingTaskParams addPostToSlackChannelsItem(AddActionItemTaskParamsPostToSlackChannelsInner postToSlackChannelsItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateGoToMeetingTaskParams createGoToMeetingTaskParams = (CreateGoToMeetingTaskParams) o;
    return Objects.equals(this.taskType, createGoToMeetingTaskParams.taskType) &&
        Objects.equals(this.subject, createGoToMeetingTaskParams.subject) &&
        Objects.equals(this.conferenceCallInfo, createGoToMeetingTaskParams.conferenceCallInfo) &&
        Objects.equals(this.passwordRequired, createGoToMeetingTaskParams.passwordRequired) &&
        Objects.equals(this.postToIncidentTimeline, createGoToMeetingTaskParams.postToIncidentTimeline) &&
        Objects.equals(this.postToSlackChannels, createGoToMeetingTaskParams.postToSlackChannels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskType, subject, conferenceCallInfo, passwordRequired, postToIncidentTimeline, postToSlackChannels);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGoToMeetingTaskParams {\n");
  ...
  static {
    ...
    openapiFields.add("conference_call_info");
    openapiFields.add("password_required");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGoToMeetingTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGoToMeetingTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGoToMeetingTaskParams is not found in the empty JSON string", CreateGoToMeetingTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGoToMeetingTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGoToMeetingTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGoToMeetingTaskParams.openapiRequiredFields) {
      ...
      if ((jsonObj.get("conference_call_info") != null && !jsonObj.get("conference_call_info").isJsonNull()) && !jsonObj.get("conference_call_info").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `conference_call_info` to be a primitive type in the JSON string but got `%s`", jsonObj.get("conference_call_info").toString()));
      }
      // validate the optional field `conference_call_info`
      if (jsonObj.get("conference_call_info") != null && !jsonObj.get("conference_call_info").isJsonNull()) {
        ConferenceCallInfoEnum.validateJsonElement(jsonObj.get("conference_call_info"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGoToMeetingTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGoToMeetingTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGoToMeetingTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGoToMeetingTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGoToMeetingTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateGoToMeetingTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGoToMeetingTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGoToMeetingTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGoToMeetingTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateGoToMeetingTaskParams
   */
  public static CreateGoToMeetingTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGoToMeetingTaskParams.class);
  }

  /**
   * Convert an instance of CreateGoToMeetingTaskParams to an JSON string
   *
   * @return JSON string
   */
