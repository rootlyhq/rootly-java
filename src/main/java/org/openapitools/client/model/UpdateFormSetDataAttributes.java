...
public class UpdateFormSetDataAttributes {
  ...
  public UpdateFormSetDataAttributes addFormsItem(String formsItem) {
    if (this.forms == null) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFormSetDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFormSetDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFormSetDataAttributes is not found in the empty JSON string", UpdateFormSetDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFormSetDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFormSetDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFormSetDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFormSetDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFormSetDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFormSetDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFormSetDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateFormSetDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFormSetDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFormSetDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFormSetDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateFormSetDataAttributes
   */
  public static UpdateFormSetDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFormSetDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateFormSetDataAttributes to an JSON string
   *
   * @return JSON string
   */
