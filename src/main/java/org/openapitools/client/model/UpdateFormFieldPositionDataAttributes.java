...
public class UpdateFormFieldPositionDataAttributes {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFormFieldPositionDataAttributes updateFormFieldPositionDataAttributes = (UpdateFormFieldPositionDataAttributes) o;
    return Objects.equals(this.formFieldId, updateFormFieldPositionDataAttributes.formFieldId) &&
        Objects.equals(this.form, updateFormFieldPositionDataAttributes.form) &&
        Objects.equals(this.position, updateFormFieldPositionDataAttributes.position);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFormFieldPositionDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFormFieldPositionDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFormFieldPositionDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFormFieldPositionDataAttributes is not found in the empty JSON string", UpdateFormFieldPositionDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFormFieldPositionDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFormFieldPositionDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFormFieldPositionDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFormFieldPositionDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFormFieldPositionDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFormFieldPositionDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFormFieldPositionDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateFormFieldPositionDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFormFieldPositionDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFormFieldPositionDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFormFieldPositionDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateFormFieldPositionDataAttributes
   */
  public static UpdateFormFieldPositionDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFormFieldPositionDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateFormFieldPositionDataAttributes to an JSON string
   *
   * @return JSON string
   */
