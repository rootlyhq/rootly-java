...
public class RemoveGoogleDocsPermissionsTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    RemoveGoogleDocsPermissionsTaskParams removeGoogleDocsPermissionsTaskParams = (RemoveGoogleDocsPermissionsTaskParams) o;
    return Objects.equals(this.taskType, removeGoogleDocsPermissionsTaskParams.taskType) &&
        Objects.equals(this.fileId, removeGoogleDocsPermissionsTaskParams.fileId) &&
        Objects.equals(this.attributeToQueryBy, removeGoogleDocsPermissionsTaskParams.attributeToQueryBy) &&
        Objects.equals(this.value, removeGoogleDocsPermissionsTaskParams.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, fileId, attributeToQueryBy, value);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemoveGoogleDocsPermissionsTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveGoogleDocsPermissionsTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveGoogleDocsPermissionsTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveGoogleDocsPermissionsTaskParams is not found in the empty JSON string", RemoveGoogleDocsPermissionsTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveGoogleDocsPermissionsTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveGoogleDocsPermissionsTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemoveGoogleDocsPermissionsTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveGoogleDocsPermissionsTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveGoogleDocsPermissionsTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveGoogleDocsPermissionsTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveGoogleDocsPermissionsTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveGoogleDocsPermissionsTaskParams>() {
           @Override
           public void write(JsonWriter out, RemoveGoogleDocsPermissionsTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveGoogleDocsPermissionsTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveGoogleDocsPermissionsTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveGoogleDocsPermissionsTaskParams
   * @throws IOException if the JSON string is invalid with respect to RemoveGoogleDocsPermissionsTaskParams
   */
  public static RemoveGoogleDocsPermissionsTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveGoogleDocsPermissionsTaskParams.class);
  }

  /**
   * Convert an instance of RemoveGoogleDocsPermissionsTaskParams to an JSON string
   *
   * @return JSON string
   */
