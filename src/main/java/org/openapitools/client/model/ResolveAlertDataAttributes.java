...
public class ResolveAlertDataAttributes {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResolveAlertDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResolveAlertDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResolveAlertDataAttributes is not found in the empty JSON string", ResolveAlertDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResolveAlertDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResolveAlertDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResolveAlertDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResolveAlertDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResolveAlertDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResolveAlertDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ResolveAlertDataAttributes>() {
           @Override
           public void write(JsonWriter out, ResolveAlertDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResolveAlertDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResolveAlertDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResolveAlertDataAttributes
   * @throws IOException if the JSON string is invalid with respect to ResolveAlertDataAttributes
   */
  public static ResolveAlertDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResolveAlertDataAttributes.class);
  }

  /**
   * Convert an instance of ResolveAlertDataAttributes to an JSON string
   *
   * @return JSON string
   */
