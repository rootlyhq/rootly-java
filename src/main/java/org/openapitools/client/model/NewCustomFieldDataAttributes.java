...
public class NewCustomFieldDataAttributes {
  ...
  public NewCustomFieldDataAttributes() {
  }

  public NewCustomFieldDataAttributes label(@javax.annotation.Nonnull String label) {
    this.label = label;
    return this;
  }
  ...
  public NewCustomFieldDataAttributes description(@javax.annotation.Nullable String description) {
  ...
  public NewCustomFieldDataAttributes shown(@javax.annotation.Nullable List<ShownEnum> shown) {
    this.shown = shown;
    return this;
  }

  public NewCustomFieldDataAttributes addShownItem(ShownEnum shownItem) {
    if (this.shown == null) {
  ...
  public NewCustomFieldDataAttributes required(@javax.annotation.Nullable List<RequiredEnum> required) {
    this.required = required;
    return this;
  }

  public NewCustomFieldDataAttributes addRequiredItem(RequiredEnum requiredItem) {
  ...
  public NewCustomFieldDataAttributes _default(@javax.annotation.Nullable String _default) {
  ...
  public NewCustomFieldDataAttributes position(@javax.annotation.Nullable Integer position) {
  ...
  public boolean equals(Object o) {
    ...
    NewCustomFieldDataAttributes newCustomFieldDataAttributes = (NewCustomFieldDataAttributes) o;
    return Objects.equals(this.label, newCustomFieldDataAttributes.label) &&
        Objects.equals(this.description, newCustomFieldDataAttributes.description) &&
        Objects.equals(this.shown, newCustomFieldDataAttributes.shown) &&
        Objects.equals(this.required, newCustomFieldDataAttributes.required) &&
        Objects.equals(this._default, newCustomFieldDataAttributes._default) &&
        Objects.equals(this.position, newCustomFieldDataAttributes.position);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewCustomFieldDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewCustomFieldDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewCustomFieldDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewCustomFieldDataAttributes is not found in the empty JSON string", NewCustomFieldDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewCustomFieldDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewCustomFieldDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewCustomFieldDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewCustomFieldDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewCustomFieldDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewCustomFieldDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewCustomFieldDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewCustomFieldDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewCustomFieldDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewCustomFieldDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewCustomFieldDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewCustomFieldDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewCustomFieldDataAttributes
   */
  public static NewCustomFieldDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewCustomFieldDataAttributes.class);
  }

  /**
   * Convert an instance of NewCustomFieldDataAttributes to an JSON string
   *
   * @return JSON string
   */
