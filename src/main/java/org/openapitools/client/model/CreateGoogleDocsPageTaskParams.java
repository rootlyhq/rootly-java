...
public class CreateGoogleDocsPageTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateGoogleDocsPageTaskParams createGoogleDocsPageTaskParams = (CreateGoogleDocsPageTaskParams) o;
    return Objects.equals(this.taskType, createGoogleDocsPageTaskParams.taskType) &&
        Objects.equals(this.postMortemTemplateId, createGoogleDocsPageTaskParams.postMortemTemplateId) &&
        Objects.equals(this.markPostMortemAsPublished, createGoogleDocsPageTaskParams.markPostMortemAsPublished) &&
        Objects.equals(this.title, createGoogleDocsPageTaskParams.title) &&
        Objects.equals(this.drive, createGoogleDocsPageTaskParams.drive) &&
  ...
  public String toString() {
    ...
    sb.append("class CreateGoogleDocsPageTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGoogleDocsPageTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGoogleDocsPageTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGoogleDocsPageTaskParams is not found in the empty JSON string", CreateGoogleDocsPageTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGoogleDocsPageTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGoogleDocsPageTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGoogleDocsPageTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGoogleDocsPageTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGoogleDocsPageTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGoogleDocsPageTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGoogleDocsPageTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGoogleDocsPageTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateGoogleDocsPageTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGoogleDocsPageTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGoogleDocsPageTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGoogleDocsPageTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateGoogleDocsPageTaskParams
   */
  public static CreateGoogleDocsPageTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGoogleDocsPageTaskParams.class);
  }

  /**
   * Convert an instance of CreateGoogleDocsPageTaskParams to an JSON string
   *
   * @return JSON string
   */
