...
public class CreateSlackChannelTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateSlackChannelTaskParams createSlackChannelTaskParams = (CreateSlackChannelTaskParams) o;
  ...
  public String toString() {
    ...
    sb.append("class CreateSlackChannelTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSlackChannelTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSlackChannelTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSlackChannelTaskParams is not found in the empty JSON string", CreateSlackChannelTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSlackChannelTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSlackChannelTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSlackChannelTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSlackChannelTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSlackChannelTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSlackChannelTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSlackChannelTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSlackChannelTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateSlackChannelTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSlackChannelTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSlackChannelTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSlackChannelTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateSlackChannelTaskParams
   */
  public static CreateSlackChannelTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSlackChannelTaskParams.class);
  }

  /**
   * Convert an instance of CreateSlackChannelTaskParams to an JSON string
   *
   * @return JSON string
   */
