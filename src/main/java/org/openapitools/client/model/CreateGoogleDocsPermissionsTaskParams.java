...
public class CreateGoogleDocsPermissionsTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateGoogleDocsPermissionsTaskParams createGoogleDocsPermissionsTaskParams = (CreateGoogleDocsPermissionsTaskParams) o;
    return Objects.equals(this.taskType, createGoogleDocsPermissionsTaskParams.taskType) &&
        Objects.equals(this.fileId, createGoogleDocsPermissionsTaskParams.fileId) &&
        Objects.equals(this.permissions, createGoogleDocsPermissionsTaskParams.permissions) &&
        Objects.equals(this.sendNotificationEmail, createGoogleDocsPermissionsTaskParams.sendNotificationEmail) &&
        Objects.equals(this.emailMessage, createGoogleDocsPermissionsTaskParams.emailMessage);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskType, fileId, permissions, sendNotificationEmail, emailMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGoogleDocsPermissionsTaskParams {\n");
  ...
  static {
    ...
    openapiFields.add("send_notification_email");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGoogleDocsPermissionsTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGoogleDocsPermissionsTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGoogleDocsPermissionsTaskParams is not found in the empty JSON string", CreateGoogleDocsPermissionsTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGoogleDocsPermissionsTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGoogleDocsPermissionsTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGoogleDocsPermissionsTaskParams.openapiRequiredFields) {
      ...
      if ((jsonObj.get("email_message") != null && !jsonObj.get("email_message").isJsonNull()) && !jsonObj.get("email_message").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGoogleDocsPermissionsTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGoogleDocsPermissionsTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGoogleDocsPermissionsTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGoogleDocsPermissionsTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGoogleDocsPermissionsTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateGoogleDocsPermissionsTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGoogleDocsPermissionsTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGoogleDocsPermissionsTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGoogleDocsPermissionsTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateGoogleDocsPermissionsTaskParams
   */
  public static CreateGoogleDocsPermissionsTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGoogleDocsPermissionsTaskParams.class);
  }

  /**
   * Convert an instance of CreateGoogleDocsPermissionsTaskParams to an JSON string
   *
   * @return JSON string
   */
