...
public class UpdateNotionPageTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNotionPageTaskParams updateNotionPageTaskParams = (UpdateNotionPageTaskParams) o;
    return Objects.equals(this.taskType, updateNotionPageTaskParams.taskType) &&
        Objects.equals(this.fileId, updateNotionPageTaskParams.fileId) &&
        Objects.equals(this.title, updateNotionPageTaskParams.title) &&
        Objects.equals(this.postMortemTemplateId, updateNotionPageTaskParams.postMortemTemplateId) &&
        Objects.equals(this.showTimelineAsTable, updateNotionPageTaskParams.showTimelineAsTable) &&
        Objects.equals(this.showActionItemsAsTable, updateNotionPageTaskParams.showActionItemsAsTable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, fileId, title, postMortemTemplateId, showTimelineAsTable, showActionItemsAsTable);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateNotionPageTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNotionPageTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNotionPageTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNotionPageTaskParams is not found in the empty JSON string", UpdateNotionPageTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNotionPageTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNotionPageTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateNotionPageTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNotionPageTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNotionPageTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNotionPageTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNotionPageTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNotionPageTaskParams>() {
           @Override
           public void write(JsonWriter out, UpdateNotionPageTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNotionPageTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNotionPageTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNotionPageTaskParams
   * @throws IOException if the JSON string is invalid with respect to UpdateNotionPageTaskParams
   */
  public static UpdateNotionPageTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNotionPageTaskParams.class);
  }

  /**
   * Convert an instance of UpdateNotionPageTaskParams to an JSON string
   *
   * @return JSON string
   */
