...
public class CreateSharepointPageTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateSharepointPageTaskParams createSharepointPageTaskParams = (CreateSharepointPageTaskParams) o;
    return Objects.equals(this.taskType, createSharepointPageTaskParams.taskType) &&
        Objects.equals(this.postMortemTemplateId, createSharepointPageTaskParams.postMortemTemplateId) &&
        Objects.equals(this.markPostMortemAsPublished, createSharepointPageTaskParams.markPostMortemAsPublished) &&
        Objects.equals(this.title, createSharepointPageTaskParams.title) &&
        Objects.equals(this.site, createSharepointPageTaskParams.site) &&
        Objects.equals(this.drive, createSharepointPageTaskParams.drive) &&
        Objects.equals(this.parentFolder, createSharepointPageTaskParams.parentFolder) &&
        Objects.equals(this.content, createSharepointPageTaskParams.content) &&
        Objects.equals(this.templateId, createSharepointPageTaskParams.templateId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, postMortemTemplateId, markPostMortemAsPublished, title, site, drive, parentFolder, content, templateId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSharepointPageTaskParams {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("drive");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSharepointPageTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSharepointPageTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSharepointPageTaskParams is not found in the empty JSON string", CreateSharepointPageTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSharepointPageTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSharepointPageTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSharepointPageTaskParams.openapiRequiredFields) {
      ...
      AddActionItemTaskParamsPostToSlackChannelsInner.validateJsonElement(jsonObj.get("site"));
      // validate the required field `drive`
      AddActionItemTaskParamsPostToSlackChannelsInner.validateJsonElement(jsonObj.get("drive"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSharepointPageTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSharepointPageTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSharepointPageTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSharepointPageTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSharepointPageTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateSharepointPageTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSharepointPageTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSharepointPageTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSharepointPageTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateSharepointPageTaskParams
   */
  public static CreateSharepointPageTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSharepointPageTaskParams.class);
  }

  /**
   * Convert an instance of CreateSharepointPageTaskParams to an JSON string
   *
   * @return JSON string
   */
