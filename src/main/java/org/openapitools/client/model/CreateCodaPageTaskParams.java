...
import org.openapitools.client.model.CreateCodaPageTaskParamsTemplate;
...
public class CreateCodaPageTaskParams {
  ...
  public CreateCodaPageTaskParams taskType(@javax.annotation.Nullable TaskTypeEnum taskType) {
  ...
  public CreateCodaPageTaskParams postMortemTemplateId(@javax.annotation.Nullable String postMortemTemplateId) {
  ...
  public CreateCodaPageTaskParams markPostMortemAsPublished(@javax.annotation.Nullable Boolean markPostMortemAsPublished) {
  ...
  public CreateCodaPageTaskParams title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public CreateCodaPageTaskParams subtitle(@javax.annotation.Nullable String subtitle) {
  ...
  public CreateCodaPageTaskParams content(@javax.annotation.Nullable String content) {
  ...
  public CreateCodaPageTaskParams template(@javax.annotation.Nullable CreateCodaPageTaskParamsTemplate template) {
  ...
  public CreateCodaPageTaskParams folderId(@javax.annotation.Nullable String folderId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCodaPageTaskParams createCodaPageTaskParams = (CreateCodaPageTaskParams) o;
    return Objects.equals(this.taskType, createCodaPageTaskParams.taskType) &&
        Objects.equals(this.postMortemTemplateId, createCodaPageTaskParams.postMortemTemplateId) &&
        Objects.equals(this.markPostMortemAsPublished, createCodaPageTaskParams.markPostMortemAsPublished) &&
        Objects.equals(this.title, createCodaPageTaskParams.title) &&
  ...
  public String toString() {
    ...
    sb.append("class CreateCodaPageTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCodaPageTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCodaPageTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCodaPageTaskParams is not found in the empty JSON string", CreateCodaPageTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCodaPageTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCodaPageTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCodaPageTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCodaPageTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCodaPageTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCodaPageTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCodaPageTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCodaPageTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateCodaPageTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCodaPageTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCodaPageTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCodaPageTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateCodaPageTaskParams
   */
  public static CreateCodaPageTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCodaPageTaskParams.class);
  }

  /**
   * Convert an instance of CreateCodaPageTaskParams to an JSON string
   *
   * @return JSON string
   */
