...
public class UpdateLinearIssueTaskParams {
  ...
  public UpdateLinearIssueTaskParams state(@javax.annotation.Nullable CreateLinearIssueTaskParamsState state) {
    this.state = state;
    return this;
  }
  ...
  public void setState(@javax.annotation.Nullable CreateLinearIssueTaskParamsState state) {
    this.state = state;
  }
