...
public class CreateJiraIssueTaskParams {
  ...
  @javax.annotation.Nonnull
  private CreateJiraIssueTaskParamsIssueType issueType;
  ...
  public CreateJiraIssueTaskParams taskType(@javax.annotation.Nullable TaskTypeEnum taskType) {
  ...
  public CreateJiraIssueTaskParams integration(@javax.annotation.Nullable CreateJiraIssueTaskParamsIntegration integration) {
  ...
  public CreateJiraIssueTaskParams title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public CreateJiraIssueTaskParams description(@javax.annotation.Nullable String description) {
  ...
  public CreateJiraIssueTaskParams labels(@javax.annotation.Nullable String labels) {
    this.labels = labels;
    return this;
  }
  ...
  public CreateJiraIssueTaskParams assignUserEmail(@javax.annotation.Nullable String assignUserEmail) {
  ...
  public CreateJiraIssueTaskParams reporterUserEmail(@javax.annotation.Nullable String reporterUserEmail) {
  ...
  public CreateJiraIssueTaskParams projectKey(@javax.annotation.Nonnull String projectKey) {
  ...
  public CreateJiraIssueTaskParams dueDate(@javax.annotation.Nullable String dueDate) {
  ...
  public CreateJiraIssueTaskParams issueType(@javax.annotation.Nonnull CreateJiraIssueTaskParamsIssueType issueType) {
   ...
   */
  @javax.annotation.Nonnull
  public CreateJiraIssueTaskParamsIssueType getIssueType() {
    return issueType;
  }

  public void setIssueType(@javax.annotation.Nonnull CreateJiraIssueTaskParamsIssueType issueType) {
    this.issueType = issueType;
  }


  public CreateJiraIssueTaskParams priority(@javax.annotation.Nullable CreateJiraIssueTaskParamsPriority priority) {
  ...
  public CreateJiraIssueTaskParams status(@javax.annotation.Nullable CreateJiraIssueTaskParamsStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateJiraIssueTaskParams customFieldsMapping(@javax.annotation.Nullable String customFieldsMapping) {
  ...
  public CreateJiraIssueTaskParams updatePayload(@javax.annotation.Nullable String updatePayload) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJiraIssueTaskParams createJiraIssueTaskParams = (CreateJiraIssueTaskParams) o;
    return Objects.equals(this.taskType, createJiraIssueTaskParams.taskType) &&
        Objects.equals(this.integration, createJiraIssueTaskParams.integration) &&
        Objects.equals(this.title, createJiraIssueTaskParams.title) &&
        Objects.equals(this.description, createJiraIssueTaskParams.description) &&
        Objects.equals(this.labels, createJiraIssueTaskParams.labels) &&
        Objects.equals(this.assignUserEmail, createJiraIssueTaskParams.assignUserEmail) &&
        Objects.equals(this.reporterUserEmail, createJiraIssueTaskParams.reporterUserEmail) &&
        Objects.equals(this.projectKey, createJiraIssueTaskParams.projectKey) &&
        Objects.equals(this.dueDate, createJiraIssueTaskParams.dueDate) &&
        Objects.equals(this.issueType, createJiraIssueTaskParams.issueType) &&
  ...
  public String toString() {
    ...
    sb.append("class CreateJiraIssueTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJiraIssueTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJiraIssueTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJiraIssueTaskParams is not found in the empty JSON string", CreateJiraIssueTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJiraIssueTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJiraIssueTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateJiraIssueTaskParams.openapiRequiredFields) {
      ...
      CreateJiraIssueTaskParamsIssueType.validateJsonElement(jsonObj.get("issue_type"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJiraIssueTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJiraIssueTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJiraIssueTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJiraIssueTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJiraIssueTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateJiraIssueTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJiraIssueTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJiraIssueTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJiraIssueTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateJiraIssueTaskParams
   */
  public static CreateJiraIssueTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJiraIssueTaskParams.class);
  }

  /**
   * Convert an instance of CreateJiraIssueTaskParams to an JSON string
   *
   * @return JSON string
   */
