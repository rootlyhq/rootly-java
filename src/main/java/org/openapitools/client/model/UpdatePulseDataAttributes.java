...
import org.openapitools.client.model.NewPulseDataAttributesRefsInner;
...
public class UpdatePulseDataAttributes {
  ...
  public UpdatePulseDataAttributes() {
  }

  public UpdatePulseDataAttributes source(@javax.annotation.Nullable String source) {
    this.source = source;
    return this;
  }
  ...
  public UpdatePulseDataAttributes summary(@javax.annotation.Nullable String summary) {
  ...
  public UpdatePulseDataAttributes serviceIds(@javax.annotation.Nullable List<String> serviceIds) {
    this.serviceIds = serviceIds;
    return this;
  }

  public UpdatePulseDataAttributes addServiceIdsItem(String serviceIdsItem) {
  ...
  public UpdatePulseDataAttributes environmentIds(@javax.annotation.Nullable List<String> environmentIds) {
    this.environmentIds = environmentIds;
    return this;
  }

  public UpdatePulseDataAttributes addEnvironmentIdsItem(String environmentIdsItem) {
  ...
  public UpdatePulseDataAttributes startedAt(@javax.annotation.Nullable OffsetDateTime startedAt) {
  ...
  public UpdatePulseDataAttributes endedAt(@javax.annotation.Nullable OffsetDateTime endedAt) {
  ...
  public UpdatePulseDataAttributes externalUrl(@javax.annotation.Nullable String externalUrl) {
  ...
  public UpdatePulseDataAttributes refs(@javax.annotation.Nullable List<NewPulseDataAttributesRefsInner> refs) {
    this.refs = refs;
    return this;
  }

  public UpdatePulseDataAttributes addRefsItem(NewPulseDataAttributesRefsInner refsItem) {
    if (this.refs == null) {
  ...
  public UpdatePulseDataAttributes data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePulseDataAttributes updatePulseDataAttributes = (UpdatePulseDataAttributes) o;
    return Objects.equals(this.source, updatePulseDataAttributes.source) &&
        Objects.equals(this.summary, updatePulseDataAttributes.summary) &&
        Objects.equals(this.serviceIds, updatePulseDataAttributes.serviceIds) &&
        Objects.equals(this.environmentIds, updatePulseDataAttributes.environmentIds) &&
        Objects.equals(this.startedAt, updatePulseDataAttributes.startedAt) &&
        Objects.equals(this.endedAt, updatePulseDataAttributes.endedAt) &&
        Objects.equals(this.externalUrl, updatePulseDataAttributes.externalUrl) &&
        Objects.equals(this.labels, updatePulseDataAttributes.labels) &&
        Objects.equals(this.refs, updatePulseDataAttributes.refs) &&
        Objects.equals(this.data, updatePulseDataAttributes.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePulseDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePulseDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePulseDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePulseDataAttributes is not found in the empty JSON string", UpdatePulseDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePulseDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePulseDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePulseDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePulseDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePulseDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePulseDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePulseDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdatePulseDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePulseDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePulseDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePulseDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdatePulseDataAttributes
   */
  public static UpdatePulseDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePulseDataAttributes.class);
  }

  /**
   * Convert an instance of UpdatePulseDataAttributes to an JSON string
   *
   * @return JSON string
   */
