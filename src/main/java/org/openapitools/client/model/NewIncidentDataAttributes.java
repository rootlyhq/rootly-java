...
public class NewIncidentDataAttributes {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, kind, parentIncidentId, duplicateIncidentId, _private, summary, userId, severityId, environmentIds, incidentTypeIds, serviceIds, functionalityIds, groupIds, causeIds, labels, slackChannelName, notifyEmails, status, url, scheduledFor, scheduledUntil, inTriageAt, startedAt, detectedAt, acknowledgedAt, mitigatedAt, resolvedAt, cancelledAt);
  }
