...
public class SnapshotGrafanaDashboardTaskParams {
  ...
  public SnapshotGrafanaDashboardTaskParams addDashboardsItem(AddActionItemTaskParamsPostToSlackChannelsInner dashboardsItem) {
  ...
  public SnapshotGrafanaDashboardTaskParams addPostToSlackChannelsItem(AddActionItemTaskParamsPostToSlackChannelsInner postToSlackChannelsItem) {
  ...
  public boolean equals(Object o) {
    ...
    SnapshotGrafanaDashboardTaskParams snapshotGrafanaDashboardTaskParams = (SnapshotGrafanaDashboardTaskParams) o;
    return Objects.equals(this.taskType, snapshotGrafanaDashboardTaskParams.taskType) &&
        Objects.equals(this.dashboards, snapshotGrafanaDashboardTaskParams.dashboards) &&
        Objects.equals(this.postToIncidentTimeline, snapshotGrafanaDashboardTaskParams.postToIncidentTimeline) &&
        Objects.equals(this.postToSlackChannels, snapshotGrafanaDashboardTaskParams.postToSlackChannels);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnapshotGrafanaDashboardTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SnapshotGrafanaDashboardTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SnapshotGrafanaDashboardTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnapshotGrafanaDashboardTaskParams is not found in the empty JSON string", SnapshotGrafanaDashboardTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SnapshotGrafanaDashboardTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SnapshotGrafanaDashboardTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnapshotGrafanaDashboardTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnapshotGrafanaDashboardTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnapshotGrafanaDashboardTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnapshotGrafanaDashboardTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnapshotGrafanaDashboardTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<SnapshotGrafanaDashboardTaskParams>() {
           @Override
           public void write(JsonWriter out, SnapshotGrafanaDashboardTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SnapshotGrafanaDashboardTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SnapshotGrafanaDashboardTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SnapshotGrafanaDashboardTaskParams
   * @throws IOException if the JSON string is invalid with respect to SnapshotGrafanaDashboardTaskParams
   */
  public static SnapshotGrafanaDashboardTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnapshotGrafanaDashboardTaskParams.class);
  }

  /**
   * Convert an instance of SnapshotGrafanaDashboardTaskParams to an JSON string
   *
   * @return JSON string
   */
