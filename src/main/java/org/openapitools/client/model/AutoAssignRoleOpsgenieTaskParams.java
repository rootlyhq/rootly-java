...
public class AutoAssignRoleOpsgenieTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    AutoAssignRoleOpsgenieTaskParams autoAssignRoleOpsgenieTaskParams = (AutoAssignRoleOpsgenieTaskParams) o;
    return Objects.equals(this.taskType, autoAssignRoleOpsgenieTaskParams.taskType) &&
        Objects.equals(this.incidentRoleId, autoAssignRoleOpsgenieTaskParams.incidentRoleId) &&
        Objects.equals(this.schedule, autoAssignRoleOpsgenieTaskParams.schedule);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, incidentRoleId, schedule);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AutoAssignRoleOpsgenieTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutoAssignRoleOpsgenieTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoAssignRoleOpsgenieTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoAssignRoleOpsgenieTaskParams is not found in the empty JSON string", AutoAssignRoleOpsgenieTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoAssignRoleOpsgenieTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoAssignRoleOpsgenieTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AutoAssignRoleOpsgenieTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutoAssignRoleOpsgenieTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutoAssignRoleOpsgenieTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutoAssignRoleOpsgenieTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoAssignRoleOpsgenieTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoAssignRoleOpsgenieTaskParams>() {
           @Override
           public void write(JsonWriter out, AutoAssignRoleOpsgenieTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutoAssignRoleOpsgenieTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutoAssignRoleOpsgenieTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutoAssignRoleOpsgenieTaskParams
   * @throws IOException if the JSON string is invalid with respect to AutoAssignRoleOpsgenieTaskParams
   */
  public static AutoAssignRoleOpsgenieTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutoAssignRoleOpsgenieTaskParams.class);
  }

  /**
   * Convert an instance of AutoAssignRoleOpsgenieTaskParams to an JSON string
   *
   * @return JSON string
   */
