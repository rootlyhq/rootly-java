...
import org.openapitools.client.model.NewLiveCallRouterDataAttributesEscalationPolicyTriggerParams;
...
public class NewLiveCallRouterDataAttributes {
  ...
  public NewLiveCallRouterDataAttributes voicemailGreeting(@javax.annotation.Nullable String voicemailGreeting) {
  ...
  public NewLiveCallRouterDataAttributes waitingMusicUrl(@javax.annotation.Nullable String waitingMusicUrl) {
  ...
  public NewLiveCallRouterDataAttributes escalationPolicyTriggerParams(@javax.annotation.Nonnull NewLiveCallRouterDataAttributesEscalationPolicyTriggerParams escalationPolicyTriggerParams) {
  ...
  public void setEscalationPolicyTriggerParams(@javax.annotation.Nonnull NewLiveCallRouterDataAttributesEscalationPolicyTriggerParams escalationPolicyTriggerParams) {
    this.escalationPolicyTriggerParams = escalationPolicyTriggerParams;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, enabled, name, countryCode, phoneType, phoneNumber, voicemailGreeting, callerGreeting, waitingMusicUrl, sentToVoicemailDelay, shouldRedirectToVoicemailOnNoAnswer, escalationLevelDelayInSeconds, shouldAutoResolveAlertOnCallEnd, alertUrgencyId, escalationPolicyTriggerParams);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("escalation_policy_trigger_params");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `escalation_policy_trigger_params`
