...
public class RedisClientTaskParams {
  ...
  public RedisClientTaskParams addPostToSlackChannelsItem(AddActionItemTaskParamsPostToSlackChannelsInner postToSlackChannelsItem) {
  ...
  public boolean equals(Object o) {
    ...
    RedisClientTaskParams redisClientTaskParams = (RedisClientTaskParams) o;
    return Objects.equals(this.taskType, redisClientTaskParams.taskType) &&
        Objects.equals(this.url, redisClientTaskParams.url) &&
        Objects.equals(this.commands, redisClientTaskParams.commands) &&
        Objects.equals(this.eventUrl, redisClientTaskParams.eventUrl) &&
        Objects.equals(this.eventMessage, redisClientTaskParams.eventMessage) &&
        Objects.equals(this.postToIncidentTimeline, redisClientTaskParams.postToIncidentTimeline) &&
        Objects.equals(this.postToSlackChannels, redisClientTaskParams.postToSlackChannels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, url, commands, eventUrl, eventMessage, postToIncidentTimeline, postToSlackChannels);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RedisClientTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RedisClientTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedisClientTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedisClientTaskParams is not found in the empty JSON string", RedisClientTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedisClientTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedisClientTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RedisClientTaskParams.openapiRequiredFields) {
      ...
      if (!jsonObj.get("commands").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `commands` to be a primitive type in the JSON string but got `%s`", jsonObj.get("commands").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedisClientTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedisClientTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedisClientTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedisClientTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<RedisClientTaskParams>() {
           @Override
           public void write(JsonWriter out, RedisClientTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RedisClientTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RedisClientTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RedisClientTaskParams
   * @throws IOException if the JSON string is invalid with respect to RedisClientTaskParams
   */
  public static RedisClientTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedisClientTaskParams.class);
  }

  /**
   * Convert an instance of RedisClientTaskParams to an JSON string
   *
   * @return JSON string
   */
