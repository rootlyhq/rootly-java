...
public class InviteToMicrosoftTeamsChannelTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    InviteToMicrosoftTeamsChannelTaskParams inviteToMicrosoftTeamsChannelTaskParams = (InviteToMicrosoftTeamsChannelTaskParams) o;
    return Objects.equals(this.taskType, inviteToMicrosoftTeamsChannelTaskParams.taskType) &&
        Objects.equals(this.team, inviteToMicrosoftTeamsChannelTaskParams.team) &&
        Objects.equals(this.channel, inviteToMicrosoftTeamsChannelTaskParams.channel) &&
        Objects.equals(this.emails, inviteToMicrosoftTeamsChannelTaskParams.emails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, team, channel, emails);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InviteToMicrosoftTeamsChannelTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InviteToMicrosoftTeamsChannelTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InviteToMicrosoftTeamsChannelTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InviteToMicrosoftTeamsChannelTaskParams is not found in the empty JSON string", InviteToMicrosoftTeamsChannelTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InviteToMicrosoftTeamsChannelTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InviteToMicrosoftTeamsChannelTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InviteToMicrosoftTeamsChannelTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InviteToMicrosoftTeamsChannelTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InviteToMicrosoftTeamsChannelTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InviteToMicrosoftTeamsChannelTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InviteToMicrosoftTeamsChannelTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<InviteToMicrosoftTeamsChannelTaskParams>() {
           @Override
           public void write(JsonWriter out, InviteToMicrosoftTeamsChannelTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InviteToMicrosoftTeamsChannelTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InviteToMicrosoftTeamsChannelTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InviteToMicrosoftTeamsChannelTaskParams
   * @throws IOException if the JSON string is invalid with respect to InviteToMicrosoftTeamsChannelTaskParams
   */
  public static InviteToMicrosoftTeamsChannelTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InviteToMicrosoftTeamsChannelTaskParams.class);
  }

  /**
   * Convert an instance of InviteToMicrosoftTeamsChannelTaskParams to an JSON string
   *
   * @return JSON string
   */
