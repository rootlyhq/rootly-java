...
public class Pulse {
  ...
  public Pulse labels(@javax.annotation.Nullable List<NewAlertDataAttributesLabelsInner> labels) {
    this.labels = labels;
    return this;
  }

  public Pulse addLabelsItem(NewAlertDataAttributesLabelsInner labelsItem) {
    if (this.labels == null) {
