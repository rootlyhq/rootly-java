...
import org.openapitools.client.model.NewWorkflowDataAttributesTriggerParams;
...
public class UpdateWorkflowDataAttributes {
  ...
  public UpdateWorkflowDataAttributes name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateWorkflowDataAttributes slug(@javax.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public UpdateWorkflowDataAttributes description(@javax.annotation.Nullable String description) {
  ...
  public UpdateWorkflowDataAttributes command(@javax.annotation.Nullable String command) {
  ...
  public UpdateWorkflowDataAttributes commandFeedbackEnabled(@javax.annotation.Nullable Boolean commandFeedbackEnabled) {
  ...
  public UpdateWorkflowDataAttributes wait(@javax.annotation.Nullable String wait) {
    this.wait = wait;
    return this;
  }
  ...
  public UpdateWorkflowDataAttributes repeatEveryDuration(@javax.annotation.Nullable String repeatEveryDuration) {
  ...
  public UpdateWorkflowDataAttributes repeatConditionDurationSinceFirstRun(@javax.annotation.Nullable String repeatConditionDurationSinceFirstRun) {
  ...
  public UpdateWorkflowDataAttributes repeatConditionNumberOfRepeats(@javax.annotation.Nullable Integer repeatConditionNumberOfRepeats) {
  ...
  public UpdateWorkflowDataAttributes continuouslyRepeat(@javax.annotation.Nullable Boolean continuouslyRepeat) {
  ...
  public UpdateWorkflowDataAttributes enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public UpdateWorkflowDataAttributes locked(@javax.annotation.Nullable Boolean locked) {
    this.locked = locked;
    return this;
  }
  ...
  public UpdateWorkflowDataAttributes position(@javax.annotation.Nullable Integer position) {
  ...
  public UpdateWorkflowDataAttributes workflowGroupId(@javax.annotation.Nullable String workflowGroupId) {
  ...
  public UpdateWorkflowDataAttributes triggerParams(@javax.annotation.Nullable NewWorkflowDataAttributesTriggerParams triggerParams) {
  ...
  public UpdateWorkflowDataAttributes environmentIds(@javax.annotation.Nullable List<String> environmentIds) {
  ...
  public UpdateWorkflowDataAttributes severityIds(@javax.annotation.Nullable List<String> severityIds) {
  ...
  public UpdateWorkflowDataAttributes incidentTypeIds(@javax.annotation.Nullable List<String> incidentTypeIds) {
  ...
  public UpdateWorkflowDataAttributes incidentRoleIds(@javax.annotation.Nullable List<String> incidentRoleIds) {
  ...
  public UpdateWorkflowDataAttributes serviceIds(@javax.annotation.Nullable List<String> serviceIds) {
  ...
  public UpdateWorkflowDataAttributes functionalityIds(@javax.annotation.Nullable List<String> functionalityIds) {
  ...
  public UpdateWorkflowDataAttributes groupIds(@javax.annotation.Nullable List<String> groupIds) {
  ...
  public UpdateWorkflowDataAttributes causeIds(@javax.annotation.Nullable List<String> causeIds) {
  ...
  public UpdateWorkflowDataAttributes subStatusIds(@javax.annotation.Nullable List<String> subStatusIds) {
