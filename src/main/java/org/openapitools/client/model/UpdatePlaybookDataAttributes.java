...
public class UpdatePlaybookDataAttributes {
  ...
  public UpdatePlaybookDataAttributes addSeverityIdsItem(String severityIdsItem) {
  ...
  public UpdatePlaybookDataAttributes addEnvironmentIdsItem(String environmentIdsItem) {
  ...
  public UpdatePlaybookDataAttributes addServiceIdsItem(String serviceIdsItem) {
  ...
  public UpdatePlaybookDataAttributes addFunctionalityIdsItem(String functionalityIdsItem) {
  ...
  public UpdatePlaybookDataAttributes addGroupIdsItem(String groupIdsItem) {
  ...
  public UpdatePlaybookDataAttributes addIncidentTypeIdsItem(String incidentTypeIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePlaybookDataAttributes updatePlaybookDataAttributes = (UpdatePlaybookDataAttributes) o;
    return Objects.equals(this.title, updatePlaybookDataAttributes.title) &&
        Objects.equals(this.summary, updatePlaybookDataAttributes.summary) &&
        Objects.equals(this.externalUrl, updatePlaybookDataAttributes.externalUrl) &&
        Objects.equals(this.severityIds, updatePlaybookDataAttributes.severityIds) &&
        Objects.equals(this.environmentIds, updatePlaybookDataAttributes.environmentIds) &&
        Objects.equals(this.serviceIds, updatePlaybookDataAttributes.serviceIds) &&
        Objects.equals(this.functionalityIds, updatePlaybookDataAttributes.functionalityIds) &&
        Objects.equals(this.groupIds, updatePlaybookDataAttributes.groupIds) &&
        Objects.equals(this.incidentTypeIds, updatePlaybookDataAttributes.incidentTypeIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePlaybookDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePlaybookDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePlaybookDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePlaybookDataAttributes is not found in the empty JSON string", UpdatePlaybookDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePlaybookDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePlaybookDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePlaybookDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePlaybookDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePlaybookDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePlaybookDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePlaybookDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdatePlaybookDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePlaybookDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePlaybookDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePlaybookDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdatePlaybookDataAttributes
   */
  public static UpdatePlaybookDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePlaybookDataAttributes.class);
  }

  /**
   * Convert an instance of UpdatePlaybookDataAttributes to an JSON string
   *
   * @return JSON string
   */
