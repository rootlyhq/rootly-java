...
public class NewServiceDataAttributes {
  ...
  public NewServiceDataAttributes addNotifyEmailsItem(String notifyEmailsItem) {
  ...
  public NewServiceDataAttributes addEnvironmentIdsItem(String environmentIdsItem) {
  ...
  public NewServiceDataAttributes addServiceIdsItem(String serviceIdsItem) {
  ...
  public NewServiceDataAttributes addSlackChannelsItem(NewEnvironmentDataAttributesSlackChannelsInner slackChannelsItem) {
  ...
  public NewServiceDataAttributes addSlackAliasesItem(NewEnvironmentDataAttributesSlackAliasesInner slackAliasesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, newServiceDataAttributes.name) &&
        ...
        Objects.equals(this.color, newServiceDataAttributes.color) &&
        Objects.equals(this.position, newServiceDataAttributes.position) &&
        Objects.equals(this.showUptime, newServiceDataAttributes.showUptime) &&
        Objects.equals(this.showUptimeLastDays, newServiceDataAttributes.showUptimeLastDays) &&
        Objects.equals(this.backstageId, newServiceDataAttributes.backstageId) &&
        Objects.equals(this.pagerdutyId, newServiceDataAttributes.pagerdutyId) &&
        Objects.equals(this.externalId, newServiceDataAttributes.externalId) &&
        Objects.equals(this.opsgenieId, newServiceDataAttributes.opsgenieId) &&
        Objects.equals(this.opsgenieTeamId, newServiceDataAttributes.opsgenieTeamId) &&
        Objects.equals(this.cortexId, newServiceDataAttributes.cortexId) &&
        Objects.equals(this.serviceNowCiSysId, newServiceDataAttributes.serviceNowCiSysId) &&
        Objects.equals(this.githubRepositoryName, newServiceDataAttributes.githubRepositoryName) &&
        Objects.equals(this.githubRepositoryBranch, newServiceDataAttributes.githubRepositoryBranch) &&
        Objects.equals(this.gitlabRepositoryName, newServiceDataAttributes.gitlabRepositoryName) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewServiceDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewServiceDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewServiceDataAttributes is not found in the empty JSON string", NewServiceDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewServiceDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewServiceDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewServiceDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewServiceDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewServiceDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewServiceDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewServiceDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewServiceDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewServiceDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewServiceDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewServiceDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewServiceDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewServiceDataAttributes
   */
  public static NewServiceDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewServiceDataAttributes.class);
  }

  /**
   * Convert an instance of NewServiceDataAttributes to an JSON string
   *
   * @return JSON string
   */
