...
import org.openapitools.client.model.ServiceResponseData;
...
public class ServiceResponse {
  ...
  private ServiceResponseData data;

  public ServiceResponse() {
  }

  public ServiceResponse data(@javax.annotation.Nonnull ServiceResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull ServiceResponseData data) {
    this.data = data;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      ServiceResponseData.validateJsonElement(jsonObj.get("data"));
  }
