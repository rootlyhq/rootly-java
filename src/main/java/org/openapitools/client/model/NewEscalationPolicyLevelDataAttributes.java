...
import org.openapitools.client.model.NewEscalationPolicyLevelDataAttributesNotificationTargetParamsInner;
...
public class NewEscalationPolicyLevelDataAttributes {
  ...
  public NewEscalationPolicyLevelDataAttributes addNotificationTargetParamsItem(NewEscalationPolicyLevelDataAttributesNotificationTargetParamsInner notificationTargetParamsItem) {
  ...
  public boolean equals(Object o) {
    ...
    NewEscalationPolicyLevelDataAttributes newEscalationPolicyLevelDataAttributes = (NewEscalationPolicyLevelDataAttributes) o;
    return Objects.equals(this.delay, newEscalationPolicyLevelDataAttributes.delay) &&
  ...
  public String toString() {
    ...
    sb.append("class NewEscalationPolicyLevelDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewEscalationPolicyLevelDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewEscalationPolicyLevelDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewEscalationPolicyLevelDataAttributes is not found in the empty JSON string", NewEscalationPolicyLevelDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewEscalationPolicyLevelDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewEscalationPolicyLevelDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewEscalationPolicyLevelDataAttributes.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraynotificationTargetParams.size(); i++) {
        NewEscalationPolicyLevelDataAttributesNotificationTargetParamsInner.validateJsonElement(jsonArraynotificationTargetParams.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewEscalationPolicyLevelDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewEscalationPolicyLevelDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewEscalationPolicyLevelDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewEscalationPolicyLevelDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewEscalationPolicyLevelDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewEscalationPolicyLevelDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewEscalationPolicyLevelDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewEscalationPolicyLevelDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewEscalationPolicyLevelDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewEscalationPolicyLevelDataAttributes
   */
  public static NewEscalationPolicyLevelDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewEscalationPolicyLevelDataAttributes.class);
  }

  /**
   * Convert an instance of NewEscalationPolicyLevelDataAttributes to an JSON string
   *
   * @return JSON string
   */
