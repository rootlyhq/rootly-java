...
public class CreateClickupTaskTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateClickupTaskTaskParams createClickupTaskTaskParams = (CreateClickupTaskTaskParams) o;
    return Objects.equals(this.taskType, createClickupTaskTaskParams.taskType) &&
        ...
        Objects.equals(this.customFieldsMapping, createClickupTaskTaskParams.customFieldsMapping) &&
        Objects.equals(this.taskPayload, createClickupTaskTaskParams.taskPayload);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateClickupTaskTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateClickupTaskTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateClickupTaskTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateClickupTaskTaskParams is not found in the empty JSON string", CreateClickupTaskTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateClickupTaskTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateClickupTaskTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateClickupTaskTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateClickupTaskTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateClickupTaskTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateClickupTaskTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateClickupTaskTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateClickupTaskTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateClickupTaskTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateClickupTaskTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateClickupTaskTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateClickupTaskTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateClickupTaskTaskParams
   */
  public static CreateClickupTaskTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateClickupTaskTaskParams.class);
  }

  /**
   * Convert an instance of CreateClickupTaskTaskParams to an JSON string
   *
   * @return JSON string
   */
