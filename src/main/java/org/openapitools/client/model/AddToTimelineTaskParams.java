...
public class AddToTimelineTaskParams {
  ...
  public AddToTimelineTaskParams addPostToSlackChannelsItem(AddActionItemTaskParamsPostToSlackChannelsInner postToSlackChannelsItem) {
  ...
  public boolean equals(Object o) {
    ...
    AddToTimelineTaskParams addToTimelineTaskParams = (AddToTimelineTaskParams) o;
    return Objects.equals(this.taskType, addToTimelineTaskParams.taskType) &&
        Objects.equals(this.event, addToTimelineTaskParams.event) &&
        Objects.equals(this.url, addToTimelineTaskParams.url) &&
        Objects.equals(this.postToSlackChannels, addToTimelineTaskParams.postToSlackChannels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, event, url, postToSlackChannels);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddToTimelineTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddToTimelineTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddToTimelineTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddToTimelineTaskParams is not found in the empty JSON string", AddToTimelineTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddToTimelineTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddToTimelineTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddToTimelineTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddToTimelineTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddToTimelineTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddToTimelineTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddToTimelineTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<AddToTimelineTaskParams>() {
           @Override
           public void write(JsonWriter out, AddToTimelineTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddToTimelineTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddToTimelineTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddToTimelineTaskParams
   * @throws IOException if the JSON string is invalid with respect to AddToTimelineTaskParams
   */
  public static AddToTimelineTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddToTimelineTaskParams.class);
  }

  /**
   * Convert an instance of AddToTimelineTaskParams to an JSON string
   *
   * @return JSON string
   */
