...
public class ShiftsApi {
     ...
     */
    public okhttp3.Call listShiftsCall(@javax.annotation.Nullable String include, @javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable List<Integer> userIds, @javax.annotation.Nullable List<String> scheduleIds, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listShiftsValidateBeforeCall(@javax.annotation.Nullable String include, @javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable List<Integer> userIds, @javax.annotation.Nullable List<String> scheduleIds, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ShiftList listShifts(@javax.annotation.Nullable String include, @javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable List<Integer> userIds, @javax.annotation.Nullable List<String> scheduleIds, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize) throws ApiException {
     ...
     */
    public ApiResponse<ShiftList> listShiftsWithHttpInfo(@javax.annotation.Nullable String include, @javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable List<Integer> userIds, @javax.annotation.Nullable List<String> scheduleIds, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize) throws ApiException {
     ...
     */
    public okhttp3.Call listShiftsAsync(@javax.annotation.Nullable String include, @javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable List<Integer> userIds, @javax.annotation.Nullable List<String> scheduleIds, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize, final ApiCallback<ShiftList> _callback) throws ApiException {
