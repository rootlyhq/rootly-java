...
public class AlertRoutesApi {
     ...
     */
    public ApiResponse<AlertRouteResponse> patchAlertRouteWithHttpInfo(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull PatchAlertRoute patchAlertRoute) throws ApiException {
     ...
     */
    public okhttp3.Call patchAlertRouteAsync(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull PatchAlertRoute patchAlertRoute, final ApiCallback<AlertRouteResponse> _callback) throws ApiException {
