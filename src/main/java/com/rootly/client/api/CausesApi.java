...
public class CausesApi {
     ...
     */
    public okhttp3.Call createCauseCatalogPropertyCall(@javax.annotation.Nonnull NewCatalogProperty newCatalogProperty, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createCauseCatalogPropertyValidateBeforeCall(@javax.annotation.Nonnull NewCatalogProperty newCatalogProperty, final ApiCallback _callback) throws ApiException {
     ...
     */
    public CatalogPropertyResponse createCauseCatalogProperty(@javax.annotation.Nonnull NewCatalogProperty newCatalogProperty) throws ApiException {
     ...
     */
    public ApiResponse<CatalogPropertyResponse> createCauseCatalogPropertyWithHttpInfo(@javax.annotation.Nonnull NewCatalogProperty newCatalogProperty) throws ApiException {
     ...
     */
    public okhttp3.Call createCauseCatalogPropertyAsync(@javax.annotation.Nonnull NewCatalogProperty newCatalogProperty, final ApiCallback<CatalogPropertyResponse> _callback) throws ApiException {
     ...
     */
    public ApiResponse<CatalogPropertyList> listCauseCatalogPropertiesWithHttpInfo(@javax.annotation.Nullable String include, @javax.annotation.Nullable String sort, @javax.annotation.Nullable Integer pageNumber, @javax.annotation.Nullable Integer pageSize, @javax.annotation.Nullable String filterSlug, @javax.annotation.Nullable String filterName, @javax.annotation.Nullable String filterKind, @javax.annotation.Nullable String filterCreatedAtGt, @javax.annotation.Nullable String filterCreatedAtGte, @javax.annotation.Nullable String filterCreatedAtLt, @javax.annotation.Nullable String filterCreatedAtLte) throws ApiException {
