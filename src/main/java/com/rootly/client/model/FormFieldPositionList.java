...
public class FormFieldPositionList {
  ...
  public FormFieldPositionList addDataItem(FormFieldPositionResponseData dataItem) {
    if (this.data == null) {
  ...
  public FormFieldPositionList included(@jakarta.annotation.Nullable List<JsonapiIncludedResource> included) {
    this.included = included;
    return this;
  }

  public FormFieldPositionList addIncludedItem(JsonapiIncludedResource includedItem) {
  ...
  public boolean equals(Object o) {
    ...
    FormFieldPositionList formFieldPositionList = (FormFieldPositionList) o;
    return Objects.equals(this.data, formFieldPositionList.data) &&
        Objects.equals(this.links, formFieldPositionList.links) &&
        Objects.equals(this.meta, formFieldPositionList.meta) &&
        Objects.equals(this.included, formFieldPositionList.included);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormFieldPositionList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FormFieldPositionList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormFieldPositionList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormFieldPositionList is not found in the empty JSON string", FormFieldPositionList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormFieldPositionList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FormFieldPositionList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormFieldPositionList.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        FormFieldPositionResponseData.validateJsonElement(jsonArraydata.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormFieldPositionList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormFieldPositionList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormFieldPositionList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormFieldPositionList.class));

       return (TypeAdapter<T>) new TypeAdapter<FormFieldPositionList>() {
           @Override
           public void write(JsonWriter out, FormFieldPositionList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FormFieldPositionList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FormFieldPositionList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FormFieldPositionList
   * @throws IOException if the JSON string is invalid with respect to FormFieldPositionList
   */
  public static FormFieldPositionList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormFieldPositionList.class);
  }

  /**
   * Convert an instance of FormFieldPositionList to an JSON string
   *
   * @return JSON string
   */
