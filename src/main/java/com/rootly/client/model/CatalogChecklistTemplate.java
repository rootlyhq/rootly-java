...
import com.rootly.client.model.CatalogChecklistTemplateFieldsInner;
import com.rootly.client.model.CatalogChecklistTemplateOwnersInner;
...
public class CatalogChecklistTemplate {
  ...
  public CatalogChecklistTemplate addFieldsItem(CatalogChecklistTemplateFieldsInner fieldsItem) {
    if (this.fields == null) {
  ...
  public CatalogChecklistTemplate addOwnersItem(CatalogChecklistTemplateOwnersInner ownersItem) {
    if (this.owners == null) {
  ...
  public boolean equals(Object o) {
    ...
    CatalogChecklistTemplate catalogChecklistTemplate = (CatalogChecklistTemplate) o;
    return Objects.equals(this.name, catalogChecklistTemplate.name) &&
        Objects.equals(this.slug, catalogChecklistTemplate.slug) &&
        Objects.equals(this.description, catalogChecklistTemplate.description) &&
        Objects.equals(this.catalogType, catalogChecklistTemplate.catalogType) &&
        Objects.equals(this.scopeType, catalogChecklistTemplate.scopeType) &&
        Objects.equals(this.scopeId, catalogChecklistTemplate.scopeId) &&
        Objects.equals(this.createdAt, catalogChecklistTemplate.createdAt) &&
        Objects.equals(this.updatedAt, catalogChecklistTemplate.updatedAt) &&
        Objects.equals(this.fields, catalogChecklistTemplate.fields) &&
        Objects.equals(this.owners, catalogChecklistTemplate.owners);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, slug, description, catalogType, scopeType, scopeId, createdAt, updatedAt, fields, owners);
  }
  ...
  public String toString() {
    ...
    sb.append("class CatalogChecklistTemplate {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("scope_type");
    openapiRequiredFields.add("scope_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogChecklistTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogChecklistTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogChecklistTemplate is not found in the empty JSON string", CatalogChecklistTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogChecklistTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogChecklistTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogChecklistTemplate.openapiRequiredFields) {
      ...
      if (!jsonObj.get("scope_type").isJsonPrimitive()) {
      ...
      // validate the required field `scope_type`
      ScopeTypeEnum.validateJsonElement(jsonObj.get("scope_type"));
      if (!jsonObj.get("scope_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `scope_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("scope_id").toString()));
      }
      ...
      if (jsonObj.get("fields") != null && !jsonObj.get("fields").isJsonNull()) {
        ...
        if (jsonArrayfields != null) {
          ...
          for (int i = 0; i < jsonArrayfields.size(); i++) {
            CatalogChecklistTemplateFieldsInner.validateJsonElement(jsonArrayfields.get(i));
          };
        }
      }
      if (jsonObj.get("owners") != null && !jsonObj.get("owners").isJsonNull()) {
        ...
        if (jsonArrayowners != null) {
          ...
          for (int i = 0; i < jsonArrayowners.size(); i++) {
            CatalogChecklistTemplateOwnersInner.validateJsonElement(jsonArrayowners.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogChecklistTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogChecklistTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogChecklistTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogChecklistTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogChecklistTemplate>() {
           @Override
           public void write(JsonWriter out, CatalogChecklistTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogChecklistTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogChecklistTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogChecklistTemplate
   * @throws IOException if the JSON string is invalid with respect to CatalogChecklistTemplate
   */
  public static CatalogChecklistTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogChecklistTemplate.class);
  }

  /**
   * Convert an instance of CatalogChecklistTemplate to an JSON string
   *
   * @return JSON string
   */
