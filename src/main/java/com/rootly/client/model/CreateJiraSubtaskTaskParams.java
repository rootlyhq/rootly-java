...
public class CreateJiraSubtaskTaskParams {
  ...
  public CreateJiraSubtaskTaskParams retryCount(@jakarta.annotation.Nullable Integer retryCount) {
  ...
  public CreateJiraSubtaskTaskParams retryWaitTime(@jakarta.annotation.Nullable Integer retryWaitTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.taskType, createJiraSubtaskTaskParams.taskType) &&
        ...
        Objects.equals(this.retryCount, createJiraSubtaskTaskParams.retryCount) &&
        Objects.equals(this.retryWaitTime, createJiraSubtaskTaskParams.retryWaitTime);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskType, integration, projectKey, parentIssueId, title, description, subtaskIssueType, labels, dueDate, assignUserEmail, reporterUserEmail, priority, status, customFieldsMapping, updatePayload, retryCount, retryWaitTime);
  }
