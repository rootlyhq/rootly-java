...
public class UpdateEdgeConnectorRequestDataAttributes {
  ...
  public UpdateEdgeConnectorRequestDataAttributes addSubscriptionsItem(String subscriptionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEdgeConnectorRequestDataAttributes updateEdgeConnectorRequestDataAttributes = (UpdateEdgeConnectorRequestDataAttributes) o;
  ...
  public String toString() {
    ...
    sb.append("class UpdateEdgeConnectorRequestDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEdgeConnectorRequestDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEdgeConnectorRequestDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEdgeConnectorRequestDataAttributes is not found in the empty JSON string", UpdateEdgeConnectorRequestDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEdgeConnectorRequestDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEdgeConnectorRequestDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEdgeConnectorRequestDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEdgeConnectorRequestDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEdgeConnectorRequestDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEdgeConnectorRequestDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEdgeConnectorRequestDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateEdgeConnectorRequestDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEdgeConnectorRequestDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEdgeConnectorRequestDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEdgeConnectorRequestDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateEdgeConnectorRequestDataAttributes
   */
  public static UpdateEdgeConnectorRequestDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEdgeConnectorRequestDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateEdgeConnectorRequestDataAttributes to an JSON string
   *
   * @return JSON string
   */
