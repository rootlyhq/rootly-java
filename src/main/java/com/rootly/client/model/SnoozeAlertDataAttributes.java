...
public class SnoozeAlertDataAttributes {
  ...
  static {
    ...
    openapiRequiredFields.add("delay_minutes");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SnoozeAlertDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SnoozeAlertDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnoozeAlertDataAttributes is not found in the empty JSON string", SnoozeAlertDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SnoozeAlertDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SnoozeAlertDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnoozeAlertDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnoozeAlertDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnoozeAlertDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnoozeAlertDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnoozeAlertDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<SnoozeAlertDataAttributes>() {
           @Override
           public void write(JsonWriter out, SnoozeAlertDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SnoozeAlertDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SnoozeAlertDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SnoozeAlertDataAttributes
   * @throws IOException if the JSON string is invalid with respect to SnoozeAlertDataAttributes
   */
  public static SnoozeAlertDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnoozeAlertDataAttributes.class);
  }

  /**
   * Convert an instance of SnoozeAlertDataAttributes to an JSON string
   *
   * @return JSON string
   */
