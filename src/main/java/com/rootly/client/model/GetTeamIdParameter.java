...
public class GetTeamIdParameter extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTeamIdParameter.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTeamIdParameter' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetTeamIdParameter>() {
                @Override
                public void write(JsonWriter out, GetTeamIdParameter value) throws IOException {
                ...
                @Override
                public GetTeamIdParameter read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for GetTeamIdParameter: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTeamIdParameter() {
        super("anyOf", Boolean.FALSE);
    }

    public GetTeamIdParameter(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetTeamIdParameter.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetTeamIdParameter
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for GetTeamIdParameter with anyOf schemas: String, UUID. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GetTeamIdParameter given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetTeamIdParameter
     * @throws IOException if the JSON string is invalid with respect to GetTeamIdParameter
     */
    public static GetTeamIdParameter fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetTeamIdParameter.class);
    }

    /**
     * Convert an instance of GetTeamIdParameter to an JSON string
     *
     * @return JSON string
     */
