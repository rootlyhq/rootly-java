...
public class AddSlackBookmarkTaskParams extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AddSlackBookmarkTaskParams.class.getName());
            ...
            return (TypeAdapter<T>) new TypeAdapter<AddSlackBookmarkTaskParams>() {
                ...
                public AddSlackBookmarkTaskParams read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        AddSlackBookmarkTaskParams ret = new AddSlackBookmarkTaskParams();
                    ...
                    throw new IOException(String.format("Failed deserialization for AddSlackBookmarkTaskParams: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AddSlackBookmarkTaskParams(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return AddSlackBookmarkTaskParams.schemas;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for AddSlackBookmarkTaskParams with anyOf schemas: AddSlackBookmarkTaskParamsAnyOf, AddSlackBookmarkTaskParamsAnyOf1. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
