...
public class NewEnvironmentDataAttributes {
  ...
  public NewEnvironmentDataAttributes description(@jakarta.annotation.Nullable String description) {
  ...
  public NewEnvironmentDataAttributes position(@jakarta.annotation.Nullable Integer position) {
  ...
  public NewEnvironmentDataAttributes notifyEmails(@jakarta.annotation.Nullable List<String> notifyEmails) {
  ...
  public NewEnvironmentDataAttributes slackChannels(@jakarta.annotation.Nullable List<NewEnvironmentDataAttributesSlackChannelsInner> slackChannels) {
  ...
  public NewEnvironmentDataAttributes slackAliases(@jakarta.annotation.Nullable List<NewEnvironmentDataAttributesSlackAliasesInner> slackAliases) {
