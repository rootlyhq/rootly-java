...
public class UpdateOnCallRoleDataAttributes {
  ...
  public UpdateOnCallRoleDataAttributes addSystemRoleItem(SystemRoleEnum systemRoleItem) {
  ...
  public UpdateOnCallRoleDataAttributes addAlertSourcesPermissionsItem(AlertSourcesPermissionsEnum alertSourcesPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addAlertUrgencyPermissionsItem(AlertUrgencyPermissionsEnum alertUrgencyPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addAlertFieldsPermissionsItem(AlertFieldsPermissionsEnum alertFieldsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addAlertGroupsPermissionsItem(AlertGroupsPermissionsEnum alertGroupsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addAlertRoutingRulesPermissionsItem(AlertRoutingRulesPermissionsEnum alertRoutingRulesPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addOnCallReadinessReportPermissionsItem(OnCallReadinessReportPermissionsEnum onCallReadinessReportPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addOnCallRolesPermissionsItem(OnCallRolesPermissionsEnum onCallRolesPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addAlertsPermissionsItem(AlertsPermissionsEnum alertsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addApiKeysPermissionsItem(ApiKeysPermissionsEnum apiKeysPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addAuditsPermissionsItem(AuditsPermissionsEnum auditsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addContactsPermissionsItem(ContactsPermissionsEnum contactsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addEscalationPoliciesPermissionsItem(EscalationPoliciesPermissionsEnum escalationPoliciesPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addGroupsPermissionsItem(GroupsPermissionsEnum groupsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addHeartbeatsPermissionsItem(HeartbeatsPermissionsEnum heartbeatsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addIntegrationsPermissionsItem(IntegrationsPermissionsEnum integrationsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addInvitationsPermissionsItem(InvitationsPermissionsEnum invitationsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addLiveCallRoutingPermissionsItem(LiveCallRoutingPermissionsEnum liveCallRoutingPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addScheduleOverridePermissionsItem(ScheduleOverridePermissionsEnum scheduleOverridePermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addSchedulesPermissionsItem(SchedulesPermissionsEnum schedulesPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addServicesPermissionsItem(ServicesPermissionsEnum servicesPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes functionalitiesPermissions(@jakarta.annotation.Nullable List<FunctionalitiesPermissionsEnum> functionalitiesPermissions) {
    this.functionalitiesPermissions = functionalitiesPermissions;
    return this;
  }

  public UpdateOnCallRoleDataAttributes addFunctionalitiesPermissionsItem(FunctionalitiesPermissionsEnum functionalitiesPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addWebhooksPermissionsItem(WebhooksPermissionsEnum webhooksPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes addWorkflowsPermissionsItem(WorkflowsPermissionsEnum workflowsPermissionsItem) {
  ...
  public UpdateOnCallRoleDataAttributes catalogsPermissions(@jakarta.annotation.Nullable List<CatalogsPermissionsEnum> catalogsPermissions) {
    this.catalogsPermissions = catalogsPermissions;
    return this;
  }

  public UpdateOnCallRoleDataAttributes addCatalogsPermissionsItem(CatalogsPermissionsEnum catalogsPermissionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateOnCallRoleDataAttributes updateOnCallRoleDataAttributes = (UpdateOnCallRoleDataAttributes) o;
    return Objects.equals(this.slug, updateOnCallRoleDataAttributes.slug) &&
        Objects.equals(this.name, updateOnCallRoleDataAttributes.name) &&
        Objects.equals(this.systemRole, updateOnCallRoleDataAttributes.systemRole) &&
        Objects.equals(this.alertSourcesPermissions, updateOnCallRoleDataAttributes.alertSourcesPermissions) &&
        Objects.equals(this.alertUrgencyPermissions, updateOnCallRoleDataAttributes.alertUrgencyPermissions) &&
        Objects.equals(this.alertFieldsPermissions, updateOnCallRoleDataAttributes.alertFieldsPermissions) &&
        Objects.equals(this.alertGroupsPermissions, updateOnCallRoleDataAttributes.alertGroupsPermissions) &&
        Objects.equals(this.alertRoutingRulesPermissions, updateOnCallRoleDataAttributes.alertRoutingRulesPermissions) &&
        Objects.equals(this.onCallReadinessReportPermissions, updateOnCallRoleDataAttributes.onCallReadinessReportPermissions) &&
        Objects.equals(this.onCallRolesPermissions, updateOnCallRoleDataAttributes.onCallRolesPermissions) &&
        Objects.equals(this.alertsPermissions, updateOnCallRoleDataAttributes.alertsPermissions) &&
        Objects.equals(this.apiKeysPermissions, updateOnCallRoleDataAttributes.apiKeysPermissions) &&
        Objects.equals(this.auditsPermissions, updateOnCallRoleDataAttributes.auditsPermissions) &&
        Objects.equals(this.contactsPermissions, updateOnCallRoleDataAttributes.contactsPermissions) &&
        Objects.equals(this.escalationPoliciesPermissions, updateOnCallRoleDataAttributes.escalationPoliciesPermissions) &&
        Objects.equals(this.groupsPermissions, updateOnCallRoleDataAttributes.groupsPermissions) &&
        Objects.equals(this.heartbeatsPermissions, updateOnCallRoleDataAttributes.heartbeatsPermissions) &&
        Objects.equals(this.integrationsPermissions, updateOnCallRoleDataAttributes.integrationsPermissions) &&
        Objects.equals(this.invitationsPermissions, updateOnCallRoleDataAttributes.invitationsPermissions) &&
        Objects.equals(this.liveCallRoutingPermissions, updateOnCallRoleDataAttributes.liveCallRoutingPermissions) &&
        Objects.equals(this.scheduleOverridePermissions, updateOnCallRoleDataAttributes.scheduleOverridePermissions) &&
        Objects.equals(this.schedulesPermissions, updateOnCallRoleDataAttributes.schedulesPermissions) &&
        Objects.equals(this.servicesPermissions, updateOnCallRoleDataAttributes.servicesPermissions) &&
        Objects.equals(this.functionalitiesPermissions, updateOnCallRoleDataAttributes.functionalitiesPermissions) &&
        Objects.equals(this.webhooksPermissions, updateOnCallRoleDataAttributes.webhooksPermissions) &&
        Objects.equals(this.workflowsPermissions, updateOnCallRoleDataAttributes.workflowsPermissions) &&
        Objects.equals(this.catalogsPermissions, updateOnCallRoleDataAttributes.catalogsPermissions);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateOnCallRoleDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOnCallRoleDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOnCallRoleDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateOnCallRoleDataAttributes is not found in the empty JSON string", UpdateOnCallRoleDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOnCallRoleDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateOnCallRoleDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOnCallRoleDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOnCallRoleDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOnCallRoleDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOnCallRoleDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOnCallRoleDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateOnCallRoleDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOnCallRoleDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOnCallRoleDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOnCallRoleDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateOnCallRoleDataAttributes
   */
  public static UpdateOnCallRoleDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOnCallRoleDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateOnCallRoleDataAttributes to an JSON string
   *
   * @return JSON string
   */
