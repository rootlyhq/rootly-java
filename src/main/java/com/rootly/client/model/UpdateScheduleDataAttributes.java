...
public class UpdateScheduleDataAttributes {
  ...
  public UpdateScheduleDataAttributes name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateScheduleDataAttributes description(@javax.annotation.Nullable String description) {
  ...
  public UpdateScheduleDataAttributes allTimeCoverage(@javax.annotation.Nullable Boolean allTimeCoverage) {
  ...
  public UpdateScheduleDataAttributes slackUserGroup(@javax.annotation.Nullable NewScheduleDataAttributesSlackUserGroup slackUserGroup) {
  ...
  public UpdateScheduleDataAttributes ownerUserId(@javax.annotation.Nullable Integer ownerUserId) {
  ...
  public UpdateScheduleDataAttributes shiftStartNotificationsEnabled(@javax.annotation.Nullable Boolean shiftStartNotificationsEnabled) {
  ...
  public UpdateScheduleDataAttributes shiftUpdateNotificationsEnabled(@javax.annotation.Nullable Boolean shiftUpdateNotificationsEnabled) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, allTimeCoverage, slackUserGroup, slackChannel, ownerGroupIds, ownerUserId, shiftStartNotificationsEnabled, shiftUpdateNotificationsEnabled);
  }
