...
import com.rootly.client.model.AlertTriggerParamsAlertPayloadConditionsConditionsInner;
...
public class AlertTriggerParamsAlertPayloadConditions {
  ...
  public AlertTriggerParamsAlertPayloadConditions addConditionsItem(AlertTriggerParamsAlertPayloadConditionsConditionsInner conditionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    AlertTriggerParamsAlertPayloadConditions alertTriggerParamsAlertPayloadConditions = (AlertTriggerParamsAlertPayloadConditions) o;
    return Objects.equals(this.logic, alertTriggerParamsAlertPayloadConditions.logic) &&
        Objects.equals(this.conditions, alertTriggerParamsAlertPayloadConditions.conditions);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlertTriggerParamsAlertPayloadConditions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlertTriggerParamsAlertPayloadConditions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlertTriggerParamsAlertPayloadConditions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertTriggerParamsAlertPayloadConditions is not found in the empty JSON string", AlertTriggerParamsAlertPayloadConditions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlertTriggerParamsAlertPayloadConditions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlertTriggerParamsAlertPayloadConditions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("conditions") != null && !jsonObj.get("conditions").isJsonNull()) {
        ...
        if (jsonArrayconditions != null) {
          ...
          for (int i = 0; i < jsonArrayconditions.size(); i++) {
            AlertTriggerParamsAlertPayloadConditionsConditionsInner.validateJsonElement(jsonArrayconditions.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertTriggerParamsAlertPayloadConditions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertTriggerParamsAlertPayloadConditions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertTriggerParamsAlertPayloadConditions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertTriggerParamsAlertPayloadConditions.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertTriggerParamsAlertPayloadConditions>() {
           @Override
           public void write(JsonWriter out, AlertTriggerParamsAlertPayloadConditions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlertTriggerParamsAlertPayloadConditions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlertTriggerParamsAlertPayloadConditions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlertTriggerParamsAlertPayloadConditions
   * @throws IOException if the JSON string is invalid with respect to AlertTriggerParamsAlertPayloadConditions
   */
  public static AlertTriggerParamsAlertPayloadConditions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertTriggerParamsAlertPayloadConditions.class);
  }

  /**
   * Convert an instance of AlertTriggerParamsAlertPayloadConditions to an JSON string
   *
   * @return JSON string
   */
