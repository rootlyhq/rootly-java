...
public class RoleList {
  ...
  private List<RoleResponseData> data = new ArrayList<>();
  ...
  public RoleList data(@jakarta.annotation.Nonnull List<RoleResponseData> data) {
    this.data = data;
    return this;
  }

  public RoleList addDataItem(RoleResponseData dataItem) {
    if (this.data == null) {
   ...
   */
  @jakarta.annotation.Nonnull
  public List<RoleResponseData> getData() {
    return data;
  }

  public void setData(@jakarta.annotation.Nonnull List<RoleResponseData> data) {
    this.data = data;
  }


  public RoleList links(@jakarta.annotation.Nonnull Links links) {
    this.links = links;
    return this;
  }
  ...
  public RoleList meta(@jakarta.annotation.Nonnull Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public RoleList included(@jakarta.annotation.Nullable List<JsonapiIncludedResource> included) {
    this.included = included;
    return this;
  }

  public RoleList addIncludedItem(JsonapiIncludedResource includedItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, roleList.data) &&
        Objects.equals(this.links, roleList.links) &&
        Objects.equals(this.meta, roleList.meta) &&
        Objects.equals(this.included, roleList.included);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        RoleResponseData.validateJsonElement(jsonArraydata.get(i));
      };
