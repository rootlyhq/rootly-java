...
public class NewIncidentActionItemDataAttributes {
  ...
  @jakarta.annotation.Nullable
  private List<String> assignedToGroupIds = new ArrayList<>();
  ...
  public NewIncidentActionItemDataAttributes() {
  }

  public NewIncidentActionItemDataAttributes summary(@jakarta.annotation.Nonnull String summary) {
  ...
  public NewIncidentActionItemDataAttributes description(@jakarta.annotation.Nullable String description) {
  ...
  public NewIncidentActionItemDataAttributes kind(@jakarta.annotation.Nullable KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public NewIncidentActionItemDataAttributes assignedToUserId(@jakarta.annotation.Nullable Integer assignedToUserId) {
  ...
  public NewIncidentActionItemDataAttributes assignedToGroupIds(@jakarta.annotation.Nullable List<String> assignedToGroupIds) {
    this.assignedToGroupIds = assignedToGroupIds;
    return this;
  }

  public NewIncidentActionItemDataAttributes addAssignedToGroupIdsItem(String assignedToGroupIdsItem) {
  ...
  public NewIncidentActionItemDataAttributes priority(@jakarta.annotation.Nullable PriorityEnum priority) {
  ...
  public NewIncidentActionItemDataAttributes status(@jakarta.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public NewIncidentActionItemDataAttributes dueDate(@jakarta.annotation.Nullable String dueDate) {
  ...
  public NewIncidentActionItemDataAttributes jiraIssueId(@jakarta.annotation.Nullable String jiraIssueId) {
  ...
  public NewIncidentActionItemDataAttributes jiraIssueKey(@jakarta.annotation.Nullable String jiraIssueKey) {
  ...
  public NewIncidentActionItemDataAttributes jiraIssueUrl(@jakarta.annotation.Nullable String jiraIssueUrl) {
  ...
  public NewIncidentActionItemDataAttributes formFieldSelections(@jakarta.annotation.Nullable List<NewIncidentActionItemDataAttributesFormFieldSelectionsInner> formFieldSelections) {
    this.formFieldSelections = formFieldSelections;
    return this;
  }

  public NewIncidentActionItemDataAttributes addFormFieldSelectionsItem(NewIncidentActionItemDataAttributesFormFieldSelectionsInner formFieldSelectionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    NewIncidentActionItemDataAttributes newIncidentActionItemDataAttributes = (NewIncidentActionItemDataAttributes) o;
    return Objects.equals(this.summary, newIncidentActionItemDataAttributes.summary) &&
        Objects.equals(this.description, newIncidentActionItemDataAttributes.description) &&
        Objects.equals(this.kind, newIncidentActionItemDataAttributes.kind) &&
        Objects.equals(this.assignedToUserId, newIncidentActionItemDataAttributes.assignedToUserId) &&
        Objects.equals(this.assignedToGroupIds, newIncidentActionItemDataAttributes.assignedToGroupIds) &&
        Objects.equals(this.priority, newIncidentActionItemDataAttributes.priority) &&
        Objects.equals(this.status, newIncidentActionItemDataAttributes.status) &&
        Objects.equals(this.dueDate, newIncidentActionItemDataAttributes.dueDate) &&
        Objects.equals(this.jiraIssueId, newIncidentActionItemDataAttributes.jiraIssueId) &&
        Objects.equals(this.jiraIssueKey, newIncidentActionItemDataAttributes.jiraIssueKey) &&
        Objects.equals(this.jiraIssueUrl, newIncidentActionItemDataAttributes.jiraIssueUrl) &&
        Objects.equals(this.formFieldSelections, newIncidentActionItemDataAttributes.formFieldSelections);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewIncidentActionItemDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewIncidentActionItemDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewIncidentActionItemDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewIncidentActionItemDataAttributes is not found in the empty JSON string", NewIncidentActionItemDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewIncidentActionItemDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewIncidentActionItemDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewIncidentActionItemDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewIncidentActionItemDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewIncidentActionItemDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewIncidentActionItemDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewIncidentActionItemDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewIncidentActionItemDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewIncidentActionItemDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewIncidentActionItemDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewIncidentActionItemDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewIncidentActionItemDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewIncidentActionItemDataAttributes
   */
  public static NewIncidentActionItemDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewIncidentActionItemDataAttributes.class);
  }

  /**
   * Convert an instance of NewIncidentActionItemDataAttributes to an JSON string
   *
   * @return JSON string
   */
