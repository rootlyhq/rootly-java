...
public class ApiKey {
  ...
  public ApiKey description(@jakarta.annotation.Nullable String description) {
  ...
  public ApiKey kind(@jakarta.annotation.Nonnull KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ApiKey roleId(@jakarta.annotation.Nullable String roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public ApiKey onCallRoleId(@jakarta.annotation.Nullable String onCallRoleId) {
  ...
  public ApiKey createdAt(@jakarta.annotation.Nonnull String createdAt) {
  ...
  public ApiKey updatedAt(@jakarta.annotation.Nonnull String updatedAt) {
  ...
  public ApiKey expiresAt(@jakarta.annotation.Nullable String expiresAt) {
  ...
  public ApiKey lastUsedAt(@jakarta.annotation.Nullable String lastUsedAt) {
  ...
  public ApiKey gracePeriodEndsAt(@jakarta.annotation.Nullable String gracePeriodEndsAt) {
