...
public class NewAlertsSourceDataAttributes {
  ...
  public NewAlertsSourceDataAttributes name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public NewAlertsSourceDataAttributes enabled(@jakarta.annotation.Nullable Boolean enabled) {
  ...
  public NewAlertsSourceDataAttributes sourceType(@jakarta.annotation.Nullable SourceTypeEnum sourceType) {
  ...
  public NewAlertsSourceDataAttributes alertUrgencyId(@jakarta.annotation.Nullable String alertUrgencyId) {
  ...
  public NewAlertsSourceDataAttributes deduplicateAlertsByKey(@jakarta.annotation.Nullable Boolean deduplicateAlertsByKey) {
  ...
  public NewAlertsSourceDataAttributes deduplicationKeyKind(@jakarta.annotation.Nullable DeduplicationKeyKindEnum deduplicationKeyKind) {
  ...
  public NewAlertsSourceDataAttributes deduplicationKeyPath(@jakarta.annotation.Nullable String deduplicationKeyPath) {
  ...
  public NewAlertsSourceDataAttributes deduplicationKeyRegexp(@jakarta.annotation.Nullable String deduplicationKeyRegexp) {
  ...
  public NewAlertsSourceDataAttributes ownerGroupIds(@jakarta.annotation.Nullable List<String> ownerGroupIds) {
    this.ownerGroupIds = ownerGroupIds;
    return this;
  }

  public NewAlertsSourceDataAttributes addOwnerGroupIdsItem(String ownerGroupIdsItem) {
  ...
  public NewAlertsSourceDataAttributes alertTemplateAttributes(@jakarta.annotation.Nullable NewAlertsSourceDataAttributesAlertTemplateAttributes alertTemplateAttributes) {
  ...
  public NewAlertsSourceDataAttributes alertSourceUrgencyRulesAttributes(@jakarta.annotation.Nullable List<NewAlertsSourceDataAttributesAlertSourceUrgencyRulesAttributesInner> alertSourceUrgencyRulesAttributes) {
    this.alertSourceUrgencyRulesAttributes = alertSourceUrgencyRulesAttributes;
    return this;
  }

  public NewAlertsSourceDataAttributes addAlertSourceUrgencyRulesAttributesItem(NewAlertsSourceDataAttributesAlertSourceUrgencyRulesAttributesInner alertSourceUrgencyRulesAttributesItem) {
  ...
  public NewAlertsSourceDataAttributes sourceableAttributes(@jakarta.annotation.Nullable NewAlertsSourceDataAttributesSourceableAttributes sourceableAttributes) {
  ...
  public NewAlertsSourceDataAttributes resolutionRuleAttributes(@jakarta.annotation.Nullable NewAlertsSourceDataAttributesResolutionRuleAttributes resolutionRuleAttributes) {
  ...
  public NewAlertsSourceDataAttributes alertSourceFieldsAttributes(@jakarta.annotation.Nullable List<NewAlertsSourceDataAttributesAlertSourceFieldsAttributesInner> alertSourceFieldsAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    NewAlertsSourceDataAttributes newAlertsSourceDataAttributes = (NewAlertsSourceDataAttributes) o;
    return Objects.equals(this.name, newAlertsSourceDataAttributes.name) &&
        Objects.equals(this.enabled, newAlertsSourceDataAttributes.enabled) &&
  ...
  public String toString() {
    ...
    sb.append("class NewAlertsSourceDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewAlertsSourceDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewAlertsSourceDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewAlertsSourceDataAttributes is not found in the empty JSON string", NewAlertsSourceDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewAlertsSourceDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewAlertsSourceDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewAlertsSourceDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewAlertsSourceDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewAlertsSourceDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewAlertsSourceDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewAlertsSourceDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewAlertsSourceDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewAlertsSourceDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewAlertsSourceDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewAlertsSourceDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewAlertsSourceDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewAlertsSourceDataAttributes
   */
  public static NewAlertsSourceDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewAlertsSourceDataAttributes.class);
  }

  /**
   * Convert an instance of NewAlertsSourceDataAttributes to an JSON string
   *
   * @return JSON string
   */
