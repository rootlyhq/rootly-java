...
public class CreateMistralChatCompletionTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateMistralChatCompletionTaskParams createMistralChatCompletionTaskParams = (CreateMistralChatCompletionTaskParams) o;
    return Objects.equals(this.taskType, createMistralChatCompletionTaskParams.taskType) &&
        Objects.equals(this.model, createMistralChatCompletionTaskParams.model) &&
        Objects.equals(this.systemPrompt, createMistralChatCompletionTaskParams.systemPrompt) &&
        Objects.equals(this.prompt, createMistralChatCompletionTaskParams.prompt) &&
        Objects.equals(this.temperature, createMistralChatCompletionTaskParams.temperature) &&
        Objects.equals(this.maxTokens, createMistralChatCompletionTaskParams.maxTokens) &&
        Objects.equals(this.topP, createMistralChatCompletionTaskParams.topP);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, model, systemPrompt, prompt, temperature, maxTokens, topP);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateMistralChatCompletionTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMistralChatCompletionTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMistralChatCompletionTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMistralChatCompletionTaskParams is not found in the empty JSON string", CreateMistralChatCompletionTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMistralChatCompletionTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMistralChatCompletionTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateMistralChatCompletionTaskParams.openapiRequiredFields) {
      ...
      CreateMistralChatCompletionTaskParamsModel.validateJsonElement(jsonObj.get("model"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMistralChatCompletionTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMistralChatCompletionTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMistralChatCompletionTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMistralChatCompletionTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMistralChatCompletionTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateMistralChatCompletionTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMistralChatCompletionTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMistralChatCompletionTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMistralChatCompletionTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateMistralChatCompletionTaskParams
   */
  public static CreateMistralChatCompletionTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMistralChatCompletionTaskParams.class);
  }

  /**
   * Convert an instance of CreateMistralChatCompletionTaskParams to an JSON string
   *
   * @return JSON string
   */
