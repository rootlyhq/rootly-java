...
public class NewCatalogPropertyDataAttributes {
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewCatalogPropertyDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewCatalogPropertyDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewCatalogPropertyDataAttributes is not found in the empty JSON string", NewCatalogPropertyDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewCatalogPropertyDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewCatalogPropertyDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewCatalogPropertyDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewCatalogPropertyDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewCatalogPropertyDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewCatalogPropertyDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewCatalogPropertyDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewCatalogPropertyDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewCatalogPropertyDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewCatalogPropertyDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewCatalogPropertyDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewCatalogPropertyDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewCatalogPropertyDataAttributes
   */
  public static NewCatalogPropertyDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewCatalogPropertyDataAttributes.class);
  }

  /**
   * Convert an instance of NewCatalogPropertyDataAttributes to an JSON string
   *
   * @return JSON string
   */
