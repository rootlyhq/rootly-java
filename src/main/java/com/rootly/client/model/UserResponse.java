...
public class UserResponse {
  ...
  public UserResponse included(@jakarta.annotation.Nullable List<JsonapiIncludedResource> included) {
    this.included = included;
    return this;
  }

  public UserResponse addIncludedItem(JsonapiIncludedResource includedItem) {
