...
public class NewSlaDataAttributes {
  ...
  public NewSlaDataAttributes addConditionsItem(NewSlaDataAttributesConditionsInner conditionsItem) {
  ...
  public NewSlaDataAttributes addNotificationConfigurationsItem(NewSlaDataAttributesNotificationConfigurationsInner notificationConfigurationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, newSlaDataAttributes.name) &&
        ...
        Objects.equals(this.managerRoleId, newSlaDataAttributes.managerRoleId) &&
        Objects.equals(this.managerUserId, newSlaDataAttributes.managerUserId) &&
        Objects.equals(this.assignmentDeadlineDays, newSlaDataAttributes.assignmentDeadlineDays) &&
        Objects.equals(this.assignmentDeadlineParentStatus, newSlaDataAttributes.assignmentDeadlineParentStatus) &&
        Objects.equals(this.assignmentDeadlineSubStatusId, newSlaDataAttributes.assignmentDeadlineSubStatusId) &&
        Objects.equals(this.assignmentSkipWeekends, newSlaDataAttributes.assignmentSkipWeekends) &&
        Objects.equals(this.completionDeadlineDays, newSlaDataAttributes.completionDeadlineDays) &&
        Objects.equals(this.completionDeadlineParentStatus, newSlaDataAttributes.completionDeadlineParentStatus) &&
        Objects.equals(this.completionDeadlineSubStatusId, newSlaDataAttributes.completionDeadlineSubStatusId) &&
        Objects.equals(this.completionSkipWeekends, newSlaDataAttributes.completionSkipWeekends) &&
        Objects.equals(this.conditions, newSlaDataAttributes.conditions) &&
        Objects.equals(this.notificationConfigurations, newSlaDataAttributes.notificationConfigurations);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewSlaDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewSlaDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewSlaDataAttributes is not found in the empty JSON string", NewSlaDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewSlaDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewSlaDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewSlaDataAttributes.openapiRequiredFields) {
      ...
      // validate the required field `assignment_deadline_days`
      ...
      // validate the required field `assignment_deadline_parent_status`
      ...
      // validate the required field `completion_deadline_days`
      ...
      // validate the required field `completion_deadline_parent_status`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewSlaDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewSlaDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewSlaDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewSlaDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewSlaDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewSlaDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewSlaDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewSlaDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewSlaDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewSlaDataAttributes
   */
  public static NewSlaDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewSlaDataAttributes.class);
  }

  /**
   * Convert an instance of NewSlaDataAttributes to an JSON string
   *
   * @return JSON string
   */
