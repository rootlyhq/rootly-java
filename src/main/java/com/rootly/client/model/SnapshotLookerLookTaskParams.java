...
public class SnapshotLookerLookTaskParams {
  ...
  public SnapshotLookerLookTaskParams taskType(@jakarta.annotation.Nullable TaskTypeEnum taskType) {
  ...
  public SnapshotLookerLookTaskParams dashboards(@jakarta.annotation.Nonnull List<AddActionItemTaskParamsPostToSlackChannelsInner> dashboards) {
  ...
  public SnapshotLookerLookTaskParams postToIncidentTimeline(@jakarta.annotation.Nullable Boolean postToIncidentTimeline) {
  ...
  public SnapshotLookerLookTaskParams postToSlackChannels(@jakarta.annotation.Nullable List<AddActionItemTaskParamsPostToSlackChannelsInner> postToSlackChannels) {
