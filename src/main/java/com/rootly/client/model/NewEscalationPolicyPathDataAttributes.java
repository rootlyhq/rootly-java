...
public class NewEscalationPolicyPathDataAttributes {
  ...
  public NewEscalationPolicyPathDataAttributes pathType(@jakarta.annotation.Nullable PathTypeEnum pathType) {
  ...
  public NewEscalationPolicyPathDataAttributes afterDeferralBehavior(@jakarta.annotation.Nullable AfterDeferralBehaviorEnum afterDeferralBehavior) {
  ...
  public NewEscalationPolicyPathDataAttributes afterDeferralPathId(@jakarta.annotation.Nullable String afterDeferralPathId) {
