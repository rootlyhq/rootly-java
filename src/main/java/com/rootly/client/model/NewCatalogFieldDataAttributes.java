...
public class NewCatalogFieldDataAttributes {
  ...
  @Deprecated
  public NewCatalogFieldDataAttributes slug(@jakarta.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public NewCatalogFieldDataAttributes required(@jakarta.annotation.Nullable Boolean required) {
  ...
  public NewCatalogFieldDataAttributes catalogType(@jakarta.annotation.Nullable CatalogTypeEnum catalogType) {
  ...
  public NewCatalogFieldDataAttributes externalId(@jakarta.annotation.Nullable String externalId) {
  ...
  public boolean equals(Object o) {
    ...
    NewCatalogFieldDataAttributes newCatalogFieldDataAttributes = (NewCatalogFieldDataAttributes) o;
    return Objects.equals(this.slug, newCatalogFieldDataAttributes.slug) &&
        Objects.equals(this.name, newCatalogFieldDataAttributes.name) &&
        Objects.equals(this.kind, newCatalogFieldDataAttributes.kind) &&
        Objects.equals(this.kindCatalogId, newCatalogFieldDataAttributes.kindCatalogId) &&
        Objects.equals(this.multiple, newCatalogFieldDataAttributes.multiple) &&
        Objects.equals(this.position, newCatalogFieldDataAttributes.position) &&
        Objects.equals(this.required, newCatalogFieldDataAttributes.required) &&
        Objects.equals(this.catalogType, newCatalogFieldDataAttributes.catalogType) &&
        Objects.equals(this.externalId, newCatalogFieldDataAttributes.externalId);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewCatalogFieldDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewCatalogFieldDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewCatalogFieldDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewCatalogFieldDataAttributes is not found in the empty JSON string", NewCatalogFieldDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewCatalogFieldDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewCatalogFieldDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewCatalogFieldDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewCatalogFieldDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewCatalogFieldDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewCatalogFieldDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewCatalogFieldDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewCatalogFieldDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewCatalogFieldDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewCatalogFieldDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewCatalogFieldDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewCatalogFieldDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewCatalogFieldDataAttributes
   */
  public static NewCatalogFieldDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewCatalogFieldDataAttributes.class);
  }

  /**
   * Convert an instance of NewCatalogFieldDataAttributes to an JSON string
   *
   * @return JSON string
   */
