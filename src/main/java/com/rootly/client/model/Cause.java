...
public class Cause {
  ...
  public Cause name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public Cause slug(@javax.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public Cause description(@javax.annotation.Nullable String description) {
  ...
  public Cause position(@javax.annotation.Nullable Integer position) {
  ...
  public Cause properties(@javax.annotation.Nullable List<NewCauseDataAttributesPropertiesInner> properties) {
  ...
  public Cause createdAt(@javax.annotation.Nonnull String createdAt) {
  ...
  public Cause updatedAt(@javax.annotation.Nonnull String updatedAt) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, slug, description, position, properties, createdAt, updatedAt);
  }
