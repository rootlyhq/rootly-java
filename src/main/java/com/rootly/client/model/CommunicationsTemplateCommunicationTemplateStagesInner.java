...
public class CommunicationsTemplateCommunicationTemplateStagesInner {
  ...
  public CommunicationsTemplateCommunicationTemplateStagesInner id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CommunicationsTemplateCommunicationTemplateStagesInner communicationStageId(@javax.annotation.Nullable String communicationStageId) {
  ...
  public CommunicationsTemplateCommunicationTemplateStagesInner smsContent(@javax.annotation.Nullable String smsContent) {
  ...
  public CommunicationsTemplateCommunicationTemplateStagesInner emailSubject(@javax.annotation.Nullable String emailSubject) {
  ...
  public CommunicationsTemplateCommunicationTemplateStagesInner emailBody(@javax.annotation.Nullable String emailBody) {
  ...
  public CommunicationsTemplateCommunicationTemplateStagesInner slackContent(@javax.annotation.Nullable String slackContent) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommunicationsTemplateCommunicationTemplateStagesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommunicationsTemplateCommunicationTemplateStagesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommunicationsTemplateCommunicationTemplateStagesInner is not found in the empty JSON string", CommunicationsTemplateCommunicationTemplateStagesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommunicationsTemplateCommunicationTemplateStagesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommunicationsTemplateCommunicationTemplateStagesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommunicationsTemplateCommunicationTemplateStagesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommunicationsTemplateCommunicationTemplateStagesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommunicationsTemplateCommunicationTemplateStagesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommunicationsTemplateCommunicationTemplateStagesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CommunicationsTemplateCommunicationTemplateStagesInner>() {
           @Override
           public void write(JsonWriter out, CommunicationsTemplateCommunicationTemplateStagesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommunicationsTemplateCommunicationTemplateStagesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommunicationsTemplateCommunicationTemplateStagesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommunicationsTemplateCommunicationTemplateStagesInner
   * @throws IOException if the JSON string is invalid with respect to CommunicationsTemplateCommunicationTemplateStagesInner
   */
  public static CommunicationsTemplateCommunicationTemplateStagesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommunicationsTemplateCommunicationTemplateStagesInner.class);
  }

  /**
   * Convert an instance of CommunicationsTemplateCommunicationTemplateStagesInner to an JSON string
   *
   * @return JSON string
   */
