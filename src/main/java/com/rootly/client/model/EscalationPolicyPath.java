...
public class EscalationPolicyPath {
  ...
  public EscalationPolicyPath pathType(@javax.annotation.Nullable PathTypeEnum pathType) {
  ...
  public EscalationPolicyPath afterDeferralBehavior(@javax.annotation.Nullable AfterDeferralBehaviorEnum afterDeferralBehavior) {
  ...
  public EscalationPolicyPath afterDeferralPathId(@javax.annotation.Nullable String afterDeferralPathId) {
  ...
  public EscalationPolicyPath rules(@javax.annotation.Nullable List<UpdateEscalationPolicyPathDataAttributesRulesInner> rules) {
    this.rules = rules;
    return this;
  }
  ...
  public EscalationPolicyPath timeRestrictionTimeZone(@javax.annotation.Nullable TimeRestrictionTimeZoneEnum timeRestrictionTimeZone) {
  ...
  public EscalationPolicyPath timeRestrictions(@javax.annotation.Nullable List<UpdateEscalationPolicyPathDataAttributesTimeRestrictionsInner> timeRestrictions) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, _default, notificationType, pathType, escalationPolicyId, afterDeferralBehavior, afterDeferralPathId, matchMode, position, repeat, repeatCount, initialDelay, createdAt, updatedAt, rules, timeRestrictionTimeZone, timeRestrictions);
  }
