...
public class CatalogEntity {
  ...
  public CatalogEntity name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CatalogEntity description(@jakarta.annotation.Nullable String description) {
  ...
  public CatalogEntity publicDescription(@jakarta.annotation.Nullable String publicDescription) {
  ...
  public CatalogEntity position(@jakarta.annotation.Nullable Integer position) {
  ...
  public CatalogEntity backstageId(@jakarta.annotation.Nullable String backstageId) {
  ...
  public CatalogEntity externalId(@jakarta.annotation.Nullable String externalId) {
  ...
  public CatalogEntity managedBy(@jakarta.annotation.Nullable ManagedByEnum managedBy) {
  ...
  public CatalogEntity createdAt(@jakarta.annotation.Nonnull String createdAt) {
  ...
  public CatalogEntity updatedAt(@jakarta.annotation.Nonnull String updatedAt) {
  ...
  public CatalogEntity properties(@jakarta.annotation.Nullable List<NewCatalogEntityDataAttributesPropertiesInner> properties) {
    this.properties = properties;
    return this;
  }

  public CatalogEntity addPropertiesItem(NewCatalogEntityDataAttributesPropertiesInner propertiesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, catalogEntity.name) &&
        Objects.equals(this.slug, catalogEntity.slug) &&
        Objects.equals(this.description, catalogEntity.description) &&
        Objects.equals(this.publicDescription, catalogEntity.publicDescription) &&
        Objects.equals(this.position, catalogEntity.position) &&
        Objects.equals(this.backstageId, catalogEntity.backstageId) &&
        Objects.equals(this.externalId, catalogEntity.externalId) &&
        Objects.equals(this.managedBy, catalogEntity.managedBy) &&
        Objects.equals(this.createdAt, catalogEntity.createdAt) &&
        Objects.equals(this.updatedAt, catalogEntity.updatedAt) &&
        Objects.equals(this.properties, catalogEntity.properties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, slug, description, publicDescription, position, backstageId, externalId, managedBy, createdAt, updatedAt, properties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogEntity is not found in the empty JSON string", CatalogEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogEntity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogEntity>() {
           @Override
           public void write(JsonWriter out, CatalogEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogEntity
   * @throws IOException if the JSON string is invalid with respect to CatalogEntity
   */
  public static CatalogEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogEntity.class);
  }

  /**
   * Convert an instance of CatalogEntity to an JSON string
   *
   * @return JSON string
   */
