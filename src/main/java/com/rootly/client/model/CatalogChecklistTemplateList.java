...
public class CatalogChecklistTemplateList {
  ...
  public CatalogChecklistTemplateList addDataItem(CatalogChecklistTemplateResponseData dataItem) {
    if (this.data == null) {
  ...
  public String toString() {
    ...
    sb.append("class CatalogChecklistTemplateList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogChecklistTemplateList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogChecklistTemplateList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogChecklistTemplateList is not found in the empty JSON string", CatalogChecklistTemplateList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogChecklistTemplateList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogChecklistTemplateList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogChecklistTemplateList.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        CatalogChecklistTemplateResponseData.validateJsonElement(jsonArraydata.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogChecklistTemplateList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogChecklistTemplateList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogChecklistTemplateList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogChecklistTemplateList.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogChecklistTemplateList>() {
           @Override
           public void write(JsonWriter out, CatalogChecklistTemplateList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogChecklistTemplateList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogChecklistTemplateList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogChecklistTemplateList
   * @throws IOException if the JSON string is invalid with respect to CatalogChecklistTemplateList
   */
  public static CatalogChecklistTemplateList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogChecklistTemplateList.class);
  }

  /**
   * Convert an instance of CatalogChecklistTemplateList to an JSON string
   *
   * @return JSON string
   */
