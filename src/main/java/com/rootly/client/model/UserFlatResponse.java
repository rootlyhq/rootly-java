...
public class UserFlatResponse {
  ...
  public UserFlatResponse() {
  }

  public UserFlatResponse id(@javax.annotation.Nonnull Integer id) {
    this.id = id;
    return this;
  }
  ...
  public UserFlatResponse email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public UserFlatResponse firstName(@javax.annotation.Nullable String firstName) {
  ...
  public UserFlatResponse lastName(@javax.annotation.Nullable String lastName) {
  ...
  public UserFlatResponse fullName(@javax.annotation.Nullable String fullName) {
  ...
  public UserFlatResponse fullNameWithTeam(@javax.annotation.Nullable String fullNameWithTeam) {
  ...
  public UserFlatResponse timeZone(@javax.annotation.Nullable String timeZone) {
  ...
  public UserFlatResponse createdAt(@javax.annotation.Nonnull String createdAt) {
  ...
  public UserFlatResponse updatedAt(@javax.annotation.Nonnull String updatedAt) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserFlatResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserFlatResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserFlatResponse is not found in the empty JSON string", UserFlatResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserFlatResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserFlatResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserFlatResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserFlatResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserFlatResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserFlatResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserFlatResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UserFlatResponse>() {
           @Override
           public void write(JsonWriter out, UserFlatResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserFlatResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserFlatResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserFlatResponse
   * @throws IOException if the JSON string is invalid with respect to UserFlatResponse
   */
  public static UserFlatResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserFlatResponse.class);
  }

  /**
   * Convert an instance of UserFlatResponse to an JSON string
   *
   * @return JSON string
   */
