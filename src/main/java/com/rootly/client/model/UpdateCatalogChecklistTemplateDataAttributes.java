...
public class UpdateCatalogChecklistTemplateDataAttributes {
  ...
  public UpdateCatalogChecklistTemplateDataAttributes addFieldsItem(NewCatalogChecklistTemplateDataAttributesFieldsInner fieldsItem) {
    if (this.fields == null) {
  ...
  public UpdateCatalogChecklistTemplateDataAttributes addOwnersItem(NewCatalogChecklistTemplateDataAttributesOwnersInner ownersItem) {
    if (this.owners == null) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCatalogChecklistTemplateDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCatalogChecklistTemplateDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCatalogChecklistTemplateDataAttributes is not found in the empty JSON string", UpdateCatalogChecklistTemplateDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCatalogChecklistTemplateDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCatalogChecklistTemplateDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCatalogChecklistTemplateDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCatalogChecklistTemplateDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCatalogChecklistTemplateDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCatalogChecklistTemplateDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCatalogChecklistTemplateDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateCatalogChecklistTemplateDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCatalogChecklistTemplateDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCatalogChecklistTemplateDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCatalogChecklistTemplateDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateCatalogChecklistTemplateDataAttributes
   */
  public static UpdateCatalogChecklistTemplateDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCatalogChecklistTemplateDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateCatalogChecklistTemplateDataAttributes to an JSON string
   *
   * @return JSON string
   */
