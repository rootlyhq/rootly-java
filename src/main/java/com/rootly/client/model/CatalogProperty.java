...
public class CatalogProperty {
  ...
  public boolean equals(Object o) {
    ...
    CatalogProperty catalogProperty = (CatalogProperty) o;
    return Objects.equals(this.catalogId, catalogProperty.catalogId) &&
        Objects.equals(this.name, catalogProperty.name) &&
        Objects.equals(this.slug, catalogProperty.slug) &&
        Objects.equals(this.kind, catalogProperty.kind) &&
        Objects.equals(this.kindCatalogId, catalogProperty.kindCatalogId) &&
        Objects.equals(this.multiple, catalogProperty.multiple) &&
  ...
  public String toString() {
    ...
    sb.append("class CatalogProperty {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogProperty is not found in the empty JSON string", CatalogProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogProperty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogProperty>() {
           @Override
           public void write(JsonWriter out, CatalogProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogProperty read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogProperty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogProperty
   * @throws IOException if the JSON string is invalid with respect to CatalogProperty
   */
  public static CatalogProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogProperty.class);
  }

  /**
   * Convert an instance of CatalogProperty to an JSON string
   *
   * @return JSON string
   */
