...
public class SendMicrosoftTeamsChatMessageTaskParams {
  ...
  public SendMicrosoftTeamsChatMessageTaskParams addChatsItem(AddActionItemTaskParamsPostToSlackChannelsInner chatsItem) {
    if (this.chats == null) {
  ...
  public boolean equals(Object o) {
    ...
    SendMicrosoftTeamsChatMessageTaskParams sendMicrosoftTeamsChatMessageTaskParams = (SendMicrosoftTeamsChatMessageTaskParams) o;
    return Objects.equals(this.taskType, sendMicrosoftTeamsChatMessageTaskParams.taskType) &&
        Objects.equals(this.chats, sendMicrosoftTeamsChatMessageTaskParams.chats) &&
        Objects.equals(this.text, sendMicrosoftTeamsChatMessageTaskParams.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, chats, text);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SendMicrosoftTeamsChatMessageTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMicrosoftTeamsChatMessageTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMicrosoftTeamsChatMessageTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendMicrosoftTeamsChatMessageTaskParams is not found in the empty JSON string", SendMicrosoftTeamsChatMessageTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMicrosoftTeamsChatMessageTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendMicrosoftTeamsChatMessageTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SendMicrosoftTeamsChatMessageTaskParams.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraychats.size(); i++) {
        AddActionItemTaskParamsPostToSlackChannelsInner.validateJsonElement(jsonArraychats.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMicrosoftTeamsChatMessageTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMicrosoftTeamsChatMessageTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMicrosoftTeamsChatMessageTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMicrosoftTeamsChatMessageTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMicrosoftTeamsChatMessageTaskParams>() {
           @Override
           public void write(JsonWriter out, SendMicrosoftTeamsChatMessageTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMicrosoftTeamsChatMessageTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMicrosoftTeamsChatMessageTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMicrosoftTeamsChatMessageTaskParams
   * @throws IOException if the JSON string is invalid with respect to SendMicrosoftTeamsChatMessageTaskParams
   */
  public static SendMicrosoftTeamsChatMessageTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMicrosoftTeamsChatMessageTaskParams.class);
  }

  /**
   * Convert an instance of SendMicrosoftTeamsChatMessageTaskParams to an JSON string
   *
   * @return JSON string
   */
