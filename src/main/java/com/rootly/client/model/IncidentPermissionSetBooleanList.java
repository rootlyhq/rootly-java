...
public class IncidentPermissionSetBooleanList {
  ...
  public IncidentPermissionSetBooleanList addDataItem(IncidentPermissionSetBooleanResponseData dataItem) {
    if (this.data == null) {
  ...
  public IncidentPermissionSetBooleanList included(@jakarta.annotation.Nullable List<JsonapiIncludedResource> included) {
    this.included = included;
    return this;
  }

  public IncidentPermissionSetBooleanList addIncludedItem(JsonapiIncludedResource includedItem) {
  ...
  public boolean equals(Object o) {
    ...
    IncidentPermissionSetBooleanList incidentPermissionSetBooleanList = (IncidentPermissionSetBooleanList) o;
    return Objects.equals(this.data, incidentPermissionSetBooleanList.data) &&
        Objects.equals(this.links, incidentPermissionSetBooleanList.links) &&
        Objects.equals(this.meta, incidentPermissionSetBooleanList.meta) &&
        Objects.equals(this.included, incidentPermissionSetBooleanList.included);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncidentPermissionSetBooleanList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IncidentPermissionSetBooleanList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IncidentPermissionSetBooleanList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncidentPermissionSetBooleanList is not found in the empty JSON string", IncidentPermissionSetBooleanList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IncidentPermissionSetBooleanList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IncidentPermissionSetBooleanList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncidentPermissionSetBooleanList.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        IncidentPermissionSetBooleanResponseData.validateJsonElement(jsonArraydata.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncidentPermissionSetBooleanList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncidentPermissionSetBooleanList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncidentPermissionSetBooleanList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncidentPermissionSetBooleanList.class));

       return (TypeAdapter<T>) new TypeAdapter<IncidentPermissionSetBooleanList>() {
           @Override
           public void write(JsonWriter out, IncidentPermissionSetBooleanList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IncidentPermissionSetBooleanList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IncidentPermissionSetBooleanList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IncidentPermissionSetBooleanList
   * @throws IOException if the JSON string is invalid with respect to IncidentPermissionSetBooleanList
   */
  public static IncidentPermissionSetBooleanList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncidentPermissionSetBooleanList.class);
  }

  /**
   * Convert an instance of IncidentPermissionSetBooleanList to an JSON string
   *
   * @return JSON string
   */
