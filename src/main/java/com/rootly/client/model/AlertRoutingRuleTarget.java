...
public class AlertRoutingRuleTarget {
  ...
  public boolean equals(Object o) {
    ...
    AlertRoutingRuleTarget alertRoutingRuleTarget = (AlertRoutingRuleTarget) o;
    return Objects.equals(this.targetType, alertRoutingRuleTarget.targetType) &&
        Objects.equals(this.targetId, alertRoutingRuleTarget.targetId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlertRoutingRuleTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlertRoutingRuleTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlertRoutingRuleTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertRoutingRuleTarget is not found in the empty JSON string", AlertRoutingRuleTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlertRoutingRuleTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlertRoutingRuleTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AlertRoutingRuleTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertRoutingRuleTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertRoutingRuleTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertRoutingRuleTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertRoutingRuleTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertRoutingRuleTarget>() {
           @Override
           public void write(JsonWriter out, AlertRoutingRuleTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlertRoutingRuleTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlertRoutingRuleTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlertRoutingRuleTarget
   * @throws IOException if the JSON string is invalid with respect to AlertRoutingRuleTarget
   */
  public static AlertRoutingRuleTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertRoutingRuleTarget.class);
  }

  /**
   * Convert an instance of AlertRoutingRuleTarget to an JSON string
   *
   * @return JSON string
   */
