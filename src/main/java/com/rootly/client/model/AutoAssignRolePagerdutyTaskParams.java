...
public class AutoAssignRolePagerdutyTaskParams extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AutoAssignRolePagerdutyTaskParams.class.getName());
            ...
            return (TypeAdapter<T>) new TypeAdapter<AutoAssignRolePagerdutyTaskParams>() {
                ...
                public AutoAssignRolePagerdutyTaskParams read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        AutoAssignRolePagerdutyTaskParams ret = new AutoAssignRolePagerdutyTaskParams();
                    ...
                    throw new IOException(String.format("Failed deserialization for AutoAssignRolePagerdutyTaskParams: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AutoAssignRolePagerdutyTaskParams(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return AutoAssignRolePagerdutyTaskParams.schemas;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for AutoAssignRolePagerdutyTaskParams with anyOf schemas: AutoAssignRolePagerdutyTaskParamsAnyOf, AutoAssignRolePagerdutyTaskParamsAnyOf1. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
