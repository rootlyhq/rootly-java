...
public class UpdateAlertDataAttributes {
  ...
  public UpdateAlertDataAttributes noise(@javax.annotation.Nullable NoiseEnum noise) {
    this.noise = noise;
    return this;
  }
  ...
  public UpdateAlertDataAttributes source(@javax.annotation.Nullable SourceEnum source) {
    this.source = source;
    return this;
  }
  ...
  public UpdateAlertDataAttributes summary(@javax.annotation.Nullable String summary) {
  ...
  public UpdateAlertDataAttributes description(@javax.annotation.Nullable String description) {
  ...
  public UpdateAlertDataAttributes serviceIds(@javax.annotation.Nullable List<String> serviceIds) {
  ...
  public UpdateAlertDataAttributes groupIds(@javax.annotation.Nullable List<String> groupIds) {
  ...
  public UpdateAlertDataAttributes environmentIds(@javax.annotation.Nullable List<String> environmentIds) {
  ...
  public UpdateAlertDataAttributes startedAt(@javax.annotation.Nullable OffsetDateTime startedAt) {
  ...
  public UpdateAlertDataAttributes endedAt(@javax.annotation.Nullable OffsetDateTime endedAt) {
  ...
  public UpdateAlertDataAttributes externalId(@javax.annotation.Nullable String externalId) {
  ...
  public UpdateAlertDataAttributes externalUrl(@javax.annotation.Nullable String externalUrl) {
  ...
  public UpdateAlertDataAttributes alertUrgencyId(@javax.annotation.Nullable String alertUrgencyId) {
  ...
  public UpdateAlertDataAttributes labels(@javax.annotation.Nullable List<NewAlertDataAttributesLabelsInner> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public UpdateAlertDataAttributes data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public UpdateAlertDataAttributes deduplicationKey(@javax.annotation.Nullable String deduplicationKey) {
  ...
  public UpdateAlertDataAttributes alertFieldValuesAttributes(@javax.annotation.Nullable List<NewAlertDataAttributesAlertFieldValuesAttributesInner> alertFieldValuesAttributes) {
