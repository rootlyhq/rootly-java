...
public class PatchAlertRouteDataAttributesRulesInnerDestinationsInner {
  ...
  public boolean equals(Object o) {
    ...
    PatchAlertRouteDataAttributesRulesInnerDestinationsInner patchAlertRouteDataAttributesRulesInnerDestinationsInner = (PatchAlertRouteDataAttributesRulesInnerDestinationsInner) o;
    return Objects.equals(this.id, patchAlertRouteDataAttributesRulesInnerDestinationsInner.id) &&
        Objects.equals(this.destroy, patchAlertRouteDataAttributesRulesInnerDestinationsInner.destroy) &&
        Objects.equals(this.targetType, patchAlertRouteDataAttributesRulesInnerDestinationsInner.targetType) &&
        Objects.equals(this.targetId, patchAlertRouteDataAttributesRulesInnerDestinationsInner.targetId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, destroy, targetType, targetId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PatchAlertRouteDataAttributesRulesInnerDestinationsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchAlertRouteDataAttributesRulesInnerDestinationsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchAlertRouteDataAttributesRulesInnerDestinationsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchAlertRouteDataAttributesRulesInnerDestinationsInner is not found in the empty JSON string", PatchAlertRouteDataAttributesRulesInnerDestinationsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchAlertRouteDataAttributesRulesInnerDestinationsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchAlertRouteDataAttributesRulesInnerDestinationsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchAlertRouteDataAttributesRulesInnerDestinationsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchAlertRouteDataAttributesRulesInnerDestinationsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchAlertRouteDataAttributesRulesInnerDestinationsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchAlertRouteDataAttributesRulesInnerDestinationsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchAlertRouteDataAttributesRulesInnerDestinationsInner>() {
           @Override
           public void write(JsonWriter out, PatchAlertRouteDataAttributesRulesInnerDestinationsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchAlertRouteDataAttributesRulesInnerDestinationsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchAlertRouteDataAttributesRulesInnerDestinationsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchAlertRouteDataAttributesRulesInnerDestinationsInner
   * @throws IOException if the JSON string is invalid with respect to PatchAlertRouteDataAttributesRulesInnerDestinationsInner
   */
  public static PatchAlertRouteDataAttributesRulesInnerDestinationsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchAlertRouteDataAttributesRulesInnerDestinationsInner.class);
  }

  /**
   * Convert an instance of PatchAlertRouteDataAttributesRulesInnerDestinationsInner to an JSON string
   *
   * @return JSON string
   */
