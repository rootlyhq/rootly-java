...
public class CatalogList {
  ...
  private List<CatalogResponseData> data = new ArrayList<>();
  ...
  public CatalogList data(@jakarta.annotation.Nonnull List<CatalogResponseData> data) {
    this.data = data;
    return this;
  }

  public CatalogList addDataItem(CatalogResponseData dataItem) {
    if (this.data == null) {
   ...
   */
  @jakarta.annotation.Nonnull
  public List<CatalogResponseData> getData() {
    return data;
  }

  public void setData(@jakarta.annotation.Nonnull List<CatalogResponseData> data) {
    this.data = data;
  }


  public CatalogList links(@jakarta.annotation.Nonnull Links links) {
    this.links = links;
    return this;
  }
  ...
  public CatalogList meta(@jakarta.annotation.Nonnull Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public CatalogList included(@jakarta.annotation.Nullable List<JsonapiIncludedResource> included) {
    this.included = included;
    return this;
  }

  public CatalogList addIncludedItem(JsonapiIncludedResource includedItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, catalogList.data) &&
        Objects.equals(this.links, catalogList.links) &&
        Objects.equals(this.meta, catalogList.meta) &&
        Objects.equals(this.included, catalogList.included);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogList is not found in the empty JSON string", CatalogList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogList.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        CatalogResponseData.validateJsonElement(jsonArraydata.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogList.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogList>() {
           @Override
           public void write(JsonWriter out, CatalogList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogList
   * @throws IOException if the JSON string is invalid with respect to CatalogList
   */
  public static CatalogList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogList.class);
  }

  /**
   * Convert an instance of CatalogList to an JSON string
   *
   * @return JSON string
   */
