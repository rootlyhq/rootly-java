...
public class UpdateEscalationPolicyPathDataAttributes {
  ...
  public UpdateEscalationPolicyPathDataAttributes pathType(@javax.annotation.Nullable PathTypeEnum pathType) {
  ...
  public UpdateEscalationPolicyPathDataAttributes afterDeferralBehavior(@javax.annotation.Nullable AfterDeferralBehaviorEnum afterDeferralBehavior) {
  ...
  public UpdateEscalationPolicyPathDataAttributes afterDeferralPathId(@javax.annotation.Nullable String afterDeferralPathId) {
  ...
  public UpdateEscalationPolicyPathDataAttributes addRulesItem(UpdateEscalationPolicyPathDataAttributesRulesInner rulesItem) {
    if (this.rules == null) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEscalationPolicyPathDataAttributes updateEscalationPolicyPathDataAttributes = (UpdateEscalationPolicyPathDataAttributes) o;
    return Objects.equals(this.name, updateEscalationPolicyPathDataAttributes.name) &&
        Objects.equals(this.notificationType, updateEscalationPolicyPathDataAttributes.notificationType) &&
        Objects.equals(this.pathType, updateEscalationPolicyPathDataAttributes.pathType) &&
        Objects.equals(this.afterDeferralBehavior, updateEscalationPolicyPathDataAttributes.afterDeferralBehavior) &&
        Objects.equals(this.afterDeferralPathId, updateEscalationPolicyPathDataAttributes.afterDeferralPathId) &&
        Objects.equals(this._default, updateEscalationPolicyPathDataAttributes._default) &&
        Objects.equals(this.matchMode, updateEscalationPolicyPathDataAttributes.matchMode) &&
        Objects.equals(this.position, updateEscalationPolicyPathDataAttributes.position) &&
  ...
  public String toString() {
    ...
    sb.append("class UpdateEscalationPolicyPathDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEscalationPolicyPathDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEscalationPolicyPathDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEscalationPolicyPathDataAttributes is not found in the empty JSON string", UpdateEscalationPolicyPathDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEscalationPolicyPathDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEscalationPolicyPathDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEscalationPolicyPathDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEscalationPolicyPathDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEscalationPolicyPathDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEscalationPolicyPathDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEscalationPolicyPathDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateEscalationPolicyPathDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEscalationPolicyPathDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEscalationPolicyPathDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEscalationPolicyPathDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateEscalationPolicyPathDataAttributes
   */
  public static UpdateEscalationPolicyPathDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEscalationPolicyPathDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateEscalationPolicyPathDataAttributes to an JSON string
   *
   * @return JSON string
   */
