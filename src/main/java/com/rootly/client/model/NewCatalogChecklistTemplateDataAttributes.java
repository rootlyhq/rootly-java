...
import com.rootly.client.model.NewCatalogChecklistTemplateDataAttributesFieldsInner;
import com.rootly.client.model.NewCatalogChecklistTemplateDataAttributesOwnersInner;
...
public class NewCatalogChecklistTemplateDataAttributes {
  ...
  public NewCatalogChecklistTemplateDataAttributes addFieldsItem(NewCatalogChecklistTemplateDataAttributesFieldsInner fieldsItem) {
    if (this.fields == null) {
  ...
  public NewCatalogChecklistTemplateDataAttributes addOwnersItem(NewCatalogChecklistTemplateDataAttributesOwnersInner ownersItem) {
    if (this.owners == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, newCatalogChecklistTemplateDataAttributes.name) &&
        ...
        Objects.equals(this.scopeId, newCatalogChecklistTemplateDataAttributes.scopeId) &&
        Objects.equals(this.fields, newCatalogChecklistTemplateDataAttributes.fields) &&
        Objects.equals(this.owners, newCatalogChecklistTemplateDataAttributes.owners);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewCatalogChecklistTemplateDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewCatalogChecklistTemplateDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewCatalogChecklistTemplateDataAttributes is not found in the empty JSON string", NewCatalogChecklistTemplateDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewCatalogChecklistTemplateDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewCatalogChecklistTemplateDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewCatalogChecklistTemplateDataAttributes.openapiRequiredFields) {
      ...
      if ((jsonObj.get("scope_id") != null && !jsonObj.get("scope_id").isJsonNull()) && !jsonObj.get("scope_id").isJsonPrimitive()) {
      ...
      if (jsonObj.get("fields") != null && !jsonObj.get("fields").isJsonNull()) {
        ...
        if (jsonArrayfields != null) {
          ...
          for (int i = 0; i < jsonArrayfields.size(); i++) {
            NewCatalogChecklistTemplateDataAttributesFieldsInner.validateJsonElement(jsonArrayfields.get(i));
          };
        }
      }
      if (jsonObj.get("owners") != null && !jsonObj.get("owners").isJsonNull()) {
        ...
        if (jsonArrayowners != null) {
          ...
          for (int i = 0; i < jsonArrayowners.size(); i++) {
            NewCatalogChecklistTemplateDataAttributesOwnersInner.validateJsonElement(jsonArrayowners.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewCatalogChecklistTemplateDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewCatalogChecklistTemplateDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewCatalogChecklistTemplateDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewCatalogChecklistTemplateDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewCatalogChecklistTemplateDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewCatalogChecklistTemplateDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewCatalogChecklistTemplateDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewCatalogChecklistTemplateDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewCatalogChecklistTemplateDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewCatalogChecklistTemplateDataAttributes
   */
  public static NewCatalogChecklistTemplateDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewCatalogChecklistTemplateDataAttributes.class);
  }

  /**
   * Convert an instance of NewCatalogChecklistTemplateDataAttributes to an JSON string
   *
   * @return JSON string
   */
