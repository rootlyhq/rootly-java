...
public class UpdateIncidentStatusPageEventDataAttributes {
  ...
  public UpdateIncidentStatusPageEventDataAttributes event(@jakarta.annotation.Nullable String event) {
    this.event = event;
    return this;
  }
  ...
  public UpdateIncidentStatusPageEventDataAttributes statusPageId(@jakarta.annotation.Nullable String statusPageId) {
  ...
  public UpdateIncidentStatusPageEventDataAttributes status(@jakarta.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateIncidentStatusPageEventDataAttributes notifySubscribers(@jakarta.annotation.Nullable Boolean notifySubscribers) {
  ...
  public UpdateIncidentStatusPageEventDataAttributes shouldTweet(@jakarta.annotation.Nullable Boolean shouldTweet) {
