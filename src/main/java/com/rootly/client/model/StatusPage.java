...
public class StatusPage {
  ...
  public StatusPage sectionOrder(@javax.annotation.Nullable List<SectionOrderEnum> sectionOrder) {
  ...
  public StatusPage addServiceIdsItem(String serviceIdsItem) {
  ...
  public StatusPage addFunctionalityIdsItem(String functionalityIdsItem) {
  ...
  public StatusPage addExternalDomainNamesItem(String externalDomainNamesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, statusPage.title) &&
        ...
        Objects.equals(this.headerColor, statusPage.headerColor) &&
        Objects.equals(this.footerColor, statusPage.footerColor) &&
        Objects.equals(this.allowSearchEngineIndex, statusPage.allowSearchEngineIndex) &&
        Objects.equals(this.showUptime, statusPage.showUptime) &&
        ...
        Objects.equals(this.gaTrackingId, statusPage.gaTrackingId) &&
        Objects.equals(this.timeZone, statusPage.timeZone) &&
        Objects.equals(this._public, statusPage._public) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusPage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatusPage is not found in the empty JSON string", StatusPage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatusPage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatusPage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatusPage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatusPage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatusPage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatusPage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatusPage.class));

       return (TypeAdapter<T>) new TypeAdapter<StatusPage>() {
           @Override
           public void write(JsonWriter out, StatusPage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatusPage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatusPage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatusPage
   * @throws IOException if the JSON string is invalid with respect to StatusPage
   */
  public static StatusPage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatusPage.class);
  }

  /**
   * Convert an instance of StatusPage to an JSON string
   *
   * @return JSON string
   */
