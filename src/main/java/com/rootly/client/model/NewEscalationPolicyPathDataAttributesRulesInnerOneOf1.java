...
public class NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 {
  ...
  public boolean equals(Object o) {
    ...
    NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 newEscalationPolicyPathDataAttributesRulesInnerOneOf1 = (NewEscalationPolicyPathDataAttributesRulesInnerOneOf1) o;
    return Objects.equals(this.ruleType, newEscalationPolicyPathDataAttributesRulesInnerOneOf1.ruleType) &&
        Objects.equals(this.withinWorkingHour, newEscalationPolicyPathDataAttributesRulesInnerOneOf1.withinWorkingHour);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewEscalationPolicyPathDataAttributesRulesInnerOneOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewEscalationPolicyPathDataAttributesRulesInnerOneOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 is not found in the empty JSON string", NewEscalationPolicyPathDataAttributesRulesInnerOneOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewEscalationPolicyPathDataAttributesRulesInnerOneOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewEscalationPolicyPathDataAttributesRulesInnerOneOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewEscalationPolicyPathDataAttributesRulesInnerOneOf1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewEscalationPolicyPathDataAttributesRulesInnerOneOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewEscalationPolicyPathDataAttributesRulesInnerOneOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewEscalationPolicyPathDataAttributesRulesInnerOneOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewEscalationPolicyPathDataAttributesRulesInnerOneOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<NewEscalationPolicyPathDataAttributesRulesInnerOneOf1>() {
           @Override
           public void write(JsonWriter out, NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewEscalationPolicyPathDataAttributesRulesInnerOneOf1
   * @throws IOException if the JSON string is invalid with respect to NewEscalationPolicyPathDataAttributesRulesInnerOneOf1
   */
  public static NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewEscalationPolicyPathDataAttributesRulesInnerOneOf1.class);
  }

  /**
   * Convert an instance of NewEscalationPolicyPathDataAttributesRulesInnerOneOf1 to an JSON string
   *
   * @return JSON string
   */
