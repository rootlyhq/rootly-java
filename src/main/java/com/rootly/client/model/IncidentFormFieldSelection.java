...
public class IncidentFormFieldSelection {
  ...
  public IncidentFormFieldSelection incidentId(@javax.annotation.Nonnull String incidentId) {
  ...
  public IncidentFormFieldSelection formFieldId(@javax.annotation.Nonnull String formFieldId) {
  ...
  public IncidentFormFieldSelection value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public IncidentFormFieldSelection selectedCatalogEntityIds(@javax.annotation.Nullable List<String> selectedCatalogEntityIds) {
    this.selectedCatalogEntityIds = selectedCatalogEntityIds;
    return this;
  }

  public IncidentFormFieldSelection addSelectedCatalogEntityIdsItem(String selectedCatalogEntityIdsItem) {
  ...
  public IncidentFormFieldSelection selectedGroupIds(@javax.annotation.Nullable List<String> selectedGroupIds) {
    this.selectedGroupIds = selectedGroupIds;
    return this;
  }

  public IncidentFormFieldSelection addSelectedGroupIdsItem(String selectedGroupIdsItem) {
  ...
  public IncidentFormFieldSelection selectedOptionIds(@javax.annotation.Nullable List<String> selectedOptionIds) {
    this.selectedOptionIds = selectedOptionIds;
    return this;
  }

  public IncidentFormFieldSelection addSelectedOptionIdsItem(String selectedOptionIdsItem) {
  ...
  public IncidentFormFieldSelection selectedServiceIds(@javax.annotation.Nullable List<String> selectedServiceIds) {
    this.selectedServiceIds = selectedServiceIds;
    return this;
  }

  public IncidentFormFieldSelection addSelectedServiceIdsItem(String selectedServiceIdsItem) {
  ...
  public IncidentFormFieldSelection selectedFunctionalityIds(@javax.annotation.Nullable List<String> selectedFunctionalityIds) {
    this.selectedFunctionalityIds = selectedFunctionalityIds;
    return this;
  }

  public IncidentFormFieldSelection addSelectedFunctionalityIdsItem(String selectedFunctionalityIdsItem) {
  ...
  public IncidentFormFieldSelection selectedUserIds(@javax.annotation.Nullable List<Integer> selectedUserIds) {
    this.selectedUserIds = selectedUserIds;
    return this;
  }

  public IncidentFormFieldSelection addSelectedUserIdsItem(Integer selectedUserIdsItem) {
  ...
  public IncidentFormFieldSelection selectedEnvironmentIds(@javax.annotation.Nullable List<String> selectedEnvironmentIds) {
  ...
  public IncidentFormFieldSelection selectedCauseIds(@javax.annotation.Nullable List<String> selectedCauseIds) {
  ...
  public IncidentFormFieldSelection selectedIncidentTypeIds(@javax.annotation.Nullable List<String> selectedIncidentTypeIds) {
  ...
  public boolean equals(Object o) {
    ...
    IncidentFormFieldSelection incidentFormFieldSelection = (IncidentFormFieldSelection) o;
    return Objects.equals(this.incidentId, incidentFormFieldSelection.incidentId) &&
        Objects.equals(this.formFieldId, incidentFormFieldSelection.formFieldId) &&
        Objects.equals(this.value, incidentFormFieldSelection.value) &&
        Objects.equals(this.selectedCatalogEntityIds, incidentFormFieldSelection.selectedCatalogEntityIds) &&
        Objects.equals(this.selectedGroupIds, incidentFormFieldSelection.selectedGroupIds) &&
  ...
  public String toString() {
    ...
    sb.append("class IncidentFormFieldSelection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IncidentFormFieldSelection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IncidentFormFieldSelection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncidentFormFieldSelection is not found in the empty JSON string", IncidentFormFieldSelection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IncidentFormFieldSelection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IncidentFormFieldSelection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncidentFormFieldSelection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncidentFormFieldSelection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncidentFormFieldSelection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncidentFormFieldSelection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncidentFormFieldSelection.class));

       return (TypeAdapter<T>) new TypeAdapter<IncidentFormFieldSelection>() {
           @Override
           public void write(JsonWriter out, IncidentFormFieldSelection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IncidentFormFieldSelection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IncidentFormFieldSelection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IncidentFormFieldSelection
   * @throws IOException if the JSON string is invalid with respect to IncidentFormFieldSelection
   */
  public static IncidentFormFieldSelection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncidentFormFieldSelection.class);
  }

  /**
   * Convert an instance of IncidentFormFieldSelection to an JSON string
   *
   * @return JSON string
   */
