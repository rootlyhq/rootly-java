...
public class CatalogEntityChecklistResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogEntityChecklistResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogEntityChecklistResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogEntityChecklistResponse is not found in the empty JSON string", CatalogEntityChecklistResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogEntityChecklistResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogEntityChecklistResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CatalogEntityChecklistResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogEntityChecklistResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogEntityChecklistResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogEntityChecklistResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogEntityChecklistResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogEntityChecklistResponse>() {
           @Override
           public void write(JsonWriter out, CatalogEntityChecklistResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogEntityChecklistResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogEntityChecklistResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogEntityChecklistResponse
   * @throws IOException if the JSON string is invalid with respect to CatalogEntityChecklistResponse
   */
  public static CatalogEntityChecklistResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogEntityChecklistResponse.class);
  }

  /**
   * Convert an instance of CatalogEntityChecklistResponse to an JSON string
   *
   * @return JSON string
   */
