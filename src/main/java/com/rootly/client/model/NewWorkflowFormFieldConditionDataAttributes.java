...
public class NewWorkflowFormFieldConditionDataAttributes {
  ...
  public NewWorkflowFormFieldConditionDataAttributes selectedCauseIds(@javax.annotation.Nullable List<String> selectedCauseIds) {
  ...
  public NewWorkflowFormFieldConditionDataAttributes selectedEnvironmentIds(@javax.annotation.Nullable List<String> selectedEnvironmentIds) {
  ...
  public NewWorkflowFormFieldConditionDataAttributes selectedIncidentTypeIds(@javax.annotation.Nullable List<String> selectedIncidentTypeIds) {
