...
public class MeetingRecordingList {
  ...
  public boolean equals(Object o) {
    ...
    MeetingRecordingList meetingRecordingList = (MeetingRecordingList) o;
    return Objects.equals(this.data, meetingRecordingList.data) &&
        Objects.equals(this.meta, meetingRecordingList.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingRecordingList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MeetingRecordingList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MeetingRecordingList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingRecordingList is not found in the empty JSON string", MeetingRecordingList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MeetingRecordingList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MeetingRecordingList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MeetingRecordingList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingRecordingList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingRecordingList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingRecordingList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingRecordingList.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingRecordingList>() {
           @Override
           public void write(JsonWriter out, MeetingRecordingList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MeetingRecordingList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MeetingRecordingList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MeetingRecordingList
   * @throws IOException if the JSON string is invalid with respect to MeetingRecordingList
   */
  public static MeetingRecordingList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingRecordingList.class);
  }

  /**
   * Convert an instance of MeetingRecordingList to an JSON string
   *
   * @return JSON string
   */
