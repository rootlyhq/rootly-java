...
import com.rootly.client.model.NewApiKeyData;
...
public class NewApiKey {
  ...
  private NewApiKeyData data;

  public NewApiKey() {
  }

  public NewApiKey data(@jakarta.annotation.Nonnull NewApiKeyData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  public NewApiKeyData getData() {
    return data;
  }

  public void setData(@jakarta.annotation.Nonnull NewApiKeyData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, newApiKey.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : NewApiKey.openapiRequiredFields) {
      ...
      NewApiKeyData.validateJsonElement(jsonObj.get("data"));
  }
