...
public class NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 {
  ...
  public NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 addServiceIdsItem(String serviceIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 newEscalationPolicyPathDataAttributesRulesInnerOneOf4 = (NewEscalationPolicyPathDataAttributesRulesInnerOneOf4) o;
    return Objects.equals(this.ruleType, newEscalationPolicyPathDataAttributesRulesInnerOneOf4.ruleType) &&
        Objects.equals(this.serviceIds, newEscalationPolicyPathDataAttributesRulesInnerOneOf4.serviceIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ruleType, serviceIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewEscalationPolicyPathDataAttributesRulesInnerOneOf4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewEscalationPolicyPathDataAttributesRulesInnerOneOf4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 is not found in the empty JSON string", NewEscalationPolicyPathDataAttributesRulesInnerOneOf4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewEscalationPolicyPathDataAttributesRulesInnerOneOf4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewEscalationPolicyPathDataAttributesRulesInnerOneOf4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewEscalationPolicyPathDataAttributesRulesInnerOneOf4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewEscalationPolicyPathDataAttributesRulesInnerOneOf4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewEscalationPolicyPathDataAttributesRulesInnerOneOf4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewEscalationPolicyPathDataAttributesRulesInnerOneOf4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewEscalationPolicyPathDataAttributesRulesInnerOneOf4.class));

       return (TypeAdapter<T>) new TypeAdapter<NewEscalationPolicyPathDataAttributesRulesInnerOneOf4>() {
           @Override
           public void write(JsonWriter out, NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewEscalationPolicyPathDataAttributesRulesInnerOneOf4
   * @throws IOException if the JSON string is invalid with respect to NewEscalationPolicyPathDataAttributesRulesInnerOneOf4
   */
  public static NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewEscalationPolicyPathDataAttributesRulesInnerOneOf4.class);
  }

  /**
   * Convert an instance of NewEscalationPolicyPathDataAttributesRulesInnerOneOf4 to an JSON string
   *
   * @return JSON string
   */
