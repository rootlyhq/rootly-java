...
public class NewLiveCallRouterDataAttributes {
  ...
  public NewLiveCallRouterDataAttributes callingTreeEnabled(@javax.annotation.Nullable Boolean callingTreeEnabled) {
  ...
  public void setCallingTreeEnabled(@javax.annotation.Nullable Boolean callingTreeEnabled) {
    this.callingTreeEnabled = callingTreeEnabled;
  }
