...
public class BuiltinField {
  ...
  public boolean equals(Object o) {
    ...
    BuiltinField builtinField = (BuiltinField) o;
    return Objects.equals(this.fieldSource, builtinField.fieldSource) &&
        Objects.equals(this.fieldKey, builtinField.fieldKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fieldSource, fieldKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BuiltinField {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BuiltinField
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BuiltinField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BuiltinField is not found in the empty JSON string", BuiltinField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BuiltinField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BuiltinField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BuiltinField.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BuiltinField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BuiltinField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BuiltinField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BuiltinField.class));

       return (TypeAdapter<T>) new TypeAdapter<BuiltinField>() {
           @Override
           public void write(JsonWriter out, BuiltinField value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BuiltinField read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BuiltinField given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BuiltinField
   * @throws IOException if the JSON string is invalid with respect to BuiltinField
   */
  public static BuiltinField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BuiltinField.class);
  }

  /**
   * Convert an instance of BuiltinField to an JSON string
   *
   * @return JSON string
   */
