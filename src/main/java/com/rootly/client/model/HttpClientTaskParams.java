...
public class HttpClientTaskParams {
  ...
  public HttpClientTaskParams retryCount(@jakarta.annotation.Nullable Integer retryCount) {
  ...
  public HttpClientTaskParams retryWaitTime(@jakarta.annotation.Nullable Integer retryWaitTime) {
