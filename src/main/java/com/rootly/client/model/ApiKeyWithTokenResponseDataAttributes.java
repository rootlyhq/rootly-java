...
public class ApiKeyWithTokenResponseDataAttributes {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeyWithTokenResponseDataAttributes apiKeyWithTokenResponseDataAttributes = (ApiKeyWithTokenResponseDataAttributes) o;
    return Objects.equals(this.name, apiKeyWithTokenResponseDataAttributes.name) &&
        ...
        Objects.equals(this.updatedAt, apiKeyWithTokenResponseDataAttributes.updatedAt) &&
        Objects.equals(this.expiresAt, apiKeyWithTokenResponseDataAttributes.expiresAt) &&
        Objects.equals(this.lastUsedAt, apiKeyWithTokenResponseDataAttributes.lastUsedAt) &&
        Objects.equals(this.gracePeriodEndsAt, apiKeyWithTokenResponseDataAttributes.gracePeriodEndsAt) &&
        Objects.equals(this.token, apiKeyWithTokenResponseDataAttributes.token);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiKeyWithTokenResponseDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiKeyWithTokenResponseDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiKeyWithTokenResponseDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiKeyWithTokenResponseDataAttributes is not found in the empty JSON string", ApiKeyWithTokenResponseDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiKeyWithTokenResponseDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiKeyWithTokenResponseDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiKeyWithTokenResponseDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKeyWithTokenResponseDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKeyWithTokenResponseDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKeyWithTokenResponseDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKeyWithTokenResponseDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKeyWithTokenResponseDataAttributes>() {
           @Override
           public void write(JsonWriter out, ApiKeyWithTokenResponseDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiKeyWithTokenResponseDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiKeyWithTokenResponseDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiKeyWithTokenResponseDataAttributes
   * @throws IOException if the JSON string is invalid with respect to ApiKeyWithTokenResponseDataAttributes
   */
  public static ApiKeyWithTokenResponseDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKeyWithTokenResponseDataAttributes.class);
  }

  /**
   * Convert an instance of ApiKeyWithTokenResponseDataAttributes to an JSON string
   *
   * @return JSON string
   */
