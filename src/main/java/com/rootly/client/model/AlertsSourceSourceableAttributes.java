...
public class AlertsSourceSourceableAttributes {
  ...
  public AlertsSourceSourceableAttributes id(@jakarta.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }

  /**
   * Unique ID of the underlying source. Read-only; it is resolved from the alert source itself on update.
   * @return id
   */
  @jakarta.annotation.Nullable
  public UUID getId() {
  ...
  public AlertsSourceSourceableAttributes autoResolve(@jakarta.annotation.Nullable Boolean autoResolve) {
  ...
  public AlertsSourceSourceableAttributes resolveState(@jakarta.annotation.Nullable String resolveState) {
  ...
  public AlertsSourceSourceableAttributes acceptThreadedEmails(@jakarta.annotation.Nullable Boolean acceptThreadedEmails) {
  ...
  public boolean equals(Object o) {
    ...
    AlertsSourceSourceableAttributes alertsSourceSourceableAttributes = (AlertsSourceSourceableAttributes) o;
    return Objects.equals(this.id, alertsSourceSourceableAttributes.id) &&
  ...
  public String toString() {
    ...
    sb.append("class AlertsSourceSourceableAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlertsSourceSourceableAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlertsSourceSourceableAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertsSourceSourceableAttributes is not found in the empty JSON string", AlertsSourceSourceableAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlertsSourceSourceableAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlertsSourceSourceableAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertsSourceSourceableAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertsSourceSourceableAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertsSourceSourceableAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertsSourceSourceableAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertsSourceSourceableAttributes>() {
           @Override
           public void write(JsonWriter out, AlertsSourceSourceableAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlertsSourceSourceableAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlertsSourceSourceableAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlertsSourceSourceableAttributes
   * @throws IOException if the JSON string is invalid with respect to AlertsSourceSourceableAttributes
   */
  public static AlertsSourceSourceableAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertsSourceSourceableAttributes.class);
  }

  /**
   * Convert an instance of AlertsSourceSourceableAttributes to an JSON string
   *
   * @return JSON string
   */
