...
public class AlertList {
  ...
  private List<AlertResponseData> data = new ArrayList<>();
  ...
  public AlertList data(@jakarta.annotation.Nonnull List<AlertResponseData> data) {
    this.data = data;
    return this;
  }

  public AlertList addDataItem(AlertResponseData dataItem) {
    if (this.data == null) {
   ...
   */
  @jakarta.annotation.Nonnull
  public List<AlertResponseData> getData() {
    return data;
  }

  public void setData(@jakarta.annotation.Nonnull List<AlertResponseData> data) {
    this.data = data;
  }


  public AlertList links(@jakarta.annotation.Nonnull Links links) {
    this.links = links;
    return this;
  }
  ...
  public AlertList meta(@jakarta.annotation.Nonnull Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public AlertList included(@jakarta.annotation.Nullable List<JsonapiIncludedResource> included) {
    this.included = included;
    return this;
  }

  public AlertList addIncludedItem(JsonapiIncludedResource includedItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, alertList.data) &&
        Objects.equals(this.links, alertList.links) &&
        Objects.equals(this.meta, alertList.meta) &&
        Objects.equals(this.included, alertList.included);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        AlertResponseData.validateJsonElement(jsonArraydata.get(i));
      };
