...
public class StatusResponseData {
  ...
  public StatusResponseData id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public StatusResponseData type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public StatusResponseData attributes(@javax.annotation.Nonnull Status attributes) {
  ...
  public void setAttributes(@javax.annotation.Nonnull Status attributes) {
    this.attributes = attributes;
  }
