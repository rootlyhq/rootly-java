...
public class StatusResponseData {
  ...
  @jakarta.annotation.Nonnull
  private Status attributes;

  public StatusResponseData() {
  }

  public StatusResponseData id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public StatusResponseData type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public StatusResponseData attributes(@jakarta.annotation.Nonnull Status attributes) {
   ...
   */
  @jakarta.annotation.Nonnull
  public Status getAttributes() {
    return attributes;
  }

  public void setAttributes(@jakarta.annotation.Nonnull Status attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, statusResponseData.id) &&
        Objects.equals(this.type, statusResponseData.type) &&
        Objects.equals(this.attributes, statusResponseData.attributes);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : StatusResponseData.openapiRequiredFields) {
      ...
      Status.validateJsonElement(jsonObj.get("attributes"));
  }
