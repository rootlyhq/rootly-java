...
public class CreateOpenaiChatCompletionTaskParams {
   ...
   */
  @JsonAdapter(ReasoningSummaryEnum.Adapter.class)
  public enum ReasoningSummaryEnum {
    AUTO("auto"),
    ...
    ReasoningSummaryEnum(String value) {
      this.value = value;
    }
    ...
    public static ReasoningSummaryEnum fromValue(String value) {
      for (ReasoningSummaryEnum b : ReasoningSummaryEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ReasoningSummaryEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ReasoningSummaryEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ReasoningSummaryEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ReasoningSummaryEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ReasoningSummaryEnum.fromValue(value);
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateOpenaiChatCompletionTaskParams createOpenaiChatCompletionTaskParams = (CreateOpenaiChatCompletionTaskParams) o;
    return Objects.equals(this.taskType, createOpenaiChatCompletionTaskParams.taskType) &&
        Objects.equals(this.model, createOpenaiChatCompletionTaskParams.model) &&
        Objects.equals(this.systemPrompt, createOpenaiChatCompletionTaskParams.systemPrompt) &&
        Objects.equals(this.prompt, createOpenaiChatCompletionTaskParams.prompt) &&
        Objects.equals(this.temperature, createOpenaiChatCompletionTaskParams.temperature) &&
        Objects.equals(this.maxTokens, createOpenaiChatCompletionTaskParams.maxTokens) &&
        Objects.equals(this.topP, createOpenaiChatCompletionTaskParams.topP) &&
        Objects.equals(this.reasoningEffort, createOpenaiChatCompletionTaskParams.reasoningEffort) &&
        Objects.equals(this.reasoningSummary, createOpenaiChatCompletionTaskParams.reasoningSummary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, model, systemPrompt, prompt, temperature, maxTokens, topP, reasoningEffort, reasoningSummary);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateOpenaiChatCompletionTaskParams {\n");
  ...
  static {
    ...
    openapiFields.add("reasoning_summary");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOpenaiChatCompletionTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOpenaiChatCompletionTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOpenaiChatCompletionTaskParams is not found in the empty JSON string", CreateOpenaiChatCompletionTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOpenaiChatCompletionTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOpenaiChatCompletionTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateOpenaiChatCompletionTaskParams.openapiRequiredFields) {
      ...
      CreateOpenaiChatCompletionTaskParamsModel.validateJsonElement(jsonObj.get("model"));
      ...
      if ((jsonObj.get("reasoning_effort") != null && !jsonObj.get("reasoning_effort").isJsonNull()) && !jsonObj.get("reasoning_effort").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reasoning_effort` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reasoning_effort").toString()));
      }
      ...
      if ((jsonObj.get("reasoning_summary") != null && !jsonObj.get("reasoning_summary").isJsonNull()) && !jsonObj.get("reasoning_summary").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reasoning_summary` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reasoning_summary").toString()));
      }
      // validate the optional field `reasoning_summary`
      if (jsonObj.get("reasoning_summary") != null && !jsonObj.get("reasoning_summary").isJsonNull()) {
        ReasoningSummaryEnum.validateJsonElement(jsonObj.get("reasoning_summary"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOpenaiChatCompletionTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOpenaiChatCompletionTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOpenaiChatCompletionTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOpenaiChatCompletionTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOpenaiChatCompletionTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateOpenaiChatCompletionTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOpenaiChatCompletionTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOpenaiChatCompletionTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOpenaiChatCompletionTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateOpenaiChatCompletionTaskParams
   */
  public static CreateOpenaiChatCompletionTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOpenaiChatCompletionTaskParams.class);
  }

  /**
   * Convert an instance of CreateOpenaiChatCompletionTaskParams to an JSON string
   *
   * @return JSON string
   */
