...
public class NewEdgeConnectorActionAction {
  ...
  public boolean equals(Object o) {
    ...
    NewEdgeConnectorActionAction newEdgeConnectorActionAction = (NewEdgeConnectorActionAction) o;
    return Objects.equals(this.name, newEdgeConnectorActionAction.name) &&
        Objects.equals(this.actionType, newEdgeConnectorActionAction.actionType) &&
        Objects.equals(this.metadata, newEdgeConnectorActionAction.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewEdgeConnectorActionAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewEdgeConnectorActionAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewEdgeConnectorActionAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewEdgeConnectorActionAction is not found in the empty JSON string", NewEdgeConnectorActionAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewEdgeConnectorActionAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewEdgeConnectorActionAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewEdgeConnectorActionAction.openapiRequiredFields) {
      ...
      if (jsonObj.get("metadata") != null && !jsonObj.get("metadata").isJsonNull()) {
        NewEdgeConnectorActionActionMetadata.validateJsonElement(jsonObj.get("metadata"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewEdgeConnectorActionAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewEdgeConnectorActionAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewEdgeConnectorActionAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewEdgeConnectorActionAction.class));

       return (TypeAdapter<T>) new TypeAdapter<NewEdgeConnectorActionAction>() {
           @Override
           public void write(JsonWriter out, NewEdgeConnectorActionAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewEdgeConnectorActionAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewEdgeConnectorActionAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewEdgeConnectorActionAction
   * @throws IOException if the JSON string is invalid with respect to NewEdgeConnectorActionAction
   */
  public static NewEdgeConnectorActionAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewEdgeConnectorActionAction.class);
  }

  /**
   * Convert an instance of NewEdgeConnectorActionAction to an JSON string
   *
   * @return JSON string
   */
