...
public class UpdateFunctionalityDataAttributes {
  ...
  public UpdateFunctionalityDataAttributes escalationPolicyId(@javax.annotation.Nullable String escalationPolicyId) {
  ...
  public UpdateFunctionalityDataAttributes properties(@javax.annotation.Nullable List<NewCauseDataAttributesPropertiesInner> properties) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, publicDescription, notifyEmails, color, position, backstageId, externalId, pagerdutyId, opsgenieId, opsgenieTeamId, cortexId, serviceNowCiSysId, environmentIds, serviceIds, ownerGroupIds, ownerUserIds, escalationPolicyId, slackChannels, slackAliases, properties);
  }
