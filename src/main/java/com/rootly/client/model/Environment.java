...
public class Environment {
  ...
  public Environment properties(@javax.annotation.Nullable List<NewCauseDataAttributesPropertiesInner> properties) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, slug, description, notifyEmails, color, position, slackChannels, slackAliases, properties, createdAt, updatedAt);
  }
