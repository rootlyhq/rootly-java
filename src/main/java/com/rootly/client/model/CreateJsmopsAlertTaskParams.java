...
public class CreateJsmopsAlertTaskParams {
  ...
  public CreateJsmopsAlertTaskParams addTeamsItem(AddActionItemTaskParamsPostToSlackChannelsInner teamsItem) {
    if (this.teams == null) {
  ...
  public CreateJsmopsAlertTaskParams addUsersItem(AddActionItemTaskParamsPostToSlackChannelsInner usersItem) {
    if (this.users == null) {
  ...
  public CreateJsmopsAlertTaskParams addSchedulesItem(AddActionItemTaskParamsPostToSlackChannelsInner schedulesItem) {
  ...
  public CreateJsmopsAlertTaskParams addEscalationsItem(AddActionItemTaskParamsPostToSlackChannelsInner escalationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJsmopsAlertTaskParams createJsmopsAlertTaskParams = (CreateJsmopsAlertTaskParams) o;
    return Objects.equals(this.taskType, createJsmopsAlertTaskParams.taskType) &&
        Objects.equals(this.message, createJsmopsAlertTaskParams.message) &&
        Objects.equals(this.description, createJsmopsAlertTaskParams.description) &&
        Objects.equals(this.teams, createJsmopsAlertTaskParams.teams) &&
        Objects.equals(this.users, createJsmopsAlertTaskParams.users) &&
        Objects.equals(this.schedules, createJsmopsAlertTaskParams.schedules) &&
        Objects.equals(this.escalations, createJsmopsAlertTaskParams.escalations) &&
        Objects.equals(this.priority, createJsmopsAlertTaskParams.priority) &&
        Objects.equals(this.details, createJsmopsAlertTaskParams.details);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJsmopsAlertTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJsmopsAlertTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJsmopsAlertTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJsmopsAlertTaskParams is not found in the empty JSON string", CreateJsmopsAlertTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJsmopsAlertTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJsmopsAlertTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateJsmopsAlertTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJsmopsAlertTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJsmopsAlertTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJsmopsAlertTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJsmopsAlertTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJsmopsAlertTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateJsmopsAlertTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJsmopsAlertTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJsmopsAlertTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJsmopsAlertTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateJsmopsAlertTaskParams
   */
  public static CreateJsmopsAlertTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJsmopsAlertTaskParams.class);
  }

  /**
   * Convert an instance of CreateJsmopsAlertTaskParams to an JSON string
   *
   * @return JSON string
   */
