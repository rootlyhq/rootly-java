...
public class IncidentType {
  ...
  public IncidentType name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public IncidentType slug(@javax.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public IncidentType description(@javax.annotation.Nullable String description) {
  ...
  public IncidentType color(@javax.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  public IncidentType position(@javax.annotation.Nullable Integer position) {
  ...
  public IncidentType notifyEmails(@javax.annotation.Nullable List<String> notifyEmails) {
    this.notifyEmails = notifyEmails;
    return this;
  }

  public IncidentType addNotifyEmailsItem(String notifyEmailsItem) {
  ...
  public IncidentType slackChannels(@javax.annotation.Nullable List<NewEnvironmentDataAttributesSlackChannelsInner> slackChannels) {
  ...
  public IncidentType slackAliases(@javax.annotation.Nullable List<NewEnvironmentDataAttributesSlackAliasesInner> slackAliases) {
  ...
  public IncidentType properties(@javax.annotation.Nullable List<NewCauseDataAttributesPropertiesInner> properties) {
    this.properties = properties;
    return this;
  }

  public IncidentType addPropertiesItem(NewCauseDataAttributesPropertiesInner propertiesItem) {
  ...
  public IncidentType createdAt(@javax.annotation.Nonnull String createdAt) {
  ...
  public IncidentType updatedAt(@javax.annotation.Nonnull String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, incidentType.name) &&
        Objects.equals(this.slug, incidentType.slug) &&
        Objects.equals(this.description, incidentType.description) &&
        Objects.equals(this.color, incidentType.color) &&
        Objects.equals(this.position, incidentType.position) &&
        Objects.equals(this.notifyEmails, incidentType.notifyEmails) &&
        Objects.equals(this.slackChannels, incidentType.slackChannels) &&
        Objects.equals(this.slackAliases, incidentType.slackAliases) &&
        Objects.equals(this.properties, incidentType.properties) &&
        Objects.equals(this.createdAt, incidentType.createdAt) &&
        Objects.equals(this.updatedAt, incidentType.updatedAt);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, slug, description, color, position, notifyEmails, slackChannels, slackAliases, properties, createdAt, updatedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IncidentType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IncidentType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncidentType is not found in the empty JSON string", IncidentType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IncidentType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IncidentType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncidentType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncidentType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncidentType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncidentType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncidentType.class));

       return (TypeAdapter<T>) new TypeAdapter<IncidentType>() {
           @Override
           public void write(JsonWriter out, IncidentType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IncidentType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IncidentType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IncidentType
   * @throws IOException if the JSON string is invalid with respect to IncidentType
   */
  public static IncidentType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncidentType.class);
  }

  /**
   * Convert an instance of IncidentType to an JSON string
   *
   * @return JSON string
   */
