...
public class PageJsmopsOnCallRespondersTaskParams {
  ...
  public PageJsmopsOnCallRespondersTaskParams addTeamsItem(AddActionItemTaskParamsPostToSlackChannelsInner teamsItem) {
    if (this.teams == null) {
  ...
  public PageJsmopsOnCallRespondersTaskParams addUsersItem(AddActionItemTaskParamsPostToSlackChannelsInner usersItem) {
    if (this.users == null) {
  ...
  public boolean equals(Object o) {
    ...
    PageJsmopsOnCallRespondersTaskParams pageJsmopsOnCallRespondersTaskParams = (PageJsmopsOnCallRespondersTaskParams) o;
    return Objects.equals(this.taskType, pageJsmopsOnCallRespondersTaskParams.taskType) &&
        Objects.equals(this.title, pageJsmopsOnCallRespondersTaskParams.title) &&
        Objects.equals(this.message, pageJsmopsOnCallRespondersTaskParams.message) &&
        Objects.equals(this.description, pageJsmopsOnCallRespondersTaskParams.description) &&
        Objects.equals(this.teams, pageJsmopsOnCallRespondersTaskParams.teams) &&
        Objects.equals(this.users, pageJsmopsOnCallRespondersTaskParams.users) &&
        Objects.equals(this.priority, pageJsmopsOnCallRespondersTaskParams.priority);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageJsmopsOnCallRespondersTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageJsmopsOnCallRespondersTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PageJsmopsOnCallRespondersTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PageJsmopsOnCallRespondersTaskParams is not found in the empty JSON string", PageJsmopsOnCallRespondersTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageJsmopsOnCallRespondersTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageJsmopsOnCallRespondersTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PageJsmopsOnCallRespondersTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PageJsmopsOnCallRespondersTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PageJsmopsOnCallRespondersTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PageJsmopsOnCallRespondersTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<PageJsmopsOnCallRespondersTaskParams>() {
           @Override
           public void write(JsonWriter out, PageJsmopsOnCallRespondersTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PageJsmopsOnCallRespondersTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PageJsmopsOnCallRespondersTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PageJsmopsOnCallRespondersTaskParams
   * @throws IOException if the JSON string is invalid with respect to PageJsmopsOnCallRespondersTaskParams
   */
  public static PageJsmopsOnCallRespondersTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PageJsmopsOnCallRespondersTaskParams.class);
  }

  /**
   * Convert an instance of PageJsmopsOnCallRespondersTaskParams to an JSON string
   *
   * @return JSON string
   */
