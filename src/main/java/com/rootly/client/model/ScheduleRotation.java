...
public class ScheduleRotation {
  ...
  public ScheduleRotation startTime(@javax.annotation.Nullable OffsetDateTime startTime) {
  ...
  public ScheduleRotation endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
