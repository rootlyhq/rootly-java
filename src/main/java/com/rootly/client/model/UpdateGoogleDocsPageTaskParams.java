...
public class UpdateGoogleDocsPageTaskParams {
  ...
  public UpdateGoogleDocsPageTaskParams includeOverview(@jakarta.annotation.Nullable Boolean includeOverview) {
  ...
  public UpdateGoogleDocsPageTaskParams includeTimeline(@jakarta.annotation.Nullable Boolean includeTimeline) {
  ...
  public UpdateGoogleDocsPageTaskParams includeFollowUps(@jakarta.annotation.Nullable Boolean includeFollowUps) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGoogleDocsPageTaskParams updateGoogleDocsPageTaskParams = (UpdateGoogleDocsPageTaskParams) o;
    return Objects.equals(this.taskType, updateGoogleDocsPageTaskParams.taskType) &&
        Objects.equals(this.fileId, updateGoogleDocsPageTaskParams.fileId) &&
        Objects.equals(this.title, updateGoogleDocsPageTaskParams.title) &&
        Objects.equals(this.content, updateGoogleDocsPageTaskParams.content) &&
        Objects.equals(this.postMortemTemplateId, updateGoogleDocsPageTaskParams.postMortemTemplateId) &&
        Objects.equals(this.templateId, updateGoogleDocsPageTaskParams.templateId) &&
        Objects.equals(this.includeOverview, updateGoogleDocsPageTaskParams.includeOverview) &&
        Objects.equals(this.includeTimeline, updateGoogleDocsPageTaskParams.includeTimeline) &&
        Objects.equals(this.includeFollowUps, updateGoogleDocsPageTaskParams.includeFollowUps);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, fileId, title, content, postMortemTemplateId, templateId, includeOverview, includeTimeline, includeFollowUps);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateGoogleDocsPageTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGoogleDocsPageTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGoogleDocsPageTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGoogleDocsPageTaskParams is not found in the empty JSON string", UpdateGoogleDocsPageTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGoogleDocsPageTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGoogleDocsPageTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGoogleDocsPageTaskParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGoogleDocsPageTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGoogleDocsPageTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGoogleDocsPageTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGoogleDocsPageTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGoogleDocsPageTaskParams>() {
           @Override
           public void write(JsonWriter out, UpdateGoogleDocsPageTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGoogleDocsPageTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGoogleDocsPageTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGoogleDocsPageTaskParams
   * @throws IOException if the JSON string is invalid with respect to UpdateGoogleDocsPageTaskParams
   */
  public static UpdateGoogleDocsPageTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGoogleDocsPageTaskParams.class);
  }

  /**
   * Convert an instance of UpdateGoogleDocsPageTaskParams to an JSON string
   *
   * @return JSON string
   */
