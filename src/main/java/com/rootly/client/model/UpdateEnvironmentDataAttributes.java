...
public class UpdateEnvironmentDataAttributes {
  ...
  public UpdateEnvironmentDataAttributes() {
  }

  @Deprecated
  public UpdateEnvironmentDataAttributes slug(@jakarta.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public UpdateEnvironmentDataAttributes name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateEnvironmentDataAttributes description(@jakarta.annotation.Nullable String description) {
  ...
  public UpdateEnvironmentDataAttributes publicDescription(@jakarta.annotation.Nullable String publicDescription) {
  ...
  public UpdateEnvironmentDataAttributes color(@jakarta.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  public UpdateEnvironmentDataAttributes position(@jakarta.annotation.Nullable Integer position) {
  ...
  public UpdateEnvironmentDataAttributes externalId(@jakarta.annotation.Nullable String externalId) {
  ...
  public UpdateEnvironmentDataAttributes notifyEmails(@jakarta.annotation.Nullable List<String> notifyEmails) {
    this.notifyEmails = notifyEmails;
    return this;
  }

  public UpdateEnvironmentDataAttributes addNotifyEmailsItem(String notifyEmailsItem) {
  ...
  public UpdateEnvironmentDataAttributes slackChannels(@jakarta.annotation.Nullable List<NewEnvironmentDataAttributesSlackChannelsInner> slackChannels) {
    this.slackChannels = slackChannels;
    return this;
  }

  public UpdateEnvironmentDataAttributes addSlackChannelsItem(NewEnvironmentDataAttributesSlackChannelsInner slackChannelsItem) {
  ...
  public UpdateEnvironmentDataAttributes slackAliases(@jakarta.annotation.Nullable List<NewEnvironmentDataAttributesSlackAliasesInner> slackAliases) {
    this.slackAliases = slackAliases;
    return this;
  }

  public UpdateEnvironmentDataAttributes addSlackAliasesItem(NewEnvironmentDataAttributesSlackAliasesInner slackAliasesItem) {
  ...
  public UpdateEnvironmentDataAttributes properties(@jakarta.annotation.Nullable List<NewCauseDataAttributesPropertiesInner> properties) {
    this.properties = properties;
    return this;
  }

  public UpdateEnvironmentDataAttributes addPropertiesItem(NewCauseDataAttributesPropertiesInner propertiesItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEnvironmentDataAttributes updateEnvironmentDataAttributes = (UpdateEnvironmentDataAttributes) o;
    return Objects.equals(this.slug, updateEnvironmentDataAttributes.slug) &&
        Objects.equals(this.name, updateEnvironmentDataAttributes.name) &&
        Objects.equals(this.description, updateEnvironmentDataAttributes.description) &&
        Objects.equals(this.publicDescription, updateEnvironmentDataAttributes.publicDescription) &&
        Objects.equals(this.color, updateEnvironmentDataAttributes.color) &&
        Objects.equals(this.position, updateEnvironmentDataAttributes.position) &&
        Objects.equals(this.externalId, updateEnvironmentDataAttributes.externalId) &&
        Objects.equals(this.notifyEmails, updateEnvironmentDataAttributes.notifyEmails) &&
        Objects.equals(this.slackChannels, updateEnvironmentDataAttributes.slackChannels) &&
        Objects.equals(this.slackAliases, updateEnvironmentDataAttributes.slackAliases) &&
        Objects.equals(this.properties, updateEnvironmentDataAttributes.properties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateEnvironmentDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEnvironmentDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEnvironmentDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEnvironmentDataAttributes is not found in the empty JSON string", UpdateEnvironmentDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEnvironmentDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEnvironmentDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEnvironmentDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEnvironmentDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEnvironmentDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEnvironmentDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEnvironmentDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateEnvironmentDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEnvironmentDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEnvironmentDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEnvironmentDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateEnvironmentDataAttributes
   */
  public static UpdateEnvironmentDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEnvironmentDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateEnvironmentDataAttributes to an JSON string
   *
   * @return JSON string
   */
