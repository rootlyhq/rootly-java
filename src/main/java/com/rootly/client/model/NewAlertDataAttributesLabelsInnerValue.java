...
public class NewAlertDataAttributesLabelsInnerValue extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewAlertDataAttributesLabelsInnerValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewAlertDataAttributesLabelsInnerValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NewAlertDataAttributesLabelsInnerValue>() {
                @Override
                public void write(JsonWriter out, NewAlertDataAttributesLabelsInnerValue value) throws IOException {
                ...
                @Override
                public NewAlertDataAttributesLabelsInnerValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        NewAlertDataAttributesLabelsInnerValue ret = new NewAlertDataAttributesLabelsInnerValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for NewAlertDataAttributesLabelsInnerValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public NewAlertDataAttributesLabelsInnerValue() {
        super("oneOf", Boolean.FALSE);
    }

    public NewAlertDataAttributesLabelsInnerValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return NewAlertDataAttributesLabelsInnerValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to NewAlertDataAttributesLabelsInnerValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for NewAlertDataAttributesLabelsInnerValue with oneOf schemas: BigDecimal, Boolean, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of NewAlertDataAttributesLabelsInnerValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of NewAlertDataAttributesLabelsInnerValue
     * @throws IOException if the JSON string is invalid with respect to NewAlertDataAttributesLabelsInnerValue
     */
    public static NewAlertDataAttributesLabelsInnerValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, NewAlertDataAttributesLabelsInnerValue.class);
    }

    /**
     * Convert an instance of NewAlertDataAttributesLabelsInnerValue to an JSON string
     *
     * @return JSON string
     */
