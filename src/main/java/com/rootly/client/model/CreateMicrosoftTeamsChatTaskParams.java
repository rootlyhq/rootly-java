...
public class CreateMicrosoftTeamsChatTaskParams {
  ...
  public CreateMicrosoftTeamsChatTaskParams addMembersItem(CreateMicrosoftTeamsChatTaskParamsMembersInner membersItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMicrosoftTeamsChatTaskParams createMicrosoftTeamsChatTaskParams = (CreateMicrosoftTeamsChatTaskParams) o;
    return Objects.equals(this.taskType, createMicrosoftTeamsChatTaskParams.taskType) &&
        Objects.equals(this.topic, createMicrosoftTeamsChatTaskParams.topic) &&
        Objects.equals(this.chatType, createMicrosoftTeamsChatTaskParams.chatType) &&
        Objects.equals(this.members, createMicrosoftTeamsChatTaskParams.members);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskType, topic, chatType, members);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateMicrosoftTeamsChatTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMicrosoftTeamsChatTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMicrosoftTeamsChatTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMicrosoftTeamsChatTaskParams is not found in the empty JSON string", CreateMicrosoftTeamsChatTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMicrosoftTeamsChatTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMicrosoftTeamsChatTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateMicrosoftTeamsChatTaskParams.openapiRequiredFields) {
      ...
      if ((jsonObj.get("chat_type") != null && !jsonObj.get("chat_type").isJsonNull()) && !jsonObj.get("chat_type").isJsonPrimitive()) {
      ...
      // validate the optional field `chat_type`
      if (jsonObj.get("chat_type") != null && !jsonObj.get("chat_type").isJsonNull()) {
        ChatTypeEnum.validateJsonElement(jsonObj.get("chat_type"));
      }
      ...
      for (int i = 0; i < jsonArraymembers.size(); i++) {
        CreateMicrosoftTeamsChatTaskParamsMembersInner.validateJsonElement(jsonArraymembers.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMicrosoftTeamsChatTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMicrosoftTeamsChatTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMicrosoftTeamsChatTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMicrosoftTeamsChatTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMicrosoftTeamsChatTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateMicrosoftTeamsChatTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMicrosoftTeamsChatTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMicrosoftTeamsChatTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMicrosoftTeamsChatTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateMicrosoftTeamsChatTaskParams
   */
  public static CreateMicrosoftTeamsChatTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMicrosoftTeamsChatTaskParams.class);
  }

  /**
   * Convert an instance of CreateMicrosoftTeamsChatTaskParams to an JSON string
   *
   * @return JSON string
   */
