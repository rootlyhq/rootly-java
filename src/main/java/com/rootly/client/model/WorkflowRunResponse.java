...
public class WorkflowRunResponse {
  ...
  private WorkflowRunResponseData data;
  ...
  public WorkflowRunResponse data(@jakarta.annotation.Nonnull WorkflowRunResponseData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  public WorkflowRunResponseData getData() {
    return data;
  }

  public void setData(@jakarta.annotation.Nonnull WorkflowRunResponseData data) {
    this.data = data;
  }


  public WorkflowRunResponse included(@jakarta.annotation.Nullable List<JsonapiIncludedResource> included) {
    this.included = included;
    return this;
  }

  public WorkflowRunResponse addIncludedItem(JsonapiIncludedResource includedItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, workflowRunResponse.data) &&
        Objects.equals(this.included, workflowRunResponse.included);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowRunResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowRunResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      WorkflowRunResponseData.validateJsonElement(jsonObj.get("data"));
