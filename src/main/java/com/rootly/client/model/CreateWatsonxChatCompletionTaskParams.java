...
public class CreateWatsonxChatCompletionTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateWatsonxChatCompletionTaskParams createWatsonxChatCompletionTaskParams = (CreateWatsonxChatCompletionTaskParams) o;
    return Objects.equals(this.taskType, createWatsonxChatCompletionTaskParams.taskType) &&
        Objects.equals(this.model, createWatsonxChatCompletionTaskParams.model) &&
        Objects.equals(this.systemPrompt, createWatsonxChatCompletionTaskParams.systemPrompt) &&
        Objects.equals(this.prompt, createWatsonxChatCompletionTaskParams.prompt) &&
        Objects.equals(this.projectId, createWatsonxChatCompletionTaskParams.projectId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, model, systemPrompt, prompt, projectId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateWatsonxChatCompletionTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateWatsonxChatCompletionTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateWatsonxChatCompletionTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateWatsonxChatCompletionTaskParams is not found in the empty JSON string", CreateWatsonxChatCompletionTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWatsonxChatCompletionTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWatsonxChatCompletionTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateWatsonxChatCompletionTaskParams.openapiRequiredFields) {
      ...
      CreateWatsonxChatCompletionTaskParamsModel.validateJsonElement(jsonObj.get("model"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWatsonxChatCompletionTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWatsonxChatCompletionTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateWatsonxChatCompletionTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateWatsonxChatCompletionTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateWatsonxChatCompletionTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateWatsonxChatCompletionTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateWatsonxChatCompletionTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateWatsonxChatCompletionTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateWatsonxChatCompletionTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateWatsonxChatCompletionTaskParams
   */
  public static CreateWatsonxChatCompletionTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateWatsonxChatCompletionTaskParams.class);
  }

  /**
   * Convert an instance of CreateWatsonxChatCompletionTaskParams to an JSON string
   *
   * @return JSON string
   */
