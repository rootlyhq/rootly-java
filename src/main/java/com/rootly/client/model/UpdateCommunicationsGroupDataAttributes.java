...
public class UpdateCommunicationsGroupDataAttributes {
  ...
  public UpdateCommunicationsGroupDataAttributes addMemberIdsItem(Integer memberIdsItem) {
  ...
  public UpdateCommunicationsGroupDataAttributes addSlackChannelIdsItem(String slackChannelIdsItem) {
  ...
  public UpdateCommunicationsGroupDataAttributes addCommunicationGroupConditionsItem(UpdateCommunicationsGroupDataAttributesCommunicationGroupConditionsInner communicationGroupConditionsItem) {
  ...
  public UpdateCommunicationsGroupDataAttributes addCommunicationExternalGroupMembersItem(UpdateCommunicationsGroupDataAttributesCommunicationExternalGroupMembersInner communicationExternalGroupMembersItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCommunicationsGroupDataAttributes updateCommunicationsGroupDataAttributes = (UpdateCommunicationsGroupDataAttributes) o;
    return Objects.equals(this.name, updateCommunicationsGroupDataAttributes.name) &&
        Objects.equals(this.description, updateCommunicationsGroupDataAttributes.description) &&
        Objects.equals(this.communicationTypeId, updateCommunicationsGroupDataAttributes.communicationTypeId) &&
        Objects.equals(this.isPrivate, updateCommunicationsGroupDataAttributes.isPrivate) &&
        Objects.equals(this.conditionType, updateCommunicationsGroupDataAttributes.conditionType) &&
        Objects.equals(this.smsChannel, updateCommunicationsGroupDataAttributes.smsChannel) &&
        Objects.equals(this.emailChannel, updateCommunicationsGroupDataAttributes.emailChannel) &&
        Objects.equals(this.memberIds, updateCommunicationsGroupDataAttributes.memberIds) &&
        Objects.equals(this.slackChannelIds, updateCommunicationsGroupDataAttributes.slackChannelIds) &&
        Objects.equals(this.communicationGroupConditions, updateCommunicationsGroupDataAttributes.communicationGroupConditions) &&
        Objects.equals(this.communicationExternalGroupMembers, updateCommunicationsGroupDataAttributes.communicationExternalGroupMembers);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCommunicationsGroupDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCommunicationsGroupDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCommunicationsGroupDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCommunicationsGroupDataAttributes is not found in the empty JSON string", UpdateCommunicationsGroupDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCommunicationsGroupDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCommunicationsGroupDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("communication_group_conditions") != null && !jsonObj.get("communication_group_conditions").isJsonNull()) {
        ...
        if (jsonArraycommunicationGroupConditions != null) {
          ...
          for (int i = 0; i < jsonArraycommunicationGroupConditions.size(); i++) {
            UpdateCommunicationsGroupDataAttributesCommunicationGroupConditionsInner.validateJsonElement(jsonArraycommunicationGroupConditions.get(i));
          };
        }
      }
      if (jsonObj.get("communication_external_group_members") != null && !jsonObj.get("communication_external_group_members").isJsonNull()) {
        ...
        if (jsonArraycommunicationExternalGroupMembers != null) {
          ...
          for (int i = 0; i < jsonArraycommunicationExternalGroupMembers.size(); i++) {
            UpdateCommunicationsGroupDataAttributesCommunicationExternalGroupMembersInner.validateJsonElement(jsonArraycommunicationExternalGroupMembers.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCommunicationsGroupDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCommunicationsGroupDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCommunicationsGroupDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCommunicationsGroupDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCommunicationsGroupDataAttributes>() {
           @Override
           public void write(JsonWriter out, UpdateCommunicationsGroupDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCommunicationsGroupDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCommunicationsGroupDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCommunicationsGroupDataAttributes
   * @throws IOException if the JSON string is invalid with respect to UpdateCommunicationsGroupDataAttributes
   */
  public static UpdateCommunicationsGroupDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCommunicationsGroupDataAttributes.class);
  }

  /**
   * Convert an instance of UpdateCommunicationsGroupDataAttributes to an JSON string
   *
   * @return JSON string
   */
