...
public class CreateAnthropicChatCompletionTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    CreateAnthropicChatCompletionTaskParams createAnthropicChatCompletionTaskParams = (CreateAnthropicChatCompletionTaskParams) o;
  ...
  public String toString() {
    ...
    sb.append("class CreateAnthropicChatCompletionTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAnthropicChatCompletionTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAnthropicChatCompletionTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAnthropicChatCompletionTaskParams is not found in the empty JSON string", CreateAnthropicChatCompletionTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAnthropicChatCompletionTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAnthropicChatCompletionTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAnthropicChatCompletionTaskParams.openapiRequiredFields) {
      ...
      CreateAnthropicChatCompletionTaskParamsModel.validateJsonElement(jsonObj.get("model"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAnthropicChatCompletionTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAnthropicChatCompletionTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAnthropicChatCompletionTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAnthropicChatCompletionTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAnthropicChatCompletionTaskParams>() {
           @Override
           public void write(JsonWriter out, CreateAnthropicChatCompletionTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAnthropicChatCompletionTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAnthropicChatCompletionTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAnthropicChatCompletionTaskParams
   * @throws IOException if the JSON string is invalid with respect to CreateAnthropicChatCompletionTaskParams
   */
  public static CreateAnthropicChatCompletionTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAnthropicChatCompletionTaskParams.class);
  }

  /**
   * Convert an instance of CreateAnthropicChatCompletionTaskParams to an JSON string
   *
   * @return JSON string
   */
