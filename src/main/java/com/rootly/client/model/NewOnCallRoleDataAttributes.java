...
public class NewOnCallRoleDataAttributes {
  ...
  public NewOnCallRoleDataAttributes() {
  }

  @Deprecated
  public NewOnCallRoleDataAttributes slug(@jakarta.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public NewOnCallRoleDataAttributes name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public NewOnCallRoleDataAttributes systemRole(@jakarta.annotation.Nullable List<SystemRoleEnum> systemRole) {
    this.systemRole = systemRole;
    return this;
  }

  public NewOnCallRoleDataAttributes addSystemRoleItem(SystemRoleEnum systemRoleItem) {
  ...
  public NewOnCallRoleDataAttributes alertFieldsPermissions(@jakarta.annotation.Nullable List<AlertFieldsPermissionsEnum> alertFieldsPermissions) {
  ...
  public NewOnCallRoleDataAttributes alertGroupsPermissions(@jakarta.annotation.Nullable List<AlertGroupsPermissionsEnum> alertGroupsPermissions) {
  ...
  public NewOnCallRoleDataAttributes alertRoutingRulesPermissions(@jakarta.annotation.Nullable List<AlertRoutingRulesPermissionsEnum> alertRoutingRulesPermissions) {
  ...
  public NewOnCallRoleDataAttributes onCallReadinessReportPermissions(@jakarta.annotation.Nullable List<OnCallReadinessReportPermissionsEnum> onCallReadinessReportPermissions) {
  ...
  public NewOnCallRoleDataAttributes onCallRolesPermissions(@jakarta.annotation.Nullable List<OnCallRolesPermissionsEnum> onCallRolesPermissions) {
  ...
  public NewOnCallRoleDataAttributes alertSourcesPermissions(@jakarta.annotation.Nullable List<AlertSourcesPermissionsEnum> alertSourcesPermissions) {
    this.alertSourcesPermissions = alertSourcesPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addAlertSourcesPermissionsItem(AlertSourcesPermissionsEnum alertSourcesPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes alertUrgencyPermissions(@jakarta.annotation.Nullable List<AlertUrgencyPermissionsEnum> alertUrgencyPermissions) {
    this.alertUrgencyPermissions = alertUrgencyPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addAlertUrgencyPermissionsItem(AlertUrgencyPermissionsEnum alertUrgencyPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes alertsPermissions(@jakarta.annotation.Nullable List<AlertsPermissionsEnum> alertsPermissions) {
    this.alertsPermissions = alertsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addAlertsPermissionsItem(AlertsPermissionsEnum alertsPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes apiKeysPermissions(@jakarta.annotation.Nullable List<ApiKeysPermissionsEnum> apiKeysPermissions) {
    this.apiKeysPermissions = apiKeysPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addApiKeysPermissionsItem(ApiKeysPermissionsEnum apiKeysPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes auditsPermissions(@jakarta.annotation.Nullable List<AuditsPermissionsEnum> auditsPermissions) {
    this.auditsPermissions = auditsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addAuditsPermissionsItem(AuditsPermissionsEnum auditsPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes contactsPermissions(@jakarta.annotation.Nullable List<ContactsPermissionsEnum> contactsPermissions) {
    this.contactsPermissions = contactsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addContactsPermissionsItem(ContactsPermissionsEnum contactsPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes escalationPoliciesPermissions(@jakarta.annotation.Nullable List<EscalationPoliciesPermissionsEnum> escalationPoliciesPermissions) {
    this.escalationPoliciesPermissions = escalationPoliciesPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addEscalationPoliciesPermissionsItem(EscalationPoliciesPermissionsEnum escalationPoliciesPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes groupsPermissions(@jakarta.annotation.Nullable List<GroupsPermissionsEnum> groupsPermissions) {
    this.groupsPermissions = groupsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addGroupsPermissionsItem(GroupsPermissionsEnum groupsPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes heartbeatsPermissions(@jakarta.annotation.Nullable List<HeartbeatsPermissionsEnum> heartbeatsPermissions) {
    this.heartbeatsPermissions = heartbeatsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addHeartbeatsPermissionsItem(HeartbeatsPermissionsEnum heartbeatsPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes integrationsPermissions(@jakarta.annotation.Nullable List<IntegrationsPermissionsEnum> integrationsPermissions) {
    this.integrationsPermissions = integrationsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addIntegrationsPermissionsItem(IntegrationsPermissionsEnum integrationsPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes invitationsPermissions(@jakarta.annotation.Nullable List<InvitationsPermissionsEnum> invitationsPermissions) {
    this.invitationsPermissions = invitationsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addInvitationsPermissionsItem(InvitationsPermissionsEnum invitationsPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes liveCallRoutingPermissions(@jakarta.annotation.Nullable List<LiveCallRoutingPermissionsEnum> liveCallRoutingPermissions) {
    this.liveCallRoutingPermissions = liveCallRoutingPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addLiveCallRoutingPermissionsItem(LiveCallRoutingPermissionsEnum liveCallRoutingPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes addScheduleOverridePermissionsItem(ScheduleOverridePermissionsEnum scheduleOverridePermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes schedulesPermissions(@jakarta.annotation.Nullable List<SchedulesPermissionsEnum> schedulesPermissions) {
    this.schedulesPermissions = schedulesPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addSchedulesPermissionsItem(SchedulesPermissionsEnum schedulesPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes servicesPermissions(@jakarta.annotation.Nullable List<ServicesPermissionsEnum> servicesPermissions) {
    this.servicesPermissions = servicesPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addServicesPermissionsItem(ServicesPermissionsEnum servicesPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes functionalitiesPermissions(@jakarta.annotation.Nullable List<FunctionalitiesPermissionsEnum> functionalitiesPermissions) {
    this.functionalitiesPermissions = functionalitiesPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addFunctionalitiesPermissionsItem(FunctionalitiesPermissionsEnum functionalitiesPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes webhooksPermissions(@jakarta.annotation.Nullable List<WebhooksPermissionsEnum> webhooksPermissions) {
    this.webhooksPermissions = webhooksPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addWebhooksPermissionsItem(WebhooksPermissionsEnum webhooksPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes workflowsPermissions(@jakarta.annotation.Nullable List<WorkflowsPermissionsEnum> workflowsPermissions) {
    this.workflowsPermissions = workflowsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addWorkflowsPermissionsItem(WorkflowsPermissionsEnum workflowsPermissionsItem) {
  ...
  public NewOnCallRoleDataAttributes catalogsPermissions(@jakarta.annotation.Nullable List<CatalogsPermissionsEnum> catalogsPermissions) {
    this.catalogsPermissions = catalogsPermissions;
    return this;
  }

  public NewOnCallRoleDataAttributes addCatalogsPermissionsItem(CatalogsPermissionsEnum catalogsPermissionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    NewOnCallRoleDataAttributes newOnCallRoleDataAttributes = (NewOnCallRoleDataAttributes) o;
    return Objects.equals(this.slug, newOnCallRoleDataAttributes.slug) &&
        Objects.equals(this.name, newOnCallRoleDataAttributes.name) &&
        ...
        Objects.equals(this.apiKeysPermissions, newOnCallRoleDataAttributes.apiKeysPermissions) &&
        Objects.equals(this.auditsPermissions, newOnCallRoleDataAttributes.auditsPermissions) &&
        Objects.equals(this.contactsPermissions, newOnCallRoleDataAttributes.contactsPermissions) &&
        Objects.equals(this.escalationPoliciesPermissions, newOnCallRoleDataAttributes.escalationPoliciesPermissions) &&
        Objects.equals(this.groupsPermissions, newOnCallRoleDataAttributes.groupsPermissions) &&
        Objects.equals(this.heartbeatsPermissions, newOnCallRoleDataAttributes.heartbeatsPermissions) &&
        ...
        Objects.equals(this.functionalitiesPermissions, newOnCallRoleDataAttributes.functionalitiesPermissions) &&
        Objects.equals(this.webhooksPermissions, newOnCallRoleDataAttributes.webhooksPermissions) &&
        Objects.equals(this.workflowsPermissions, newOnCallRoleDataAttributes.workflowsPermissions) &&
        Objects.equals(this.catalogsPermissions, newOnCallRoleDataAttributes.catalogsPermissions);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewOnCallRoleDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewOnCallRoleDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewOnCallRoleDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewOnCallRoleDataAttributes is not found in the empty JSON string", NewOnCallRoleDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewOnCallRoleDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewOnCallRoleDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewOnCallRoleDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewOnCallRoleDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewOnCallRoleDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewOnCallRoleDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewOnCallRoleDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NewOnCallRoleDataAttributes>() {
           @Override
           public void write(JsonWriter out, NewOnCallRoleDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewOnCallRoleDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewOnCallRoleDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewOnCallRoleDataAttributes
   * @throws IOException if the JSON string is invalid with respect to NewOnCallRoleDataAttributes
   */
  public static NewOnCallRoleDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewOnCallRoleDataAttributes.class);
  }

  /**
   * Convert an instance of NewOnCallRoleDataAttributes to an JSON string
   *
   * @return JSON string
   */
