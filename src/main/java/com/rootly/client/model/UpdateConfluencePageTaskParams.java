...
public class UpdateConfluencePageTaskParams {
  ...
  public UpdateConfluencePageTaskParams taskType(@javax.annotation.Nullable TaskTypeEnum taskType) {
  ...
  public UpdateConfluencePageTaskParams integration(@javax.annotation.Nullable CreateConfluencePageTaskParamsIntegration integration) {
  ...
  public UpdateConfluencePageTaskParams fileId(@javax.annotation.Nonnull String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public UpdateConfluencePageTaskParams title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public UpdateConfluencePageTaskParams content(@javax.annotation.Nullable String content) {
  ...
  public UpdateConfluencePageTaskParams postMortemTemplateId(@javax.annotation.Nullable String postMortemTemplateId) {
  ...
  public UpdateConfluencePageTaskParams template(@javax.annotation.Nullable UpdateConfluencePageTaskParamsTemplate template) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateConfluencePageTaskParamsTemplate getTemplate() {
    return template;
  }

  public void setTemplate(@javax.annotation.Nullable UpdateConfluencePageTaskParamsTemplate template) {
    this.template = template;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskType, integration, fileId, title, content, postMortemTemplateId, template);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateConfluencePageTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateConfluencePageTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateConfluencePageTaskParams is not found in the empty JSON string", UpdateConfluencePageTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateConfluencePageTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateConfluencePageTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateConfluencePageTaskParams.openapiRequiredFields) {
      ...
      if (jsonObj.get("template") != null && !jsonObj.get("template").isJsonNull()) {
        UpdateConfluencePageTaskParamsTemplate.validateJsonElement(jsonObj.get("template"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateConfluencePageTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateConfluencePageTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateConfluencePageTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateConfluencePageTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateConfluencePageTaskParams>() {
           @Override
           public void write(JsonWriter out, UpdateConfluencePageTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateConfluencePageTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateConfluencePageTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateConfluencePageTaskParams
   * @throws IOException if the JSON string is invalid with respect to UpdateConfluencePageTaskParams
   */
  public static UpdateConfluencePageTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateConfluencePageTaskParams.class);
  }

  /**
   * Convert an instance of UpdateConfluencePageTaskParams to an JSON string
   *
   * @return JSON string
   */
