...
public class AddMicrosoftTeamsChatTabTaskParams {
  ...
  public boolean equals(Object o) {
    ...
    AddMicrosoftTeamsChatTabTaskParams addMicrosoftTeamsChatTabTaskParams = (AddMicrosoftTeamsChatTabTaskParams) o;
    return Objects.equals(this.taskType, addMicrosoftTeamsChatTabTaskParams.taskType) &&
        Objects.equals(this.chat, addMicrosoftTeamsChatTabTaskParams.chat) &&
        Objects.equals(this.title, addMicrosoftTeamsChatTabTaskParams.title) &&
        Objects.equals(this.link, addMicrosoftTeamsChatTabTaskParams.link);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskType, chat, title, link);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddMicrosoftTeamsChatTabTaskParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddMicrosoftTeamsChatTabTaskParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddMicrosoftTeamsChatTabTaskParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddMicrosoftTeamsChatTabTaskParams is not found in the empty JSON string", AddMicrosoftTeamsChatTabTaskParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddMicrosoftTeamsChatTabTaskParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddMicrosoftTeamsChatTabTaskParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddMicrosoftTeamsChatTabTaskParams.openapiRequiredFields) {
      ...
      AddActionItemTaskParamsPostToSlackChannelsInner.validateJsonElement(jsonObj.get("chat"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddMicrosoftTeamsChatTabTaskParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddMicrosoftTeamsChatTabTaskParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddMicrosoftTeamsChatTabTaskParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddMicrosoftTeamsChatTabTaskParams.class));

       return (TypeAdapter<T>) new TypeAdapter<AddMicrosoftTeamsChatTabTaskParams>() {
           @Override
           public void write(JsonWriter out, AddMicrosoftTeamsChatTabTaskParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddMicrosoftTeamsChatTabTaskParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddMicrosoftTeamsChatTabTaskParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddMicrosoftTeamsChatTabTaskParams
   * @throws IOException if the JSON string is invalid with respect to AddMicrosoftTeamsChatTabTaskParams
   */
  public static AddMicrosoftTeamsChatTabTaskParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddMicrosoftTeamsChatTabTaskParams.class);
  }

  /**
   * Convert an instance of AddMicrosoftTeamsChatTabTaskParams to an JSON string
   *
   * @return JSON string
   */
