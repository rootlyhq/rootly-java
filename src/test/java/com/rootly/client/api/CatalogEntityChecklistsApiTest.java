...
/**
 * API tests for CatalogEntityChecklistsApi
 */
@Disabled
public class CatalogEntityChecklistsApiTest {

    private final CatalogEntityChecklistsApi api = new CatalogEntityChecklistsApi();
     ...
     */
    @Test
    public void getCatalogEntityChecklistTest() throws ApiException {
        UUID id = null;
        CatalogEntityChecklistResponse response = api.getCatalogEntityChecklist(id);
     ...
     */
    @Test
    public void listCatalogEntityChecklistsTest() throws ApiException {
        Integer pageNumber = null;
        Integer pageSize = null;
        String filterStatus = null;
        String filterCatalogChecklistTemplateId = null;
        String filterAuditableType = null;
        String filterAuditableId = null;
        String filterCreatedAtGt = null;
        String filterCreatedAtGte = null;
        String filterCreatedAtLt = null;
        String filterCreatedAtLte = null;
        CatalogEntityChecklistList response = api.listCatalogEntityChecklists(pageNumber, pageSize, filterStatus, filterCatalogChecklistTemplateId, filterAuditableType, filterAuditableId, filterCreatedAtGt, filterCreatedAtGte, filterCreatedAtLt, filterCreatedAtLte);
        // TODO: test validations
    }
