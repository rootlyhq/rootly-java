...
/**
 * API tests for OnCallsApi
 */
@Disabled
public class OnCallsApiTest {

    private final OnCallsApi api = new OnCallsApi();
     ...
     */
    @Test
    public void listOncallsTest() throws ApiException {
        String include = null;
        String since = null;
        String until = null;
        Boolean earliest = null;
        String timeZone = null;
        String filterEscalationPolicyIds = null;
        String filterScheduleIds = null;
        String filterUserIds = null;
