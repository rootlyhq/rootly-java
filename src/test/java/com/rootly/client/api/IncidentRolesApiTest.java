...
public class IncidentRolesApiTest {
    ...
    public void listIncidentRolesTest() throws ApiException {
        ...
        String sort = null;
        IncidentRoleList response = api.listIncidentRoles(pageNumber, pageSize, filterSearch, filterSlug, filterName, filterEnabled, filterCreatedAtGt, filterCreatedAtGte, filterCreatedAtLt, filterCreatedAtLte, sort);
        // TODO: test validations
    }
